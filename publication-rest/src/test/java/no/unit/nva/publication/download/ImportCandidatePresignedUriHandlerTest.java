...
class ImportCandidatePresignedUriHandlerTest extends ResourcesLocalTest {
  ...
  public void init() {
    ...
    handler =
        new ImportCandidatePresignedUrlHandler(
            s3Presigner, importCandidateService, new Environment());
  ...
  void shouldReturnNotFoundWhenFileDoesNotExist() throws IOException {
    ...
    var request =
        createRequestForCandidateWithFile(
  ...
  void shouldReturnPresignedUrlSuccessfully() throws IOException, URISyntaxException {
    ...
    var request =
        createRequestForCandidateWithFile(importCandidate.getIdentifier(), file.getIdentifier());
  ...
  private static InputStream createRequestForCandidateWithFile(
      SortableIdentifier importCandidateIdentifier, UUID fileIdentifier)
