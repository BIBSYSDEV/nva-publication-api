...
public class PublicationUriEntityDescriptionValidatorTest {
  ...
  private static final String INVALID_SORTABLE_IDENTIFIER =
      "0193cfbef040-20d8938d-1096-44e9-8a9e-XXX";
  ...
  void shouldReturnFalseWithInvalidSortableId() {
    assertThat(
        PublicationUriValidator.isValid(
            URI.create(PROTOCOL + HOST + PUBLICATION + INVALID_SORTABLE_IDENTIFIER), HOST),
        is(false));
  }
}
