...
class PublishPublicationHandlerTest extends ResourcesLocalTest {
  ...
  @Test
  void shouldReturnForbiddenWhenUserHasNoPermissionsToPublishPublication()
  ...
  void shouldReturnBadGatewayWhenUnexpectedExceptionOccurs()
    ...
    doThrow(new RuntimeException())
        ...
        .updateResource(any(Resource.class), any());
    var publishPublicationHandler =
  ...
  private static Map<String, String> publicationIdentifierPathParam(
  ...
  private InputStream createRequestWithUserWithPermissionsToPublishPublication(
      Publication publication) throws JsonProcessingException {
    return new HandlerRequestBuilder<Void>(dtoObjectMapper)
