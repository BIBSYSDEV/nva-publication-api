...
public class CustomerApiStubs {
  ...
  public static void stubCustomSuccessfulCustomerResponse(URI customerId, String customerResponse) {
    stubFor(
        get(urlPathEqualTo(customerId.getPath()))
  ...
  public static void stubCustomerResponseAcceptingFilesForAllTypesAndNotAllowingAutoPublishingFiles(
      URI customerId) {
    stubCustomSuccessfulCustomerResponse(
        customerId, customerAcceptingFilesForAllTypesNotAllowingAutoPublishingFiles());
  }

  public static void stubCustomerResponseAcceptingFilesForAllTypesAndOverridableRrs(
      URI customerId) {
    stubCustomSuccessfulCustomerResponse(
        customerId, customerAcceptingFilesForAllTypesAndOverridableRrs());
  }
