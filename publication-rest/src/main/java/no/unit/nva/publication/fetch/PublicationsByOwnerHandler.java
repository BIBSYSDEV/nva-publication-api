...
public class PublicationsByOwnerHandler
    extends ApiGatewayHandler<Void, PublicationsByOwnerResponse> {
  ...
  @Override
  protected PublicationsByOwnerResponse processInput(
    ...
    return new PublicationsByOwnerResponse(
