...
public class UriShortenerImpl implements UriShortener {
  ...
  public UriShortenerImpl(
      UriWrapper apiHostWrapper, UriShortenerWriteClient uriShortenerWriteClient) {
  ...
  public static UriShortenerImpl createDefault(String host) {
    return new UriShortenerImpl(
        UriWrapper.fromHost(host),
        new UriShortenerWriteClient(
            AmazonDynamoDBClientBuilder.defaultClient(),
            new Environment().readEnv(TABLE_NAME_ENVIRONMENT_VARIABLE)));
  }
