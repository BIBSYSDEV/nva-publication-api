...
public record PresignedUri(
    UUID fileIdentifier, @JsonIgnore String bucket, Instant expires, String mime, URI id) {
  ...
  public Builder copy() {
    return builder()
        .withFileIdentifier(this.fileIdentifier)
  ...
  public PresignedUri create(S3Presigner s3Presigner) throws S3ServiceException {
    return attempt(() -> getS3ObjectRequest(fileIdentifier))
        .map(this::getPresignedUrlRequest)
