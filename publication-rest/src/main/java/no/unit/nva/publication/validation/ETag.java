 ...
 *
 * <p>ETags are used to validate cached responses. This implementation combines entity version with
 * username to ensure cache invalidation when the user's authorization state changes.
 *
...
public final class ETag {
  ...
  private static final String ETAG_MISSING_VERSION_MESSAGE =
      "ETag can not be constructed without version";
  private static final String ETAG_MISSING_VALUE_EXCEPTION =
      "ETag value cannot be created from blank string";
