...
public final class PublicationServiceConfig {
  ...
  public static final URI PUBLICATION_HOST_URI =
      UriWrapper.fromHost(API_HOST).addChild(PUBLICATION_PATH).getUri();
  @Deprecated public static final String DEPRECATED_MESSAGE_PATH = "/messages";
  ...
  public static final Integer RESULT_SET_SIZE_FOR_DYNAMODB_QUERIES =
      readDynamoDbQueryResultsPageSize();
