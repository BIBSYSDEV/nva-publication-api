...
public class FilesApprovalThesis extends FilesApprovalEntry {
  ...
  public static FilesApprovalThesis createForChannelOwningInstitution(
      Resource resource,
  ...
  public static FilesApprovalThesis createQueryObject(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getIdentifier(), that.getIdentifier())
        ...
        && getWorkflow() == that.getWorkflow()
        && Objects.equals(getAssignee(), that.getAssignee())
        && Objects.equals(getOwnerAffiliation(), that.getOwnerAffiliation());
  }

  private static FilesApprovalThesis createFileApproval(
      Resource resource,
      UserInstance userInstance,
      URI organizationId,
      SortableIdentifier channelClaimIdentifier,
    ...
    fileApproval.setReceivingOrganizationDetails(
