...
public class DoiRequestDao extends TicketDao implements JoinWithResource, JsonSerializable {
  ...
  public static DoiRequestDao queryObject(
      URI publisherId, User owner, SortableIdentifier doiRequestIdentifier) {
    DoiRequest doi =
        DoiRequest.builder()
  ...
  public static DoiRequestDao queryObject(ResourceDao queryObject) {
    var doiRequest =
        DoiRequest.builder().withResourceIdentifier(queryObject.getResourceIdentifier()).build();
  ...
  public static DoiRequestDao queryByCustomerAndResourceIdentifier(
      UserInstance resourceOwner, SortableIdentifier resourceIdentifier) {
    DoiRequest doi =
        DoiRequest.builder()
  ...
  public String joinByResourceContainedOrderedType() {
    return JOIN_BY_RESOURCE_INDEX_ORDER_PREFIX
