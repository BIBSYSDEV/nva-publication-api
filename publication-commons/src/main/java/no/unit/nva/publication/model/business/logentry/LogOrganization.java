...
public record LogOrganization(URI id, String acronym, Map<String, String> labels)
    implements LogAgent {
  ...
  public static LogOrganization fromCristinOrganization(
      CristinOrganizationDto cristinOrganizationDto) {
    return new LogOrganization(
        cristinOrganizationDto.id(),
        cristinOrganizationDto.acronym(),
