...
public record ResourceRelationshipDao(
    @JsonProperty("data") ResourceRelationship resourceRelationship, Instant createdDate)
  ...
  public Map<String, AttributeValue> getPrimaryKey() {
    return Map.of(
        PRIMARY_KEY_PARTITION_KEY_NAME, AttributeValue.fromS(getChildKey()),
        PRIMARY_KEY_SORT_KEY_NAME, AttributeValue.fromS(getParentKey()));
  }
}
