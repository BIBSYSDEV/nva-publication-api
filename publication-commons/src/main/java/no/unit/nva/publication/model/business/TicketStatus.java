...
public enum TicketStatus {
  ...
  public static final String INVALID_DOI_REQUEST_STATUS_ERROR =
      "Invalid DoiRequest status. Valid values:  ";
  public static final String SEPARATOR = ",";
  static final Set<TicketStatus> validStatusChangeForRejected = Set.of(COMPLETED);
  static final Set<TicketStatus> validStatusChangeForRequested =
      Set.of(COMPLETED, CLOSED, NOT_APPLICABLE);
  ...
  /**
   * Changes status for a DoiRequestStatus change. It will return the new DoiRequestStatus if the
   * transition is valid.
   *
  ...
  public TicketStatus changeStatus(TicketStatus requestedStatusChange) {
    ...
    throw new IllegalArgumentException(
        getErrorMessageForNotAllowedStatusChange(requestedStatusChange));
  }

  protected String getErrorMessageForNotAllowedStatusChange(TicketStatus requestedStatusChange) {
    return String.format(
        ERROR_MESSAGE_NOT_ALLOWED_TO_CHANGE_STATUS_FROM_S_TO_S, this, requestedStatusChange);
  }
