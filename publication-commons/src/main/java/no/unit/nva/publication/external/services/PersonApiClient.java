...
public class PersonApiClient {
  ...
  public static final String ERROR_WITH_PERSON_SERVICE_COMMUNICATION =
      "Error communicating with Person service";
  ...
  private List<URI> extractUserAffiliations(HttpResponse<String> response)
  ...
  private Optional<ObjectNode> extractUserInformation(HttpResponse<String> response)
      throws JsonProcessingException {
