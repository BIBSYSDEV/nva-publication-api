...
public class PublishingRequestCase extends FilesApprovalEntry {
  ...
  public static PublishingRequestCase create(
    ...
    return REGISTRATOR_PUBLISHES_METADATA_AND_FILES.equals(workflow)
        ...
        : (PublishingRequestCase)
            publishingRequestCase.handleMetadataOnlyWorkflow(resource, userInstance, workflow);
  }

  public static PublishingRequestCase createWithFilesForApproval(
      Resource resource,
  ...
  public static PublishingRequestCase createQueryObject(
      UserInstance userInstance,
      SortableIdentifier publicationIdentifier,
      SortableIdentifier publishingRequestIdentifier) {
    return createPublishingRequestIdentifyingObject(
        userInstance, publicationIdentifier, publishingRequestIdentifier);
  }

  public static PublishingRequestCase createQueryObject(
      SortableIdentifier resourceIdentifier, URI customerId) {
  ...
  public PublishingRequestCase copy() {
    ...
    copy.setFilesForApproval(
        this.getFilesForApproval().isEmpty() ? Set.of() : this.getFilesForApproval());
  ...
  private static PublishingRequestCase createPublishingRequest(
      Resource resource, UserInstance userInstance, PublishingWorkflow workflow) {
    ...
    publishingRequestCase.setReceivingOrganizationDetails(
        createDefaultReceivingOrganizationDetails(userInstance));
    return publishingRequestCase;
  }
