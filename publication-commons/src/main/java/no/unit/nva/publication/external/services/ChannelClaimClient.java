...
public final class ChannelClaimClient {
  ...
  public ChannelClaimDto fetchChannelClaim(URI channelClaimId) throws NotFoundException {
    return attempt(() -> uriRetriever.fetchResponse(channelClaimId, "application/json"))
        .map(Optional::get)
  ...
  private static ChannelClaimDto toChannelClaimDto(HttpResponse<String> response)
