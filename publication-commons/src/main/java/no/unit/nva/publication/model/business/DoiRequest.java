...
public class DoiRequest extends TicketEntry {
  ...
  public static final Set<PublicationStatus> ACCEPTABLE_PUBLICATION_STATUSES =
      Set.of(PUBLISHED, PublicationStatus.PUBLISHED_METADATA, PublicationStatus.DRAFT);
  public static final String DOI_REQUEST_APPROVAL_FAILURE =
      "Cannot approve DoiRequest for non-published publication";
  ...
  public static DoiRequest create(Resource resource, UserInstance userInstance) {
    ...
    doiRequest.setReceivingOrganizationDetails(
  ...
  public void validateCreationRequirements(Publication publication) throws ConflictException {
    if (publicationDoesNotHaveAnExpectedStatus(publication)) {
      throw new ConflictException(
          String.format(WRONG_PUBLICATION_STATUS_ERROR, ACCEPTABLE_PUBLICATION_STATUSES));
    }
  }
  ...
  public static final class Builder {
    ...
    public Builder withReceivingOrganizationDetails(
