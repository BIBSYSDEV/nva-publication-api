...
public class MessageService extends ServiceWithTransactions {
  ...
  public static final String SENDER_OR_CURATOR_ONLY_MESSAGE =
      "Only message sender and curator can perform this " + "action!";
  ...
  private boolean canManageMessage(Message message, UserInstance userInstance)
      throws NotFoundException {
