...
public class FilePermissions {
  ...
  public FilePermissions(FileEntry file, UserInstance userInstance, Resource resource) {
  ...
  private void validateDenyStrategiesRestrictions(FileOperation requestedPermission)
    ...
    if (!strategies.isEmpty()) {
      logger.info(
          "User {} was denied access {} on file {} from strategies {}",
  ...
  private void validateGrantStrategies(FileOperation requestedPermission)
      throws UnauthorizedException {
    var strategies =
    ...
    logger.info(
        "User {} was allowed {} on file {} from strategies {}",
        userInstance.getUsername(),
        requestedPermission,
        file.getIdentifier(),
        String.join(COMMA_DELIMITER, strategies));
  ...
  private String formatUnauthorizedMessage(FileOperation requestedPermission) {
    return String.format(
        ...
        userInstance.getUsername(), requestedPermission, file.getIdentifier());
  }
}
