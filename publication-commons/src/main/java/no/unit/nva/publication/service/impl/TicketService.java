...
public class TicketService extends ServiceWithTransactions {
  ...
  private static final Supplier<SortableIdentifier> DEFAULT_IDENTIFIER_PROVIDER =
      SortableIdentifier::next;
  private static final String TICKET_REFRESHED_MESSAGE =
      "Ticket has been refreshed successfully: {}";
  public static final String TICKET_TO_REFRESH_NOT_FOUND_MESSAGE =
      "Ticket to refresh is not found: {}";
  ...
  public static TicketService defaultService() {
    return new TicketService(
        DEFAULT_DYNAMODB_CLIENT, new UriRetriever(), CristinUnitsUtil.defaultInstance());
  }
  ...
  public TicketEntry updateTicketStatus(
      TicketEntry ticketEntry, TicketStatus ticketStatus, UserInstance userInstance)
      throws ApiGatewayException {
  ...
  public <T extends TicketEntry> Optional<T> fetchTicketByResourceIdentifier(
      URI customerId, SortableIdentifier resourceIdentifier, Class<T> ticketType) {

    TicketDao dao =
        TicketEntry.createQueryObject(customerId, resourceIdentifier, ticketType).toDao();
  ...
  public TicketEntry updateTicketAssignee(TicketEntry ticketEntry, Username assignee)
      throws ApiGatewayException {
  ...
  protected TicketEntry completeTicket(TicketEntry ticketEntry, UserInstance userInstance)
      throws ApiGatewayException {
    var publication =
