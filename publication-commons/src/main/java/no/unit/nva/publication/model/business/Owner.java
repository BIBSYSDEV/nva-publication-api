...
public class Owner {
  ...
  @JsonCreator
  public Owner(
      @JsonProperty(OWNER_FIELD) User user, @JsonProperty(OWNER_AFFILIATION) URI affiliation) {
    this.user = user;
  ...
  public boolean equals(Object o) {
    ...
    Owner owner = (Owner) o;
    return Objects.equals(getUser(), owner.getUser())
        && Objects.equals(getOwnerAffiliation(), owner.getOwnerAffiliation());
  }
}
