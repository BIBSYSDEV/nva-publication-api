...
public abstract class TicketEntry implements Entity {
  ...
  public static <T extends TicketEntry> TicketEntry createNewTicket(
      Publication publication, Class<T> ticketType, Supplier<SortableIdentifier> identifierProvider)
  ...
  public static <T extends TicketEntry> TicketEntry requestNewTicket(
      Publication publication, Class<T> ticketType) {
  ...
  public static <T extends TicketEntry> T createQueryObject(
      URI customerId, SortableIdentifier resourceIdentifier, Class<T> ticketType) {
    if (DoiRequest.class.equals(ticketType)) {
      ...
      return ticketType.cast(
          PublishingRequestCase.createQueryObject(resourceIdentifier, customerId));
    } else if (GeneralSupportRequest.class.equals(ticketType)) {
      return ticketType.cast(
          GeneralSupportRequest.createQueryObject(customerId, resourceIdentifier));
    } else if (UnpublishRequest.class.equals(ticketType)) {
  ...
  public static UntypedTicketQueryObject createQueryObject(
      UserInstance userInstance, SortableIdentifier ticketIdentifier) {
  ...
  public static TicketEntry createNewUnpublishRequest(
  ...
  public void setReceivingOrganizationDetails(
      ReceivingOrganizationDetails receivingOrganizationDetails) {
    this.receivingOrganizationDetails = receivingOrganizationDetails;
  }

  public void setReceivingOrganizationDetailsAndResetAssignee(
      URI ownerAffiliation, URI responsibilityArea) {
    setReceivingOrganizationDetails(
        new ReceivingOrganizationDetails(ownerAffiliation, responsibilityArea));
    setAssignee(null);
  }
  ...
  public final TicketEntry persistNewTicket(TicketService ticketService, Publication publication)
      throws ApiGatewayException {
    // this is the only place that deprecated should be called.
    return ticketService.createTicket(this, publication);
  }
  ...
  protected static ReceivingOrganizationDetails createDefaultReceivingOrganizationDetails(
      UserInstance userInstance) {
    return new ReceivingOrganizationDetails(
        userInstance.getTopLevelOrgCristinId(), userInstance.getPersonAffiliation());
  }
