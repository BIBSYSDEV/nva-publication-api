...
public record LogUser(
  ...
  public static LogUser create(
      CristinPersonDto cristinPersonDto, CristinOrganizationDto cristinOrganizationDto) {
    return new LogUser(
        null,
        cristinPersonDto.id(),
        cristinPersonDto.firstName().orElse(null),
  ...
  private static String getName(CristinPersonDto cristinPersonDto, String nameType) {
    return cristinPersonDto.names().stream()
