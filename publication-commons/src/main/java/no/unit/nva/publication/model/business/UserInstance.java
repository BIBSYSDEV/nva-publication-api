...
public class UserInstance implements JsonSerializable {
  ...
  public static UserInstance create(User user, URI customerId) {
    return new UserInstance(
        user.toString(),
        customerId,
        UNDEFINED_TOP_LEVEL_ORG_CRISTIN_URI,
        null,
        null,
        null,
  ...
  public static UserInstance create(
      ...
      ThirdPartySystem thirdPartySystem) {
    return new UserInstance(
        resourceOwner.getOwner().getValue(),
        customerId,
  ...
  public static UserInstance createExternalUser(
      ResourceOwner resourceOwner, URI customerId, ThirdPartySystem thirdPartySystem) {
  ...
  public boolean isSender(Message message) {
    return this.user.equals(message.getSender()) && this.customerId.equals(message.getCustomerId());
  }
