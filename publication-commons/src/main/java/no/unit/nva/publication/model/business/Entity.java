...
/**
 * Entities are the basic entities associated with a Resource, ignoring database implementation
 * details. An Entity contains all information necessary to identify and describe the entity, but
 * does not contain database details.
 */
