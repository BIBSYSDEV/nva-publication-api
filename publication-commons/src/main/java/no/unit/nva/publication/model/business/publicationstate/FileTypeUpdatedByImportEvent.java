...
public record FileTypeUpdatedByImportEvent(
    Instant date,
    User user,
    URI institution,
  ...
  public static FileTypeUpdatedByImportEvent create(
      User user, URI institution, Instant timestamp, ImportSource importSource) {
    return new FileTypeUpdatedByImportEvent(
        timestamp, user, institution, SortableIdentifier.next(), importSource);
  }
