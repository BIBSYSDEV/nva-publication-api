...
public final class ImportCandidateToResourceConverter {
  ...
  public static EntityDescription toEntityDescription(ImportCandidate enrichedCandidate) {
    ...
    return new EntityDescription.Builder()
        .withAbstract(entityDescription.mainAbstract())
  ...
  private static List<Contributor> convertToEntityDescriptionForResource(
      ImportEntityDescription entityDescription) {
  ...
  public static Contributor toContributor(ImportContributor importContributor) {
    return new Contributor.Builder()
        .withIdentity(importContributor.identity())
