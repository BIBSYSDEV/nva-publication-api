Feature: Publication action permissions for publication status PUBLISHED

  Scenario Outline: Verify publication permissions when publication has status PUBLISHED and user relates to publication
    Given a "publication"
  ...
  Scenario Outline: Verify publication permissions when publication has status PUBLISHED and user does not relate to publication
    Given a "publication"
    And publication has status "published"
    And the user have the role "<UserRole>"
