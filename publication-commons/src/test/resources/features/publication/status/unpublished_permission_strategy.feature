Feature: Publication action permissions for publication status UNPUBLISHED

  Scenario Outline: Verify publication permissions when publication has status UNPUBLISHED and user relates to publication
    Given a "publication"
  ...
  Scenario Outline: Verify publication permissions when publication has status UNPUBLISHED and user does not relate to publication
    Given a "publication"
    And publication has status "unpublished"
    And the user have the role "<UserRole>"
