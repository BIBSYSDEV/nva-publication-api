Feature: Publication update permissions
  ...
  Scenario Outline: Verify operation when
    ...
    Examples:
      ...
      | Editor                  | Degree,Imported              | partial-update | Allowed     |
      ...
      | Editor                  | Degree                       | partial-update | Allowed     |
      ...
      | Editor                  | Imported                     | partial-update | Allowed     |
      ...
      | Editor                  | MetadataOnly,Degree,Imported | partial-update | Allowed     |
      ...
      | Editor                  | MetadataOnly,Degree          | partial-update | Allowed     |
      ...
      | Editor                  | MetadataOnly,Imported        | partial-update | Allowed     |
      ...
      | Editor                  | MetadataOnly                 | partial-update | Allowed     |
      ...
      | Editor                  | Degree,Imported              | update         | Allowed     |
      ...
      | Editor                  | Imported                     | update         | Allowed     |
      ...
      | Editor                  | MetadataOnly,Degree,Imported | update         | Allowed     |
      ...
      | Editor                  | MetadataOnly,Degree          | update         | Allowed     |
      ...
      | Editor                  | MetadataOnly,Imported        | update         | Allowed     |
      ...
      | Editor                  | MetadataOnly                 | update         | Allowed     |
