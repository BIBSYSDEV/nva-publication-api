Feature: Publication action permissions for degrees with finalized files

  Scenario Outline: Verify publication permissions for degrees with finalized files
    Given a "degree"
