Feature: Publication action permissions for imported degrees
  ...
  Scenario Outline: Verify publication permissions for imported degrees with no files
    Given a "degree"
    ...
    Examples:
      ...
      | Thesis curator          | read-hidden-files         | Allowed     |
      | Embargo thesis curator  | read-hidden-files         | Allowed     |
  ...
  Scenario Outline: Verify publication permissions for imported degrees with finalized files
    Given a "degree"
    And publication is an imported degree
  ...
  Scenario Outline: Verify publication permissions for imported degrees with no files when user does not relate to publication
    Given a "degree"
    And publication is an imported degree
    And publication has "no" files
    And the user have the role "<UserRole>"
  ...
  Scenario Outline: Verify publication permissions for imported degrees with finalized files when user does not relate to publication
    Given a "degree"
    And publication is an imported degree
    And publication has "finalized" files
    And the user have the role "<UserRole>"
