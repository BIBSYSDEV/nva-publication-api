Feature: Publication action permissions for degrees when user relates to publication

  Scenario Outline: Verify publication permissions for degrees when user relates to publication
    Given a "degree"
