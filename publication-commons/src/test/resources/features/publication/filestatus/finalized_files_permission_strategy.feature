Feature: Publication action permissions for publication with finalized files

  Scenario Outline: Verify publication permissions when publication has finalized files and user relates to publication
    Given a "publication"
  ...
  Scenario Outline: Verify publication permissions when publication has finalized files and user does not relate to publication
    Given a "publication"
    And publication has "finalized" files
    And the user have the role "<UserRole>"
