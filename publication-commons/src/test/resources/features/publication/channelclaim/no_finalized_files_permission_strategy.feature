Feature: Publication action permissions for publications with claimed channel and no finalized files

  Scenario Outline: Verify permissions for publications with no finalized files and channel claimed by users institution
    Given a "degree"
  ...
  Scenario Outline: Verify permissions for publications with no finalized files and channel claimed by not users institution
    Given a "degree"
    And publication has "no finalized" files
