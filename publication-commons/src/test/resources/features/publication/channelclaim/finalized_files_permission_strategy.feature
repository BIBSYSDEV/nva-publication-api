Feature: Publication action permissions for publications with claimed channel and finalized files

  Scenario Outline: Verify permissions for publications with finalized files and channel claimed by users institution
    Given a "degree"
  ...
  Scenario Outline: Verify permissions for publications with finalized files and channel claimed by not users institution
    Given a "degree"
    And publication has "finalized" files
