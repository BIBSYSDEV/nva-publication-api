...
public final class RolesToAccessRights {
  ...
  public static final Map<PermissionsRole, Set<AccessRight>> roleToAccessRightsMap =
      Map.ofEntries(
          Map.entry(CREATOR, Set.of(MANAGE_OWN_RESOURCES)),
          Map.entry(CONTRIBUTOR, Set.of(MANAGE_OWN_RESOURCES)),
          Map.entry(
              PUBLISHING_CURATOR,
              Set.of(MANAGE_RESOURCES_STANDARD, MANAGE_PUBLISHING_REQUESTS, MANAGE_RESOURCE_FILES)),
          Map.entry(NVI_CURATOR, Set.of(MANAGE_RESOURCES_STANDARD, MANAGE_NVI_CANDIDATES)),
          Map.entry(DOI_CURATOR, Set.of(MANAGE_RESOURCES_STANDARD, MANAGE_DOI)),
          Map.entry(SUPPORT_CURATOR, Set.of(MANAGE_RESOURCES_STANDARD, SUPPORT)),
          Map.entry(INTERNAL_IMPORTER, Set.of(MANAGE_IMPORT)),
          Map.entry(THESIS_CURATOR, Set.of(MANAGE_RESOURCES_STANDARD, MANAGE_DEGREE)),
          Map.entry(
              EMBARGO_THESIS_CURATOR, Set.of(MANAGE_RESOURCES_STANDARD, MANAGE_DEGREE_EMBARGO)),
          Map.entry(
              EDITOR, Set.of(MANAGE_OWN_AFFILIATION, MANAGE_RESOURCES_ALL, MANAGE_CHANNEL_CLAIMS)));
