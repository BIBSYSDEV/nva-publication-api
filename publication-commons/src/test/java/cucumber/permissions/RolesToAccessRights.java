...
public final class RolesToAccessRights {
    ...
    public static final Map<PermissionsRole, Set<AccessRight>> roleToAccessRightsMap = Map.of(
        ...
        FILE_CURATOR_BY_PUBLICATION_OWNER, Set.of(AccessRight.MANAGE_RESOURCES_STANDARD,
        ...
        NON_DEGREE_CURATOR_TYPE, Set.of(AccessRight.MANAGE_RESOURCES_STANDARD, AccessRight.MANAGE_DOI, AccessRight.SUPPORT,
                                        AccessRight.MANAGE_NVI, AccessRight.MANAGE_PUBLISHING_REQUESTS,
                                        AccessRight.MANAGE_RESOURCE_FILES),
        EDITOR, Set.of(AccessRight.MANAGE_RESOURCES_ALL, AccessRight.MANAGE_OWN_AFFILIATION,
