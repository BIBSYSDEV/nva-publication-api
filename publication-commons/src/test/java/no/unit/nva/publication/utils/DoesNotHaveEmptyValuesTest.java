...
class DoesNotHaveEmptyValuesTest {
  ...
  public static Stream<Named<Object>> nonEmptyValueProvider() {
    return Stream.of(
        ...
        named(
            "Record with string and record", new SampleRecord("hi", new SampleRecord("hi", "hi"))),
        ...
        named(
            "Class with string and list of class",
            new SampleClass("hi", List.of(new SampleClass("hi", "hi")))),
        named(
            "Record with string and list of record",
            new SampleRecord("hi", List.of(new SampleRecord("hi", "hi")))));
  }
  ...
  public static Stream<Named<Pair>> emptyValueProvider() {
    return Stream.of(
        ...
        named(
            ...
            new Pair(
                new SampleRecord("hi", new SampleRecord(null, "hi")), Set.of("field2.field1"))),
        named(
            "Empty embedded object",
            new Pair(new SampleRecord("hi", new SampleRecord("", "hi")), Set.of("field2.field1"))),
        named("Empty embedded list", new Pair(new SampleClass("hi", List.of()), Set.of("field2"))),
        named(
            "Empty field in embedded list",
            new Pair(
                new SampleRecord("hi", List.of(new SampleRecord(null, "hi"))),
  ...
  @ParameterizedTest
  @ValueSource(strings = {"field2", "field2.field2"})
  void shouldDisregardChildrenWhenParentFieldIsExcluded(String excludedField) {
    ...
    assertDoesNotThrow(
        () -> DoesNotHaveEmptyValues.checkForEmptyFields(sample, Set.of(excludedField)));
  }
