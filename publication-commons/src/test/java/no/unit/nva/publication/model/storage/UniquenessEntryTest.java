...
public class UniquenessEntryTest {
  ...
  void getPrimaryPartitionKeyReturnsStringContainingOnlyTypeAndEntryIdentifier(
      UniquenessEntry entry) {
    String expectedKey =
        entry.getType() + DatabaseConstants.KEY_FIELDS_DELIMITER + SAMPLE_IDENTIFIER;
