...
public class ClaimedChannelPermissionStrategyTest extends PublicationPermissionStrategyTest {
  ...
  @ParameterizedTest(
      name =
          "Should deny curator from non curating institution {0} operation on publication with "
              + "non claimed channel")
  ...
  void shouldDenyNonCuratingInstitutionWhenNoClaimedChannel(PublicationOperation operation)
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(nonCuratingInstitution.curator()), identityServiceClient);
    Assertions.assertFalse(
        PublicationPermissions.create(resource, userInstance).allowsAction(operation));
  }

  @ParameterizedTest(
      name =
          "Should allow registrator {0} operation on publication with non claimed "
              + "channel and no open files")
  @MethodSource("argumentsForRegistrator")
  void shouldAllowRegistratorWhenChannelIsNotClaimedAndPublicationHasNoOpenFile(
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(registrator), identityServiceClient);
  ...
  @ParameterizedTest(
      name =
          "Should allow registrator {0} operation on publication with non claimed channel and "
              + "open files")
  @MethodSource("argumentsForRegistratorAfterOpenFiles")
  void shouldAllowRegistratorWhenChannelIsNotClaimedAndPublicationHasOpenFile(
      PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var institution = Institution.random();
    var registrator = institution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow contributor from same institution {0} operation on publication with non "
  ...
  void shouldAllowContributorFromSameInstitutionWhenChannelIsNotClaimedAndPublicationHasNoOpenFiles(
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(contributor), identityServiceClient);
  ...
  @ParameterizedTest(
      name =
          "Should allow contributor from another institution {0} operation on publication with "
              + "non claimed channel and no open files")
  @MethodSource("argumentsForContributor")
  void
      shouldAllowContributorFromAnotherInstitutionWhenChannelIsNotClaimedAndPublicationHasNoOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(curatingInstitution.contributor()), identityServiceClient);
  ...
  @ParameterizedTest(
      name =
          "Should allow curator from curating institution {0} operation on publication with non "
              + "claimed channel and no open files")
  @MethodSource("argumentsForCurator")
  void shouldAllowCuratorFromCuratingInstitutionWhenChannelIsNotClaimedAndPublicationHasNoOpenFile(
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(curatingInstitution.curator()), identityServiceClient);
  ...
  @ParameterizedTest(
      name =
          "Should allow registrator {0} operation on publication with channel claimed by own "
              + "institution with publishing policy 'Everyone' and no open files")
  @MethodSource("argumentsForRegistrator")
  void
      shouldAllowRegistratorWhenChannelIsClaimedByOwnInstitutionWithPublishingPolicyEveryoneAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow curator {0} operation on publication with channel claimed by own "
              + "institution with publishing policy 'Everyone' and no open files")
  @MethodSource("argumentsForCurator")
  void
      shouldAllowCuratorWhenChannelIsClaimedByOwnInstitutionWithPublishingPolicyEveryoneAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(toRequestInfo(curator), identityServiceClient);
  ...
  @ParameterizedTest(
      name =
          "Should allow contributor from same institution {0} operation on publication with "
              + "channel claimed by own institution with publishing policy 'Everyone' and no open "
              + "files")
  @MethodSource("argumentsForContributor")
  void
      shouldAllowContributorFromSameInstitutionWhenChannelIsClaimedByOwnInstitutionWithPublishingPolicyEveryoneAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForContributor")
  void
      shouldAllowContributorFromAnotherInstitutionWhenChannelIsClaimedByOwnInstitutionWithPublishingPolicyEveryoneAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow curator from curating institution {0} operation on publication with "
              + "channel claimed by own institution with publishing policy 'Everyone' and no open "
              + "files")
  @MethodSource("argumentsForCurator")
  void
      shouldAllowCuratorFromCuratingInstitutionWhenChannelIsClaimedByRegistratorInstitutionWithPublishingPolicyEveryoneAndPublicationHasNoApprovedFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var curatingInstitution = suite.curatingInstitution();
    ...
    var publication =
        createNonDegreePublicationWithoutFinalizedFiles(owningInstitution.registrator());
    setContributor(publication, curatingInstitution.contributor());
  ...
  @MethodSource("argumentsForRegistrator")
  void
      shouldAllowRegistratorWhenChannelIsClaimedByOwnInstitutionWithPublishingPolicyOwnerOnlyAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForCurator")
  void
      shouldAllowCuratorWhenChannelIsClaimedByOwnInstitutionWithPublishingPolicyOwnerOnlyAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForContributor")
  void
      shouldAllowContributorFromSameInstitutionWhenChannelIsClaimedByContributorInstitutionWithPublishingPolicyOwnerOnlyAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @DisplayName(
      value =
          "Should deny curator from curating institution {0} operation on publication with "
              + "channel claimed by own institution with publishing policy 'OwnerOnly' and no open "
              + "files")
  void
      shouldDenyUpdateForCuratorFromCuratingInstitutionWhenChannelIsClaimedByRegistratorInstitutionWithPublishingPolicyOwnerOnlyAndPublicationHasNoOpenFile()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var curatingInstitution = suite.curatingInstitution();
    ...
    Assertions.assertFalse(
        PublicationPermissions.create(resource, userInstance).allowsAction(UPDATE));
  }

  @ParameterizedTest(
      name =
          "Should deny contributor from another institution {0} operation on publication with "
              + "channel claimed by own institution with publishing policy 'OwnerOnly' and no open "
              + "files")
  @MethodSource("argumentsForContributorExcludingUploadFileAndPartialUpdate")
  void
      shouldAllowContributorFromAnotherInstitutionWhenChannelIsClaimedByRegistratorInstitutionWithPublishingPolicyEveryoneAndPublicationHasNoOpenFile(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow registrator {0} operation on publication with open files and channel "
              + "claimed by own institution with editing policy 'Everyone'")
  @MethodSource("argumentsForRegistratorAfterOpenFiles")
  void
      shouldAllowRegistratorWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyEveryoneAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow curator {0} operation on publication with open files and channel claimed "
              + "by own institution with editing policy 'Everyone'")
  @MethodSource("argumentsForCurator")
  void
      shouldAllowCuratorWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyEveryoneAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow contributor from same institution {0} operation on publication with open "
  ...
  void
      shouldAllowContributorFromSameInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyEveryoneAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForContributorAfterOpenFiles")
  void
      shouldAllowContributorFromAnotherInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyEveryoneAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should allow curator from curating institution {0} operation on publication with open "
              + "files and channel claimed by own institution with editing policy 'Everyone'")
  @MethodSource("argumentsForCurator")
  void
      shouldAllowCuratorFromCuratingInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyEveryoneAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForCurator")
  void
      shouldDenyCuratorFromNonCuratingInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyEveryoneAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForRegistratorAfterOpenFiles")
  void
      shouldAllowRegistratorWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyOwnerOnlyAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForCurator")
  void
      shouldAllowCuratorWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyOwnerOnlyAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForContributor")
  void
      shouldAllowContributorFromSameInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyOwnerOnlyAndPublicationHasApprovedFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForContributorExcludingUploadFileAndPartialUpdate")
  void
      shouldDenyContributorFromAnotherInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyOwnerOnlyAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @DisplayName(
      value =
          "Should deny curator from curating institution {0} operation on publication with open "
              + "files and channel claimed by own institution with editing policy 'OwnerOnly'")
  @Test
  void
      shouldDenyCuratorFromCuratingInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyOwnerOnlyAndPublicationHasOpenFiles()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @MethodSource("argumentsForCurator")
  void
      shouldDenyCuratorFromNonCuratingInstitutionWhenChannelIsClaimedByOwnInstitutionWithEditingPolicyOwnerOnlyAndPublicationHasOpenFiles(
          PublicationOperation operation) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @ParameterizedTest(
      name =
          "Should deny contributor from non curating institution {0} operation on publication with "
  ...
  void shouldDenyContributorFromNonCuratingInstitutionWhenChannelIsClaimedByTheirInstitution(
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(nonCuratingInstitution.contributor()), identityServiceClient);
  ...
  @ParameterizedTest(
      name =
          "Should allow curator from non curating institution {0} operation on publication "
  ...
  @ParameterizedTest(
      name =
          "Should allow editor from non curating institution {0} operation on publication "
  ...
  void shouldAllowEditorFromNonCuratingInstitutionWhenChannelIsClaimedByEditorInstitution(
    ...
    var publication =
        createNonDegreePublicationWithoutFinalizedFiles(registrator)
            .copy()
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(
            toRequestInfo(nonCuratingInstitution.editor()), identityServiceClient);
  ...
  @DisplayName(
      value =
          "Should deny editor from non curating institution {0} operation on publication "
  ...
  @Test
  void
      shouldAllowContributorFromAnotherInstitutionToUploadFileOnPublicationWithClaimedChannelWithPolicyOwnerOnly()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @Test
  void
      shouldAllowCuratorFromCuratingInstitutionToUploadFileOnPublicationWithClaimedChannelWithPolicyOwnerOnly()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @Test
  void
      shouldAllowRegistratorWhenChannelIsClaimedByAnotherInstitutionWithEditingPolicyOwnerOnlyButOutsideOfScope()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @Test
  void
      shouldAllowCuratorWhenChannelIsClaimedByAnotherInstitutionWithEditingPolicyOwnerOnlyButOutsideOfScope()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
  ...
  @Test
  void
      shouldAllowEditorWhenChannelIsClaimedByAnotherInstitutionWithEditingPolicyOwnerOnlyButOutsideOfScope()
          throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var registrator = owningInstitution.registrator();
    ...
    var userInstance =
        RequestUtil.createUserInstanceFromRequest(toRequestInfo(editor), identityServiceClient);
    Assertions.assertTrue(
        PublicationPermissions.create(resource, userInstance).allowsAction(UPDATE));
  }
  ...
  @EnumSource(
      ...
      mode = Mode.EXCLUDE,
      names = {"DRAFT"})
  void shouldDenyUserByChannelClaimWhenPublicationHasFinalizedFilesRegardlessOfPublicationStatus(
      PublicationStatus status) throws JsonProcessingException, UnauthorizedException {
    var suite = InstitutionSuite.random();
    var owningInstitution = suite.owningInstitution();
    var nonCuratingInstitution = suite.nonCuratingInstitution();
    var registrator = owningInstitution.registrator();
  ...
  private static Stream<Arguments> argumentsForRegistratorAfterOpenFiles() {
    final var operations =
        Set.of(UPDATE, PublicationOperation.UPLOAD_FILE, PublicationOperation.PARTIAL_UPDATE);
  ...
  private static Stream<Arguments> argumentsForContributorExcludingUploadFileAndPartialUpdate() {
    final var operations = Set.of(UPDATE, PublicationOperation.UNPUBLISH);
  ...
  private static UserInstance createExternalUser(Resource resource) {
    return UserInstance.createExternalUser(
        resource.toPublication().getResourceOwner(), randomUri(), ThirdPartySystem.OTHER);
  }

  private RequestInfo toRequestInfo(User user) throws JsonProcessingException {
    return createUserRequestInfo(
        user.name(),
        user.customer(),
        user.accessRights(),
        user.cristinId(),
  ...
  private Publication createNonDegreePublicationWithFinalizedFiles(User registrator) {
    return createPublicationWithFinalizedFiles(
  ...
  private Publication createNonDegreePublicationWithoutFinalizedFiles(User registrator) {
    return createPublicationWithoutFinalizedFiles(
        AcademicArticle.class,
        registrator.name(),
        registrator.customer(),
        registrator.topLevelCristinId());
