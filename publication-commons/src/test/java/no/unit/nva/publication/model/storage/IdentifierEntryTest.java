...
public class IdentifierEntryTest {
  ...
  public void createReturnsIdentifierEntryWithNonEmptyIdentifier() {
    ...
    String expectedIdentifierPartitionKey =
        identifierEntry.getType() + KEY_FIELDS_DELIMITER + SAMPLE_IDENTIFIER.toString();
    assertThat(
        identifierEntry.getPrimaryKeyPartitionKey(), is(equalTo(expectedIdentifierPartitionKey)));
  }
}
