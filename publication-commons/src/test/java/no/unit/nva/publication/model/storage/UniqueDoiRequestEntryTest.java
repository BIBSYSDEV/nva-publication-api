...
public class UniqueDoiRequestEntryTest {
  ...
  public void createReturnObjectWithPartitionKeyContainingTheInputEntryIdentifier() {
    ...
    String expectedIdentifierPartitionKey =
        uniqueDoiRequestEntry.getType() + KEY_FIELDS_DELIMITER + RESOURCE_IDENTIFIER;
    assertThat(
        uniqueDoiRequestEntry.getPrimaryKeyPartitionKey(),
        is(equalTo(expectedIdentifierPartitionKey)));
  }
