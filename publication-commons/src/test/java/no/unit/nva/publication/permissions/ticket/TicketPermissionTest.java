...
class TicketPermissionTest {
  ...
  void shouldAllowApproveOperation() throws ConflictException {
    ...
    var ticket =
        TicketEntry.createNewTicket(
            resource.toPublication(), PublishingRequestCase.class, SortableIdentifier::next);
    ticket.setReceivingOrganizationDetails(
        new ReceivingOrganizationDetails(
    ...
    var ticketPermissions =
        TicketPermissions.create(ticket, userInstance, resource, publicationPermissions);
  ...
  void shouldDenyWhenMissingAccessRights() throws ConflictException {
    ...
    assertThrows(
        UnauthorizedException.class, () -> ticketPermissions.authorize(TicketOperation.APPROVE));
  }
