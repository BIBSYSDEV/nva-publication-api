...
public class ResourceTest {
  ...
  public static final Set<String> FIELDS_TO_IGNORE =
      Set.of(
          IMPORT_STATUS,
          REVISION,
          IMPORT_DETAILS,
  ...
  private final Javers javers =
      JaversBuilder.javers()
          .registerEntity(
              EntityDefinitionBuilder.entityDefinition(Resource.class)
  ...
  void fromDtoToDaoToDtoReturnsDtoWithoutLossOfInformation(Class<?> publicationInstanceType) {
    ...
    assertThat(
        expected,
        doesNotHaveEmptyValuesIgnoringFields(Set.of(DOI_REQUEST_FIELD, REVISION, IMPORT_DETAILS)));
  ...
  void shouldReturnTrueWhenResourceIsPresent() {
    ...
    resource.setResourceEvent(
        new CreatedResourceEvent(
            Instant.now(), new User(randomString()), randomUri(), SortableIdentifier.next(), null));
  ...
  void shouldReturnFileByIdentifier() {
    ...
    var fileByIdentifier =
        Resource.fromPublication(publication).getFileByIdentifier(file.getIdentifier());
  ...
  void shouldReturnPublisherWhenInstanceTypeIsSubtypeOfDegreeButContextIsNotDegree() {
    ...
    var reference =
        new Reference.Builder()
            .withPublishingContext(book)
            .withPublicationInstance(bachelor)
            .build();
