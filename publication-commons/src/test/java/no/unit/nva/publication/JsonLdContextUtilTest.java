...
public class JsonLdContextUtilTest {
  ...
  public void readingExistingPublicationFileReturnsData() {
    Optional<JsonNode> publicationContext =
        contextUtil.getPublicationContext(PUBLICATION_CONTEXT_JSON);
  ...
  public void readingMissingFileReturnsEmptyData() {
    Optional<JsonNode> publicationContext = contextUtil.getPublicationContext(MISSING_FILE_JSON);
