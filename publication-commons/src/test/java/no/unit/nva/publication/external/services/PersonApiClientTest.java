...
class PersonApiClientTest {
  ...
  public void init() {
    ...
    successfulNonEmptyResponse =
        PersonApiResponseBodyMock.createResponse(inputFeideId, mockOrgUnitId).toString();
  ...
  void shouldReturnPersonsOrgUnitIdsWhenInputIsUserExistingInPersonService()
    ...
    personApiClient =
        new PersonApiClient(createMockHttpClientReturningResponse(successfulNonEmptyResponse()));
  ...
  void shouldReturnEmptyListIfUserWasNotFoundInPersonService()
      throws IOException, InterruptedException, ApiGatewayException {
    personApiClient =
        new PersonApiClient(createMockHttpClientReturningResponse(successfulEmptyResponse()));
    var userAffiliations = personApiClient.fetchAffiliationsForUser(inputFeideId);
