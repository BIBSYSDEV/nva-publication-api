...
class TicketStatusTest {
    ...
    void validStatusChanges(TicketStatus existingState,
                            TicketStatus requestedChange,
                            TicketStatus expectedState) {
    ...
    void invalidStatusChanges(TicketStatus existingState,
                              TicketStatus requestedChange) {
