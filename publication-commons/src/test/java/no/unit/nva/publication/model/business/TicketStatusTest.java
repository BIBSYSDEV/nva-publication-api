...
class TicketStatusTest {
  ...
  void validStatusChanges(
      TicketStatus existingState, TicketStatus requestedChange, TicketStatus expectedState) {
  ...
  void invalidStatusChanges(TicketStatus existingState, TicketStatus requestedChange) {
    var actualException =
        assertThrows(
            IllegalArgumentException.class, () -> existingState.changeStatus(requestedChange));
    assertThat(
        actualException.getMessage(),
        is(equalTo(existingState.getErrorMessageForNotAllowedStatusChange(requestedChange))));
  }
}
