...
public class ImportCandidateServiceTest extends ResourcesLocalTest {
  ...
  void shouldUpdateImportStatus() throws NotFoundException {
    ...
    resourceService.updateImportStatus(
  ...
  void shouldThrowBadMethodExpectedWhenDeletingImportCandidateWithStatusImported()
    ...
    resourceService.updateImportStatus(
        ...
        ImportStatusFactory.createImported(randomString(), SortableIdentifier.next()));
    assertThrows(
        BadMethodException.class, () -> resourceService.deleteImportCandidate(importCandidate));
  }
  ...
  void shouldUpdateExistingNotImportedImportCandidate()
    ...
    var expectedImportCandidate =
        updatedImportCandidate
            .copy()
  ...
  void shouldOverwriteFilesWhenUpdatingExistingNotImportedImportCandidate()
    ...
    var updatedImportCandidate =
        existingImportCandidate.copy().withAssociatedArtifacts(List.of(newFile)).build();
    resourceService.updateImportCandidate(updatedImportCandidate);
    var fetchedImportCandidate =
        resourceService.getImportCandidateByIdentifier(existingImportCandidate.getIdentifier());

    assertThat(
        fetchedImportCandidate.getAssociatedArtifacts(),
  ...
  void shouldThrowExceptionWhenCanNotFetchImportCandidateWhenUpdatingIt() {
    var importCandidate = randomImportCandidate();
    assertThrows(
        NotFoundException.class, () -> resourceService.updateImportCandidate(importCandidate));
  }
