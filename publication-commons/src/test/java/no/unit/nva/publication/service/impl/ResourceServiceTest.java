...
class ResourceServiceTest extends ResourcesLocalTest {
  ...
  private static final String ENTITY_DESCRIPTION_DOES_NOT_HAVE_FIELD_ERROR =
    EntityDescription.class.getName()
  ...
  void shouldKeepImportedDataCreationDates() throws NotFoundException {
    ...
    var savedPublicationIdentifier = resourceService.createPublicationWithPredefinedCreationDate(
        inputPublication)
      .getIdentifier();
  ...
  void shouldKeepImportedEntryCreationAndModifiedDates() throws NotFoundException {
    ...
    var inputPublication = randomPublication().copy()
      ...
      .build();
    var savedPublicationIdentifier = resourceService.createPublicationFromImportedEntry(
        inputPublication)
      .getIdentifier();
    var savedPublication = resourceService.getPublicationByIdentifier(savedPublicationIdentifier);
  ...
  void createResourceThrowsTransactionFailedExceptionWhenResourceWithSameIdentifierExists()
    ...
    assertThat(sampleResource.getPublisher().getId(),
      is(not(equalTo(collidingResource.getPublisher().getId()))));
  }
  ...
  void createPublicationReturnsNullWhenResourceDoesNotBecomeAvailable() throws BadRequestException {
    ...
    ResourceService resourceService = resourceServiceThatDoesNotReceivePublicationUpdateAfterCreation(
      client);
  ...
  void getResourceByIdentifierReturnsResourceWhenResourceExists() throws ApiGatewayException {
    ...
    Publication savedResource = resourceService.getPublication(userInstance,
      sampleResource.getIdentifier());
  ...
  void whenPublicationOwnerIsUpdatedThenBothOrganizationAndUserAreUpdated()
    ...
    Publication newResource = resourceService.getPublication(newOwner,
      originalResource.getIdentifier());

    assertThat(newResource.getResourceOwner().getOwner().getValue(),
      is(equalTo(newOwner.getUsername())));
  ...
  void createResourceThrowsTransactionFailedExceptionWithInternalCauseWhenCreatingResourceFails() {
    ...
    TransactionFailedException actualException = assertThrows(TransactionFailedException.class,
      action);
  ...
  void getResourcesByCristinIdentifierReturnsAllResourcesWithCristinIdentifier() {
    ...
    List<Publication> actualPublication = resourceService.getPublicationsByCristinIdentifier(
      cristinIdentifier);
  ...
  void getResourcePropagatesJsonProcessingExceptionWhenExceptionIsThrown() {
    ...
    AmazonDynamoDB mockClient = mock(AmazonDynamoDB.class);
    Item invalidItem = new Item().withString(SOME_INVALID_FIELD, SOME_STRING);
    GetItemResult responseWithInvalidItem = new GetItemResult().withItem(
  ...
  void byTypeCustomerStatusIndexIsUpdatedWhenResourceIsUpdated() throws ApiGatewayException {
    ...
    ResourceDao resourceDaoWithStatusDraft = new ResourceDao(
  ...
  void publishResourceThrowsInvalidPublicationExceptionExceptionWhenResourceHasNoTitle()
    ...
    Executable action = () -> resourceService.publishPublication(
  ...
  void markPublicationForDeletionThrowsExceptionWhenDeletingPublishedPublication()
    ...
    Executable action = () -> resourceService.markPublicationForDeletion(
      UserInstance.fromPublication(resource),
      resource.getIdentifier());
  ...
  void markPublicationForDeletionLogsConditionExceptionWhenUpdateConditionFails()
    ...
    assertThat(testAppender.getMessages(),
      containsString(ConditionalCheckFailedException.class.getName()));
  }
  ...
  void deletePublicationCanMarkDraftForDeletion() throws ApiGatewayException {
    ...
    Publication resourceUpdate = resourceService.markPublicationForDeletion(
      UserInstance.fromPublication(resource),
      resource.getIdentifier());
    assertThat(resourceUpdate.getStatus(),
  ...
  void markPublicationForDeletionReturnsUpdatedResourceWithStatusDraftForDeletion()
    ...
    Publication resource = createPersistedPublicationWithDoi();
    var userInstance = UserInstance.fromPublication(resource);
    var resourceUpdate = resourceService.markPublicationForDeletion(userInstance,
      resource.getIdentifier());
    assertThat(resourceUpdate.getStatus(),
      Matchers.is(Matchers.equalTo(PublicationStatus.DRAFT_FOR_DELETION)));
  }
  ...
  void updateResourceUpdatesLinkedDoiRequestUponUpdate() throws ApiGatewayException {
    ...
    expectedDoiRequest.setPublicationDetails(
      expectedDoiRequest.getPublicationDetails()
        .update(Resource.fromPublication(updatedPublication)));
    ...
    assertThat(updatedDoiRequest,
      doesNotHaveEmptyValuesIgnoringFields(Set.of(ASSIGNEE1, FINALIZED_BY,
        FINALIZED_DATE)));
  }
  ...
  void updateResourceUpdatesAllFieldsInDoiRequest() throws ApiGatewayException {
    ...
    var publicationUpdate = updateAllPublicationFieldsExpectIdentifierStatusAndOwnerInfo(
      initialPublication);
    ...
    var expectedDoiRequest = expectedDoiRequestAfterPublicationUpdate(initialPublication,
      initialDoiRequest,
      publicationUpdate, updatedDoiRequest);

    assertThat(updatedDoiRequest,
      doesNotHaveEmptyValuesIgnoringFields(Set.of(ASSIGNEE, FINALIZED_BY,
        FINALIZED_DATE)));
    assertThat(expectedDoiRequest,
      doesNotHaveEmptyValuesIgnoringFields(Set.of(ASSIGNEE, FINALIZED_BY,
        FINALIZED_DATE)));
  ...
  void updateResourceDoesNotCreateDoiRequestWhenItDoesNotPreexist() throws BadRequestException {
    ...
    var expectedNonExistingTicket = ticketService.fetchTicketByResourceIdentifier(
  ...
  void getResourceByIdentifierReturnsExistingResource() throws ApiGatewayException {
    ...
    Publication retrievedResource = resourceService.getPublicationByIdentifier(
      resource.getIdentifier());
  ...
  void shouldBePossibleToSetPublicationStatusToDeletedForPublishedPublication()
    ...
    assertThat(actualPublicationInDatabaseAfterStatusUpdate.getStatus(),
  ...
  private Set<Publication> createSamplePublicationsOfSingleCristinIdentifier(
    String cristinIdentifier) {
    UserInstance userInstance = UserInstance.create(randomString(), randomUri());
    return Stream.of(publicationWithIdentifier(), publicationWithIdentifier(),
        publicationWithIdentifier())
  ...
  private Publication createPersistedPublicationWithDoi(ResourceService resourceService,
    Publication sampleResource)
    throws BadRequestException {
  ...
  private SortableIdentifier extractIdentifierFromFirstScanResult(
    ...
    return listingResult.getDatabaseEntries().stream().collect(SingletonCollector.collect())
      .getIdentifier();
  }
  ...
  private Publication publishResource(Publication resource) throws ApiGatewayException {
    resourceService.publishPublication(UserInstance.fromPublication(resource),
      resource.getIdentifier());
    return resourceService.getPublication(resource);
  }

  private ResourceService resourceServiceThatDoesNotReceivePublicationUpdateAfterCreation(
  ...
  private Publication updateAllPublicationFieldsExpectIdentifierStatusAndOwnerInfo(
  ...
  private void verifyThatTheResourceIsInThePublishedResources(Publication resourceWithStatusDraft) {
    ResourceDao resourceDaoWithStatusPublished = queryObjectForPublishedResource(
      resourceWithStatusDraft);
  ...
  private void assertThatResourceCanBeFoundInDraftResources(
    ResourceDao resourceDaoWithStatusDraft) {
  ...
  private Optional<ResourceDao> parseResult(QueryResult result) {
    return result.getItems().stream().map(map -> parseAttributeValuesMap(map, ResourceDao.class))
      .findAny();
  }
  ...
  private void assertThatJsonProcessingErrorIsPropagatedUp(
    Class<JsonProcessingException> expectedExceptionClass,
    Executable action) {
  ...
  private Publication createPublicationWithStatus(UserInstance userInstance,
    PublicationStatus status) {
    var publication = injectOwner(userInstance, publicationWithIdentifier());
    publicationWithIdentifier().setStatus(status);
    return attempt(
      () -> createPersistedPublicationWithDoi(resourceService, publication)).orElseThrow();
  }
  ...
  private Publication updateResourceTitle(Publication resource) {
    EntityDescription newEntityDescription = new EntityDescription.Builder().withMainTitle(
      UPDATED_TITLE).build();

    assertThatNewEntityDescriptionDiffersOnlyInTitle(resource.getEntityDescription(),
  ...
  private void assertThatNewEntityDescriptionDiffersOnlyInTitle(
    EntityDescription oldEntityDescription,
  ...
  private String fetchMainTitleFieldName() {
    return attempt(
      () -> EntityDescription.class.getDeclaredField(MAIN_TITLE_FIELD).getName()).orElseThrow(
