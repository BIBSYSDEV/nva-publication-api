...
import no.unit.nva.publication.exception.ResourceCannotBeDeletedException;
...
public class ResourceServiceTest extends ResourcesDynamoDbLocalTest {
    ...
    @Test
    public void createPublicationCreatesResource() throws NotFoundException, TransactionFailedException {
    ...
    @Test
    public void createPublicationThrowsTransactionFailedExceptionWhenResourceWithSameIdentifierExists()
    ...
    @Test
    public void createPublicationSavesResourcesWithSameOwnerAndPublisherButDifferentIdentifier()
        throws TransactionFailedException {
        final Publication sampleResource = publicationWithIdentifier();
    ...
    @Test
    public void createPublicationThrowsTransactionFailedExceptionWithInternalCauseWhenCreatingResourceFails() {
        AmazonDynamoDB client = mock(AmazonDynamoDB.class);
    ...
    public void publishResourceThrowsInvalidPublicationExceptionExceptionWhenResourceHasNoLinkAndNoFiles()
        ...
        Executable action =
            () -> publishPublication(savedResource);
        InvalidPublicationException exception = assertThrows(InvalidPublicationException.class, action);
        String actualMessage = exception.getMessage();
    ...
    @Test
    public void publishPublicationPublishesResourceWhenLinkIsPresentButNoFiles() throws ApiGatewayException {
        
        Publication sampleResource = publicationWithIdentifier();
        sampleResource.setLink(SOME_LINK);
        sampleResource.setFileSet(emptyFileSet());
        Publication savedResource = resourceService.createPublication(sampleResource);
        Publication updatedResource = publishPublication(savedResource);
        assertThat(updatedResource.getStatus().toString(), is(equalTo(PublicationStatus.PUBLISHED.toString())));
    }
    
    public Publication publishPublication(Publication resource) throws ApiGatewayException {
    ...
    @Test
    public void publishPublicationPublishesResourceWhenResourceHasFilesButNoLink() throws ApiGatewayException {
        
        Publication sampleResource = createSampleResourceWithDoi();
        sampleResource.setLink(null);
        
        Publication updatedResource =
            publishPublication(sampleResource);
        assertThat(updatedResource.getStatus(), is(equalTo(PublicationStatus.PUBLISHED)));
    }
    
    @Test
    public void publishPublicationUpdatesResourceStatusInResourceWithDoiRequest()
        throws ApiGatewayException {
    ...
    @Test
    public void createPublicationReturnsNewIdentifierWhenResourceIsCreated() throws TransactionFailedException {
