...
class ResourceEventTest {
  ...
  public static Stream<Arguments> resourceEventProvider() {
    return Stream.of(
        ...
        Arguments.of(
            new DeletedResourceEvent(Instant.now(), randomUser(), randomUri(), identifier()),
            PUBLICATION_DELETED),
        Arguments.of(
        ...
        Arguments.of(
            ImportedResourceEvent.fromImportSource(
                getImportSource(), randomUserInstance(), Instant.now()),
        ...
        Arguments.of(
            ...
            PUBLICATION_MERGED),
        Arguments.of(
            UpdatedResourceEvent.create(randomUserInstance(), Instant.now()), PUBLICATION_UPDATED),
        Arguments.of(
            UpdatedResourceEvent.create(randomExternalUserInstance(), Instant.now()),
            PUBLICATION_UPDATED));
  }

  public static Stream<Arguments> ticketEventProvider() {
    return Stream.of(
        Arguments.of(DoiRequestedEvent.create(randomUserInstance(), Instant.now()), DOI_REQUESTED),
  ...
  void shouldConvertResourceEventToLogEntryWithExpectedTopic(
      ResourceEvent resourceEvent, LogTopic expectedLogTopic) {
  ...
  void shouldConvertTicketEventToLogEntryWithExpectedTopic(
      TicketEvent resourceEvent, LogTopic expectedLogTopic) {
