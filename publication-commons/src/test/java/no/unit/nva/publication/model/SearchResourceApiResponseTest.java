...
public class SearchResourceApiResponseTest {
  ...
  @Test
  void shouldBeAbleToConvertSearchResourceApiRequestToJsonAndBackAgain()
      throws JsonProcessingException {
    var resourceWithId =
        new ResourceWithId(
            UriWrapper.fromUri(
                    "https://api.test.nva.aws.unit.no/publication/" + SortableIdentifier.next())
                .getUri());
    ...
    var parsedSearchResponse =
        JsonUtils.dtoObjectMapper.readValue(json, SearchResourceApiResponse.class);
