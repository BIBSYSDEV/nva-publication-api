...
class MessageTest extends TestDataSource {
  ...
  @Test
  void shouldSerializeMessageWithStatusActiveWhenMessageStatusIsNull()
  ...
  private static Publication randomDegreePublicationEligibleForDoiRequest() {
    return randomDegreePublication()
        .copy()
  ...
  private Message createSampleMessage() throws ConflictException {
    ...
    var ticket =
        TicketEntry.createNewTicket(
            publication, GeneralSupportRequest.class, SortableIdentifier::next);
