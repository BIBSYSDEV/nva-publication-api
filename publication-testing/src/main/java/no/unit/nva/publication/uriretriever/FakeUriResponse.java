...
public final class FakeUriResponse {
    ...
    private static final URI HARD_CODED_TOP_LEVEL_ORG_URI = constructCristinOrgUri(ORGANIZATION_BASE + ".0.0.0");
    private static final URI HARD_CODED_LEVEL_2_ORG_URI = constructCristinOrgUri(ORGANIZATION_BASE + ".1.0.0");
    private static final URI HARD_CODED_LEVEL_3_ORG_URI = constructCristinOrgUri(ORGANIZATION_BASE + ".1.1.0");
