...
public final class PublicationInstanceMapper {
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenPopularScienceArticle(Record brageRecord) {
    return new PopularScienceArticle(
        extractPages(brageRecord), extractVolume(brageRecord), extractIssue(brageRecord), null);
  }

  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenPopularScienceMonograph(Record brageRecord) {
  ...
  private static boolean containsEditor(Record record) {
    return record.getEntityDescription().getContributors().stream()
        .anyMatch(PublicationInstanceMapper::isEditor);
  }
  ...
  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenJournalIssue(
      Record record) {
    return new JournalIssue(
        extractVolume(record),
        extractIssue(record),
        extractArticleNumber(record),
        extractPages(record));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenEditorial(
      Record brageRecord) {
    return new JournalLeader(
        extractVolume(brageRecord), extractIssue(brageRecord),
  ...
  private static MovingPicture buildPublicationInstanceWhenFilm() {
    return new MovingPicture(
        MovingPictureSubtype.createOther(null), null, List.of(), NullDuration.create());
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenTextbook(
      Record brageRecord) {
    return new Textbook(extractMonographPages(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenAnthology(
      Record brageRecord) {
    return new BookAnthology(extractMonographPages(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenReaderOpinion(
      Record brageRecord) {
    return new MediaReaderOpinion(
        extractVolume(brageRecord), extractIssue(brageRecord), null, extractPages(brageRecord));
  }
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenProfessionalArticle(Record brageRecord) {
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenOtherPresentation() {
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenConferencePoster() {
    return new ConferencePoster();
  }

  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenPlanOrBluePrint() {
    return new Architecture(
        ArchitectureSubtype.create(ArchitectureSubtypeEnum.OTHER), null, Collections.emptyList());
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenChapter(
      Record brageRecord) {
  ...
  private static List<MusicPerformanceManifestation> extractManifestation(Record brageRecord) {
    return brageRecord.getPublication().getIsmnList().stream()
  ...
  private static Ismn createIsmn(String ismn) {
    return attempt(() -> new Ismn(ismn))
        .orElseThrow(e -> new InvalidIsmnRuntimeException(e.getException()));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenDesignProduct() {
    return new ArtisticDesign(
        ArtisticDesignSubtype.create(ArtisticDesignSubtypeEnum.OTHER),
        null,
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenMediaFeatureArticle(Record brageRecord) {
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenReportWorkingPaper(Record brageRecord) {
  ...
  private static PublicationInstance<? extends Pages>
      buildPublicationInstanceWhenScientificMonograph(Record brageRecord) {
  ...
  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenOtherStudentWork(
      Record brageRecord) {
    return new OtherStudentWork(
        extractMonographPages(brageRecord), extractPublicationDate(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenResearchReport(
      Record brageRecord) {
    return new ReportResearch(extractMonographPages(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenReport(
      Record brageRecord) {
    return new ReportBasic(extractMonographPages(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenBook(
      Record brageRecord) {
    return new NonFictionMonograph(extractMonographPages(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenDataset(
      Record brageRecord) {
    return new DataSet(
        false,
        new GeographicalDescription(String.join(", ", extractSpatialCoverage(brageRecord))),
        null,
        null,
        null);
  }
  ...
  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenMap(
      Record brageRecord) {
  ...
  private static String generateBegin(
      no.sikt.nva.brage.migration.record.PublicationInstance publicationInstance) {
    return Optional.ofNullable(publicationInstance.getPages())
        .map(no.sikt.nva.brage.migration.record.Pages::getRange)
  ...
  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenMasterThesis(
      Record brageRecord) {
    return new DegreeMaster(
        extractMonographPages(brageRecord), extractPublicationDate(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenBachelorThesis(
      Record brageRecord) {
    return new DegreeBachelor(
        extractMonographPages(brageRecord), extractPublicationDate(brageRecord));
  }

  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenDoctoralThesis(
      Record brageRecord) {
    return new DegreePhd(
        extractMonographPages(brageRecord),
        extractPublicationDate(brageRecord),
  ...
  private static PublicationInstance<? extends Pages> buildPublicationInstanceWhenJournalArticle(
      Record brageRecord) {
    return new ProfessionalArticle(
        extractPages(brageRecord),
        extractVolume(brageRecord),
        extractIssue(brageRecord),
