...
import no.sikt.nva.brage.migration.merger.publicationisntancemerger.DegreeBachelorMerger;
import no.sikt.nva.brage.migration.merger.publicationisntancemerger.DegreeLicentiateMerger;
import no.sikt.nva.brage.migration.merger.publicationisntancemerger.DegreeMasterMerger;
import no.sikt.nva.brage.migration.merger.publicationisntancemerger.DegreePhdMerger;
import no.sikt.nva.brage.migration.merger.publicationisntancemerger.OtherStudentWorkMerger;
...
public class CristinImportPublicationMerger {
    ...
    private PublicationContext determinePublicationContext(Reference reference)
        ...
        return switch (publicationContext) {
            ...
            case Event event -> EventMerger.merge(event, bragePublicationContext);
            case Anthology anthology -> AnthologyMerger.merge(anthology, bragePublicationContext);
