...
public final class MediaContributionMerger extends PublicationContextMerger {
  ...
  public static MediaContribution merge(
      MediaContribution mediaContribution, PublicationContext publicationContext) {
  ...
  private static SeriesEpisode getPartOf(
      MediaContribution oldMediaContribution, MediaContribution newMediaContribution) {
  ...
  private static MediaSubType getMedium(
      MediaContribution oldMediaContribution, MediaContribution newMediaContribution) {
