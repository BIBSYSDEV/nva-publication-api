...
public final class ReportBookOfAbstractMerger
    extends PublicationInstanceMerger<ReportBookOfAbstract> {
  ...
  public ReportBookOfAbstract merge(PublicationInstance<?> publicationInstance) {
    if (publicationInstance instanceof ReportBookOfAbstract newReportBookOfAbstract) {
      return new ReportBookOfAbstract(
          getPages(this.publicationInstance.getPages(), newReportBookOfAbstract.getPages()));
    } else {
