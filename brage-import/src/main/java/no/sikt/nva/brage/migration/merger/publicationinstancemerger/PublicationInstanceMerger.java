...
public abstract class PublicationInstanceMerger<T extends PublicationInstance<?>> {
  ...
  public static PublicationInstanceMerger<?> of(PublicationInstance<? extends Pages> instance) {
    return switch (instance) {
      ...
      case ReportWorkingPaper reportWorkingPaper ->
          new ReportWorkingPaperMerger(reportWorkingPaper);
      case ReportBookOfAbstract reportBookOfAbstract ->
          new ReportBookOfAbstractMerger(reportBookOfAbstract);
      ...
      case ProfessionalArticle professionalArticle ->
          new ProfessionalArticleMerger(professionalArticle);
      case AcademicArticle academicArticle -> new AcademicArticleMerger(academicArticle);
      case MediaFeatureArticle mediaFeatureArticle ->
          new MediaFeatureArticleMerger(mediaFeatureArticle);
      case NonFictionMonograph nonFictionMonograph ->
          new NonFictionMonographMerger(nonFictionMonograph);
      ...
      case MediaReaderOpinion mediaReaderOpinion ->
          new MediaReaderOpinionMerger(mediaReaderOpinion);
  ...
  public static <T, C extends Collection<T>> C mergeCollections(
      C oldCollection, C newCollection, Supplier<C> collectionFactory) {
