...
public final class NonFictionMonographMerger
    extends PublicationInstanceMerger<NonFictionMonograph> {
  ...
  public NonFictionMonograph merge(PublicationInstance<?> publicationInstance) {
    if (publicationInstance instanceof NonFictionMonograph newNonFictionMonograph) {
      return new NonFictionMonograph(
          getPages(this.publicationInstance.getPages(), newNonFictionMonograph.getPages()));
    } else {
