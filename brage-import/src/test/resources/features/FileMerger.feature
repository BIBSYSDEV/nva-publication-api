Feature:
  ...
  Scenario: The brage publication has a published publisherVersion and the existing file is accepted version and the publication instance is academic article
    Given a brage publication with handle "https://hdl.handle.net/11250/2506045"
    And the nva publication has main handle "https://hdl.handle.net/11250/12345"
    And both the publication instance is academic article
    And the nva publication has a file with values:
      | filename | identifier                           | mimeType | size | lisense | publisherVersion | embargoDate | publishedDate                  |
      | b.pdf    | 12234567-36ee-467b-b145-12bc5b3b9d9e | pdf      | 1232 | null    | ACCEPTED_VERSION | null        | 2019-02-20T11:48:59.131046060Z |
    And the brage publication has a file with values:
      | filename | identifier                           | mimeType                                                                  | size | lisense | publisherVersion  | embargoDate | publishedDate                  |
      | a.pptx   | 9ba7b547-36ee-467b-b145-12bc5b3b9d9e | application/vnd.openxmlformats-officedocument.presentationml.presentation | 123  | null    | PUBLISHED_VERSION | null        | 2023-10-20T11:48:59.131046060Z |
    When the nva publications are merged
    Then the merged nva publication has a file with values:
      | filename | identifier                           | mimeType                                                                  | size | lisense | publisherVersion  | embargoDate | publishedDate                  |
      | a.pptx   | 9ba7b547-36ee-467b-b145-12bc5b3b9d9e | application/vnd.openxmlformats-officedocument.presentationml.presentation | 123  | null    | PUBLISHED_VERSION | null        | 2023-10-20T11:48:59.131046060Z |
    And the merged nva publication has a handle equal to "https://hdl.handle.net/11250/2506045" in additional identifiers
    And the merged nva publication has a root level handle equal to "https://hdl.handle.net/11250/12345"
