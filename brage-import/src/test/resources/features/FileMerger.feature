Feature: Rules that apply for merging of existing publication in nva with brage-migration publication
...
#    And a nva publication with cristin identifier "1234"
  ...
  Scenario: The brage post with handle present in the main handle in nva publication considered as the master post
    Given a brage publication with cristin identifier "1234"
    And a nva publication with cristin identifier "1234"
    And a brage publication with handle "https://hdl.handle.net/11250/2506045"
    And the nva publication has a handle "https://hdl.handle.net/11250/2506045"
