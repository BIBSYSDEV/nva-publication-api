...
public class BrageEntryEventConsumerTest extends ResourcesLocalTest {
  ...
  private static final Type TYPE_BOOK =
      new Type(List.of(NvaType.BOOK.getValue()), NvaType.BOOK.getValue());
  private static final Type TYPE_CONFERENCE_REPORT =
      new Type(List.of(NvaType.CONFERENCE_REPORT.getValue()), NvaType.CONFERENCE_REPORT.getValue());
  private static final Type TYPE_PROFESSIONAL_ARTICLE =
      new Type(List.of(PROFESSIONAL_ARTICLE.getValue()), PROFESSIONAL_ARTICLE.getValue());
  private static final Type TYPE_PERFORMING_ARTS =
      new Type(List.of(PERFORMING_ARTS.getValue()), PERFORMING_ARTS.getValue());
  private static final Type TYPE_VISUAL_ARTS =
      new Type(List.of(VISUAL_ARTS.getValue()), VISUAL_ARTS.getValue());
  private static final Type TYPE_READER_OPINION =
      new Type(List.of(READER_OPINION.getValue()), READER_OPINION.getValue());
  private static final Type TYPE_ANTHOLOGY =
      new Type(List.of(ANTHOLOGY.getValue()), ANTHOLOGY.getValue());
  private static final Type TYPE_CRISTIN_RECORD =
      new Type(List.of(CRISTIN_RECORD.getValue()), CRISTIN_RECORD.getValue());
  private static final Type TYPE_TEXTBOOK =
      new Type(List.of(TEXTBOOK.getValue()), TEXTBOOK.getValue());
  private static final Type TYPE_FILM = new Type(List.of(FILM.getValue()), FILM.getValue());
  private static final Type TYPE_LITERARY_ARTS =
      new Type(List.of(LITERARY_ARTS.getValue()), LITERARY_ARTS.getValue());
  private static final Type TYPE_EXHIBITION_CATALOGUE =
      new Type(List.of(EXHIBITION_CATALOGUE.getValue()), EXHIBITION_CATALOGUE.getValue());
  private static final Type TYPE_POPULAR_SCIENCE_MONOGRAPH =
      new Type(List.of(POPULAR_SCIENCE_MONOGRAPH.getValue()), POPULAR_SCIENCE_MONOGRAPH.getValue());
  private static final Type TYPE_EDITORIAL =
      new Type(List.of(EDITORIAL.getValue()), EDITORIAL.getValue());
  private static final Type TYPE_POPULAR_SCIENCE_ARTICLE =
      new Type(List.of(POPULAR_SCIENCE_ARTICLE.getValue()), POPULAR_SCIENCE_ARTICLE.getValue());
  private static final Type TYPE_MUSIC =
      new Type(List.of(NvaType.RECORDING_MUSICAL.getValue()), NvaType.RECORDING_MUSICAL.getValue());
  private static final Type TYPE_DESIGN_PRODUCT =
      new Type(List.of(NvaType.DESIGN_PRODUCT.getValue()), NvaType.DESIGN_PRODUCT.getValue());
  private static final Type TYPE_PLAN_OR_BLUEPRINT =
      new Type(List.of(NvaType.PLAN_OR_BLUEPRINT.getValue()), NvaType.PLAN_OR_BLUEPRINT.getValue());
  private static final Type TYPE_MAP =
      new Type(List.of(NvaType.MAP.getValue()), NvaType.MAP.getValue());
  private static final Type TYPE_BOOK_OF_ABSTRACTS =
      new Type(List.of(NvaType.BOOK_OF_ABSTRACTS.getValue()), NvaType.BOOK_OF_ABSTRACTS.getValue());
  private static final Type TYPE_JOURNAL_ISSUE =
      new Type(List.of(NvaType.JOURNAL_ISSUE.getValue()), NvaType.JOURNAL_ISSUE.getValue());
  private static final Type TYPE_CONFERENCE_LECTURE =
      new Type(
          List.of(NvaType.CONFERENCE_LECTURE.getValue()), NvaType.CONFERENCE_LECTURE.getValue());
  private static final Type TYPE_REPORT =
      new Type(List.of(NvaType.REPORT.getValue()), NvaType.REPORT.getValue());
  private static final Type TYPE_RESEARCH_REPORT =
      new Type(List.of(NvaType.RESEARCH_REPORT.getValue()), NvaType.RESEARCH_REPORT.getValue());

  private static final Type TYPE_BACHELOR =
      new Type(List.of(NvaType.BACHELOR_THESIS.getValue()), NvaType.BACHELOR_THESIS.getValue());
  private static final Type TYPE_MASTER =
      new Type(List.of(NvaType.MASTER_THESIS.getValue()), NvaType.MASTER_THESIS.getValue());
  private static final Type TYPE_PHD =
      new Type(List.of(NvaType.DOCTORAL_THESIS.getValue()), NvaType.DOCTORAL_THESIS.getValue());
  private static final Type TYPE_STUDENT_PAPER_OTHERS =
      new Type(
          List.of(NvaType.STUDENT_PAPER_OTHERS.getValue()),
          NvaType.STUDENT_PAPER_OTHERS.getValue());
  private static final Type TYPE_OTHER_STUDENT_WORK =
      new Type(List.of(NvaType.STUDENT_PAPER.getValue()), NvaType.STUDENT_PAPER.getValue());
  private static final Type TYPE_CONFERENCE_POSTER =
      new Type(List.of(NvaType.CONFERENCE_POSTER.getValue()), NvaType.CONFERENCE_POSTER.getValue());
  private static final Type TYPE_SCIENTIFIC_MONOGRAPH =
      new Type(
          List.of(NvaType.SCIENTIFIC_MONOGRAPH.getValue()),
          NvaType.SCIENTIFIC_MONOGRAPH.getValue());
  private static final Type TYPE_INTERVIEW =
      new Type(List.of(NvaType.INTERVIEW.getValue()), NvaType.INTERVIEW.getValue());
  private static final Type TYPE_PRESENTATION_OTHER =
      new Type(
          List.of(NvaType.PRESENTATION_OTHER.getValue()), NvaType.PRESENTATION_OTHER.getValue());
  private static final Type TYPE_DATASET =
      new Type(List.of(NvaType.DATASET.getValue()), NvaType.DATASET.getValue());
  private static final Type TYPE_JOURNAL_ARTICLE =
      new Type(List.of(NvaType.JOURNAL_ARTICLE.getValue()), NvaType.JOURNAL_ARTICLE.getValue());

  private static final Type TYPE_SCIENTIFIC_ARTICLE =
      new Type(
          List.of(NvaType.SCIENTIFIC_ARTICLE.getValue()), NvaType.SCIENTIFIC_ARTICLE.getValue());
  ...
  private static final Organization TEST_ORGANIZATION =
      new Organization.Builder()
          .withId(URI.create("https://api.nva.unit.no/customer/test"))
          .build();
  private static final String FILENAME = "filename";
  private static final String HARD_CODED_CRISTIN_IDENTIFIER = "12345";
  private static final URI LICENSE_URI =
      URI.create("http://creativecommons.org/licenses/by-nc/4.0/");
  private static final Type TYPE_REPORT_WORKING_PAPER =
      new Type(List.of(NvaType.WORKING_PAPER.getValue()), NvaType.WORKING_PAPER.getValue());
  private static final Type TYPE_LECTURE =
      new Type(List.of(NvaType.LECTURE.getValue()), NvaType.LECTURE.getValue());
  private static final Type TYPE_CHAPTER =
      new Type(List.of(NvaType.CHAPTER.getValue()), NvaType.CHAPTER.getValue());
  private static final Type TYPE_SCIENTIFIC_CHAPTER =
      new Type(
          List.of(NvaType.SCIENTIFIC_CHAPTER.getValue()), NvaType.SCIENTIFIC_CHAPTER.getValue());
  private static final Type TYPE_MEDIA_FEATURE_ARTICLE =
      new Type(
          List.of(NvaType.MEDIA_FEATURE_ARTICLE.getValue()),
          NvaType.MEDIA_FEATURE_ARTICLE.getValue());
  private static final Type TYPE_SOFTWARE =
      new Type(List.of(NvaType.SOFTWARE.getValue()), NvaType.SOFTWARE.getValue());
  ...
  private static final String LEGAL_NOTE_REQUIRING_EMBARGO =
  ...
  private static Stream<Arguments> emptyPublicationInstanceSupplier() {
    return Stream.of(
        Arguments.of(new DegreePhd(null, null, Set.of()), TYPE_PHD),
  ...
  void shouldConvertBrageRecordToNvaPublicationWithCorrectCustomer() throws IOException {
    ...
    assertThatPublicationsMatch(
        actualPublication.publication(), brageGenerator.getNvaPublication());
  }

  @Test
  void
      shouldSetResourceEventInstitutionToPublicationResourceOwnerAffiliationWhenImportingPublication()
          throws IOException {
    var brageGenerator = buildGeneratorForRecord();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    ...
    var resourceEvent =
        Resource.fromPublication(actualPublication)
            .fetch(resourceService)
            .orElseThrow()
            .getResourceEvent();

    assertEquals(
        actualPublication.getResourceOwner().getOwnerAffiliation(), resourceEvent.institution());
  }

  @Test
  void shouldSetInstitutionShortNameForResourceEventWhenImportingPublicationFromBrage()
      throws IOException {
    var brageGenerator = buildGeneratorForRecord();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
  ...
  void shouldNotConvertBrageRecordMissingHandle() throws IOException {
    ...
    var actualErrorReport =
        extractActualReportFromS3Client(
            s3Event, IllegalArgumentException.class.getSimpleName(), record);
  ...
  @Test
  void
      shouldAttachCertainMetadataFieldsToExistingPublicationWhenExistingPublicationDoesNotHaveThoseFields()
          throws IOException {
    ...
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withResourceContent(createResourceContent(EMBARGO_DATE))
            .build();
    ...
    cristinPublication.setAdditionalIdentifiers(
        Set.of(new AdditionalIdentifier("cristin", "123456")));
    resourceService.createPublicationFromImportedEntry(
        cristinPublication, ImportSource.fromBrageArchive(randomString()));
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThat(
        actualPublication.publication().getEntityDescription().getDescription(),
        is(equalTo(brageGenerator.getNvaPublication().getEntityDescription().getDescription())));
    assertThat(
        actualPublication.publication().getEntityDescription().getAbstract(),
        is(equalTo(brageGenerator.getNvaPublication().getEntityDescription().getAbstract())));
    assertThat(
        actualPublication.publication().getHandle(),
  ...
  void shouldPrioritizeCristinImportedMetadataWhenMergingPublications() throws IOException {
    ...
    cristinPublication.setHandle(null);
    cristinPublication.setAdditionalIdentifiers(
        Set.of(new AdditionalIdentifier(CRISTIN_SOURCE, "123456")));
    var existingPublication =
        resourceService.createPublicationFromImportedEntry(
            cristinPublication, ImportSource.fromSource(Source.CRISTIN));
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThat(
        actualPublication.publication().getIdentifier(),
    ...
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withAssociatedArtifacts(
                createCorrespondingAssociatedArtifactWithLegalNote(null, EMBARGO_DATE))
            .build();
  ...
  void shouldCreateNewPublicationWhenPublicationHasNoCristinId() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_REPORT_WORKING_PAPER).build();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(
        actualPublication.publication(), brageGenerator.getNvaPublication());
  ...
  @Test
  void
      shouldUpdatePublicationAndPersistDuplicateWarningWhenThereIsMultipleSearchResultsOnCristinId()
          throws IOException {
    ...
    assertThat(
        existingPublicationIdentifiers, hasItem(actualPublication.publication().getIdentifier()));
  ...
  void shouldConvertConferenceLectureToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_CONFERENCE_LECTURE).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertBookOfAbstractsToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_BOOK_OF_ABSTRACTS).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertJournalIssueToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_JOURNAL_ISSUE).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertMediaFeatureArticleToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_MEDIA_FEATURE_ARTICLE)
  ...
  void shouldConvertLectureToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_LECTURE).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertChapterToNvaPublicationAndPersistPartOfReport() throws IOException {
    ...
    var expectedPartOfReport =
        new PartOfReport(actualPublication.publication(), brageGenerator.getBrageRecord())
            .toJsonString();
  ...
  void shouldConvertScientificChapterToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_SCIENTIFIC_CHAPTER).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertStudentPaperToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_STUDENT_PAPER_OTHERS).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertOtherStudentWorkToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_OTHER_STUDENT_WORK).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertConferencePosterToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_CONFERENCE_POSTER).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertDesignProductToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_DESIGN_PRODUCT).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertPlanOrBluePrintToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_PLAN_OR_BLUEPRINT).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertScientificMonographToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_SCIENTIFIC_MONOGRAPH).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertInterviewToNvaPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_INTERVIEW).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertPresentationOtherToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_PRESENTATION_OTHER).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertToBookAnthologyWhenBrageRecordIsBookAndHasEditor() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withContributor(
                new Contributor(
                    new Identity(randomString(), randomString(), null), "Editor", null, List.of()))
            .build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
  ...
  void shouldConvertPerformingArtsToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_PERFORMING_ARTS).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertVisualArtsToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_VISUAL_ARTS).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertReaderOpinionToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_READER_OPINION).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertAnthologyToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_ANTHOLOGY).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertTextbookToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_TEXTBOOK).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertLiteraryArtsToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_LITERARY_ARTS).build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(actualPublication.publication(), expectedPublication);
  ...
  void shouldConvertExhibitionCatalogueToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_EXHIBITION_CATALOGUE)
  ...
  void shouldConvertPopularScienceMonographToPublication() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_POPULAR_SCIENCE_MONOGRAPH)
            .build();
    var expectedPublication = brageGenerator.getNvaPublication();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
  ...
  void shouldConvertPopularScienceArticle() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_POPULAR_SCIENCE_ARTICLE)
            .withJournalTitle(randomString())
            .withVolume(randomString())
            .build();
    var expectedPublication = brageGenerator.getNvaPublication();
  ...
  @Test
  void shouldConvertToPublicationWithUnconfirmedJournalWhenJournalIdIsNotPresent()
      throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_MEDIA_FEATURE_ARTICLE)
  ...
  void shouldAdd100YearEmbargoToPublicationWhenLegalNoteRequiresEmbargo() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withAccessCode(LEGAL_NOTE_REQUIRING_EMBARGO)
            .withResourceContent(createResourceContent(null))
            .withAssociatedArtifacts(createCorrespondingAssociatedArtifactWithLegalNote(null, null))
            .build();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    ...
    assertThat(file.getLegalNote(), is(equalTo(LEGAL_NOTE_REQUIRING_EMBARGO)));
    assertThat(file.getEmbargoDate().orElseThrow().isAfter(embargoToBeAfterThisDate), is(true));
  }

  @Test
  void shouldKeepOriginalEmbargoWhenLegalNoteRequiresEmbargoButFileToImportAlreadyHasEmbargo()
      throws IOException {
    var resourceContent = createResourceContent(EMBARGO_DATE);
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_TEXTBOOK)
            .withAccessCode(LEGAL_NOTE_REQUIRING_EMBARGO)
            .withResourceContent(resourceContent)
            .withAssociatedArtifacts(
                createCorrespondingAssociatedArtifactWithLegalNote(null, EMBARGO_DATE))
            .build();

    var actualPublication =
        handler.handleRequest(createNewBrageRecordEvent(brageGenerator.getBrageRecord()), CONTEXT);

    var importedFile = (File) actualPublication.publication().getAssociatedArtifacts().getFirst();
    var originalEmbargoDate = resourceContent.getContentFiles().getFirst().getEmbargoDate();

    assertThat(importedFile.getEmbargoDate().orElseThrow(), is(equalTo(originalEmbargoDate)));
  }
  ...
  void shouldConvertCristinRecordToPublicationAndMergeWithExistingPublicationWithTheSameCristinId()
    ...
    publication
        ...
        .setPublicationDate(
            new no.unit.nva.model.PublicationDate.Builder().withYear("2022").build());
    publication
        .getEntityDescription()
        .setMainTitle("Dynamic - Response of Floating Wind Turbines! Report");
    var existingPublication =
        resourceService.createPublicationFromImportedEntry(
    ...
    var generator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withPublicationDate(
                new PublicationDate(
                    "2023", new PublicationDateNva.Builder().withYear("2023").build()))
  ...
  @Test
  void
      shouldAddBrageHandleAsAdditionalIdentifierAndWhenMergingDegreeWithPublicationThatHasHandleInAdditionalIdentifiers()
          throws IOException {
    ...
    var expectedAdditionalIdentifier =
        new HandleIdentifier(SourceName.fromBrage("ntnu"), randomUri());
    var brageTestRecord =
        generateBrageRecordAndPersistDuplicateByCristinIdentifier(
            publicationInstance, TYPE_BACHELOR, expectedAdditionalIdentifier);
    var existingPublication = brageTestRecord.getExistingPublication();

    var s3Event =
        createNewBrageRecordEvent(
            brageTestRecord.getGeneratorBuilder().withHandle(handle).build().getBrageRecord());
    var publicationRepresentation = handler.handleRequest(s3Event, CONTEXT);
    var handles =
        publicationRepresentation.publication().getAdditionalIdentifiers().stream()
    ...
    set.add(
        new HandleIdentifier(
            SourceName.fromBrage(brageTestRecord.getGeneratorBuilder().getCustomer().getName()),
            handle));
    var expectedUpdatedPublication =
        existingPublication
            .copy()
    ...
    assertThat(
        publicationRepresentation.publication().getAdditionalIdentifiers(),
  ...
  @Test
  void shouldNotMergeDegreeWithABookWhenFetchedByTitleSearch()
    ...
    var generator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withPublicationDate(
                new PublicationDate(
                    "2023", new PublicationDateNva.Builder().withYear("2023").build()))
            .withType(new Type(List.of(), "Book"))
            .build();

    mockSingleHitSearchApiResponseByTitleAndTypes(
        existingPublication.getIdentifier(), 200, mainTitle, "Book");
  ...
  @Test
  void shouldMergeBookWithADegreeWhenFetchedByCristinIdentifier()
      throws IOException, nva.commons.apigateway.exceptions.NotFoundException {
    var cristinIdentifier = randomString();
    ...
    var generator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withPublicationDate(
                new PublicationDate(
                    "2023", new PublicationDateNva.Builder().withYear("2023").build()))
            .withType(new Type(List.of(), "DegreeBachelor"))
            .build();
    var s3Event = createNewBrageRecordEvent(generator.getBrageRecord());
    handler.handleRequest(s3Event, CONTEXT);
  ...
  @Test
  void shouldMergeJournalWithAUnconfirmedJournalWhenFetchedByTitleFinder()
      throws IOException,
    ...
    publication
        .getEntityDescription()
        .getReference()
        .setPublicationContext(new UnconfirmedJournal(randomString(), null, null));
    publication.getEntityDescription().getReference().setDoi(null);
    publication
        .getEntityDescription()
        .setPublicationDate(
    ...
    var generator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withPublicationDate(
                new PublicationDate(
                    "2023", new PublicationDateNva.Builder().withYear("2023").build()))
            .withType(new Type(List.of(), "JournalArticle"))
            .build();

    mockSingleHitSearchApiResponseByTitleAndTypes(
        existingPublication.getIdentifier(), 200, title, "Journal", "UnconfirmedJournal");
  ...
  @Test
  void shouldMergeUnconfirmedJournalWithAJournalWhenFetchedByTitleFinder()
      throws IOException, nva.commons.apigateway.exceptions.NotFoundException {
    var publication = randomPublication(JournalArticle.class);
    publication
        .getEntityDescription()
        .getReference()
        .setPublicationContext(new Journal(randomUri()));
    publication.getEntityDescription().getReference().setDoi(null);
    publication
        .getEntityDescription()
        .setPublicationDate(
    ...
    mockSingleHitSearchApiResponseByTitleAndTypes(
        existingPublication.getIdentifier(), 200, title, "UnconfirmedJournal", "Journal");
  ...
  void shouldMergePublicationContextAndUseCourseFromBragePublicationWhenPublicationContextIsDegree()
    ...
    publication
        .getEntityDescription()
        .getReference()
        .setPublicationContext(new Degree(null, null, null, null, List.of(), null));
    publication
        .getEntityDescription()
        .setPublicationDate(
            new no.unit.nva.model.PublicationDate.Builder().withYear("2022").build());
    ...
    assertThat(
        ((UnconfirmedCourse) actualPublicationContext.getCourse()).code(),
        is(equalTo(subjectCode)));
  }
  ...
  void shouldMigrateHiddenFileFromIncomingWhenExistingPublicationDoesNotHaveHiddenFile()
    ...
    assertTrue(
        actualPublicationRepresentation.publication().getAssociatedArtifacts().stream()
  ...
  void shouldPersistNewFileWithUserInstanceFromIncomingPublicationWhenMergingPublications()
    ...
    var updatedResource =
        Resource.fromPublication(existingPublication).fetch(resourceService).orElseThrow();

    var fileEntry =
        updatedResource.getFileEntry(new SortableIdentifier(newFileIdentifier.toString()));
    ...
    Assertions.assertNotEquals(
        existingPublication.getResourceOwner().getOwner().getValue(),
  ...
  @Test
  void shouldNotAddLineBreaksToDescriptionAndAbstractWhenBrageRecordContainsSingleValue()
      throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder()
            .withType(TYPE_TEXTBOOK)
  ...
  void shouldNotCreateAbstractAndDescriptionWhenSingleValueIsBlankString() throws IOException {
    ...
    assertThat(
        actualPublication.publication().getEntityDescription().getDescription(), is(nullValue()));
    assertThat(
        actualPublication.publication().getEntityDescription().getAbstract(), is(nullValue()));
  }
  ...
  void shouldStoreExceptionWhenConvertingCristinRecordAndPublicationWithMatchingCristinIdDoesExist()
    ...
    var existingPublication =
        randomPublication().copy().withAdditionalIdentifiers(Set.of()).build();
    ...
    var errorReport =
        extractActualReportFromS3Client(
            s3Event, UnmappableCristinRecordException.class.getSimpleName(), record);
  ...
  void shouldStoreExceptionWhenTypeIsNotSupportedInPublicationContext() throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_SOFTWARE).build();
    var record = brageGenerator.getBrageRecord();
    var s3Event = createNewBrageRecordEvent(record);
    var publication = handler.handleRequest(s3Event, CONTEXT);
    assertThat(publication, is(nullValue()));
    var errorReport =
        extractActualReportFromS3Client(
            s3Event, PublicationContextException.class.getSimpleName(), record);
    var exception = errorReport.get("exception").asText();
  ...
  void shouldStoreExceptionWhenInvalidBrageRecordIsProvided() throws IOException {
    ...
    assertThat(publication, is(nullValue()));
    var errorReport =
        extractActualReportFromS3ClientForInvalidRecord(
            s3Event, UnknownCustomerException.class.getSimpleName());
    var exception = errorReport.get("exception").asText();
  ...
  void shouldPersistPublicationInDatabase()
    ...
    var actualPublication = handler.handleRequest(s3Event, CONTEXT);
    assertThatPublicationsMatch(
        resourceService.getPublicationByIdentifier(actualPublication.publication().getIdentifier()),
  ...
  void shouldTryToPersistPublicationInDatabaseSeveralTimesWhenResourceServiceIsThrowingException()
    ...
    this.handler =
        new BrageEntryEventConsumer(s3Client, fakeResourceServiceThrowingException, uriRetriever);
  ...
  void shouldStoreExceptionIfItCannotCopyAssociatedArtifacts() throws IOException {
    ...
    var errorReport =
        extractActualReportFromS3Client(
            s3Event, AssociatedArtifactException.class.getSimpleName(), record);
    var exception = errorReport.get("exception").asText();
  ...
  void shouldSaveErrorReportInS3ContainingTheOriginalInputData() throws IOException {
    ...
    assertThat(
        actualErrorReportBrageRecord, is(equalTo(nvaBrageMigrationDataGenerator.getBrageRecord())));
  }
  ...
  void shouldSaveSuccessReportContainingIncomingHandleWhenUpdatingExistingPublication()
    ...
    var actualStoredHandleString =
        extractUpdatedPublicationsHandleReportFromS3Client(
            s3Event, updatedPublication.publication(), generator.getBrageRecord().getId());
    assertThat(
        updatedPublication.publication().getIdentifier(),
        is(equalTo(existingPublication.getIdentifier())));
    assertThat(
        actualStoredHandleString, is(equalTo(generator.getBrageRecord().getId().toString())));
  }
  ...
  void shouldPersistMergeReport() throws IOException {
    ...
    publication.setAdditionalIdentifiers(
        Set.of(
            new AdditionalIdentifier("Cristin", cristinIdentifier),
            new CristinIdentifier(SourceName.fromBrage("ntnu"), cristinIdentifier)));
    publication
        .getEntityDescription()
        .setPublicationDate(
            new no.unit.nva.model.PublicationDate.Builder().withYear("2022").build());
    ...
    var storedMergeReportString =
        extractUpdateReportFromS3ByUpdateSource(
            s3Event,
            existingPublication,
            nvaBrageMigrationDataGenerator.getBrageRecord().getId(),
            "CRISTIN");
    var storedMergeReport =
        JsonUtils.dtoObjectMapper.readValue(storedMergeReportString, BrageMergingReport.class);
    var updatedPublication =
        Resource.fromPublication(existingPublication)
            .fetch(resourceService)
            .orElseThrow()
    ...
    var expectedPublication =
        existingPublication
            .copy()
            .withModifiedDate(storedMergeReport.oldImage().getModifiedDate())
            .build();
  ...
  void shouldMergePublicationsIfDoiDuplicateExists() throws IOException {
        ...
        List.of(
            new ResourceWithId(
                UriWrapper.fromUri(
                    ...
                    .getUri()));
    var searchResourceApiResponseSingleHit =
        new SearchResourceApiResponse(
            listOfExistingPublications.size(), listOfExistingPublications);
    ...
    var updatedPublication = handler.handleRequest(s3Event, CONTEXT);
    var brageHandle =
        updatedPublication.publication().getAdditionalIdentifiers().stream()
            .filter(HandleIdentifier.class::isInstance)
    ...
    assertThat(
        ...
        is(
            equalTo(
                new HandleIdentifier(
                    SourceName.fromBrage(brageRecord.getCustomer().getName()),
                    brageRecord.getId()))));
    assertThat(
        updatedPublication.publication().getIdentifier(),
        is(equalTo(existingPublication.getIdentifier())));
    ...
    var actualStoredHandleString =
        extractUpdatedPublicationsHandleReportFromS3Client(
            s3Event, existingPublication, brageRecord.getId());
    assertThat(
        actualStoredHandleString,
        is(equalTo(nvaBrageMigrationDataGenerator.getBrageRecord().getId().toString())));
  }
  ...
  void shouldNotMergePublicationsIfNoDoiDuplicateExists() throws IOException {
    ...
    var publication = handler.handleRequest(s3Event, CONTEXT);
    assertThat(
        publication.publication().getAdditionalIdentifiers().stream()
            .filter(HandleIdentifier.class::isInstance)
            .map(HandleIdentifier.class::cast)
            .findFirst()
            .orElseThrow(),
    ...
    var actualStoredHandleString =
        extractHandleReportFromS3Client(s3Event, publication.publication(), brageRecord.getId());
    assertThat(
        actualStoredHandleString,
        is(equalTo(nvaBrageMigrationDataGenerator.getBrageRecord().getId().toString())));
  }
  ...
  @Test
  void
      whenMergingWithExistingPublicationTheHandleReportShouldBeStoredUnderUpdatedPublicationsFolder()
          throws IOException {
    var publication = randomPublication(ConferencePoster.class);
    publication.setAdditionalIdentifiers(getDefaultIdentifiers(randomString()));
    publication.getEntityDescription().getReference().setDoi(null);
    ...
    var updatedPublication = handler.handleRequest(s3Event, CONTEXT);
    var s3Driver =
        new S3Driver(s3Client, new Environment().readEnv("BRAGE_MIGRATION_ERROR_BUCKET_NAME"));
  ...
  @Test
  void whenCreatingNewPublicationTheHandleReportShouldBeStoredUnderHandleReportsFolder()
      throws IOException {
    var brageGenerator =
        new NvaBrageMigrationDataGenerator.Builder().withType(TYPE_REPORT_WORKING_PAPER).build();
    var s3Event = createNewBrageRecordEvent(brageGenerator.getBrageRecord());
    ...
    var storedHandleString =
        extractHandleReportFromS3Client(
            s3Event, publication.publication(), brageGenerator.getBrageRecord().getId());
    assertThat(storedHandleString, is(not(nullValue())));
  }

  @Test
  void whenCristinPublicationIsMissingImportingMinimalRecordShouldNotCreateNewPublication()
      throws IOException {
    var cristinIdentifier = randomString();
  ...
  @Test
  void shouldStoreValidIsmnInIsmnObjectWhenConvertingMusicalPieces()
      throws IOException, InvalidIsmnException {
    ...
    assertThat(
        ...
        containsInAnyOrder(
            new MusicScore[] {
              new MusicScore(null, null, null, null, new Ismn(validIsmn1)),
              new MusicScore(null, null, null, null, new Ismn(validIsmn2))
            }));
  }
  ...
  void shouldStoreErrorReportIfTheMusicalPerformanceHasInvalidIsmn() throws IOException {
    ...
    var actualReport =
        extractActualReportFromS3Client(
            s3Event,
            InvalidIsmnRuntimeException.class.getSimpleName(),
  ...
  void shouldPersistReportContainingInformationRegardingDiscardedFilesDuringMerging()
    ...
    publication
        ...
        .setPublicationContext(
            new Book.BookBuilder().withIsbnList(List.of(randomIsbn10())).build());
    publication
        .getEntityDescription()
        .setPublicationDate(
            new no.unit.nva.model.PublicationDate.Builder().withYear("2022").build());
    ...
    var discardedFilesReport =
        extractDiscardedFilesReportFromS3(
            generator.getBrageRecord(), s3Event, updatedPublication.publication());
    assertThat(discardedFilesReport.getDiscardedFromUpdatedRecord(), hasSize(0));
    assertThat(
        discardedFilesReport.getDiscardedFromBrageRecord(),
  ...
  void shouldMergeIncomingPublicationWithExistingOneWhenSearchByIsbnReturnsSingleHit()
    ...
    var storedMergeReportString =
        extractUpdateReportFromS3ByUpdateSource(
            s3Event, existingPublication, generator.getBrageRecord().getId(), "ISBN");

    assertThat(storedMergeReportString, is(notNullValue()));
    assertThat(
        publicationFromBrage.publication().getIdentifier().toString(),
  ...
  @Description(
      "Should merge incoming publication with existing one when they match. Publications matchwhen"
          + " levenshtein distance between titles is less than 10 and at least one contributor"
          + " namehas levenshtein distance less than 5 with another contributor")
  @Test
  void shouldMergeIncomingPublicationWithExistingOneWhenPublicationsMatch() throws IOException {
    ...
    assertThat(
        updatedPublication.publication().getIdentifier().toString(),
  ...
  void shouldKeepBrageContributorsIfNvaPublicationIsMissingContributors() throws IOException {
    ...
    var publication = randomPublication(ConferencePoster.class);
    publication.setAdditionalIdentifiers(
        Set.of(new AdditionalIdentifier(SOURCE_CRISTIN, cirstinIdentifier)));
    publication.getEntityDescription().getReference().setDoi(null);
    ...
    var contributor =
        new Contributor(
            new Identity(randomString(), null, null),
            "Creator",
            "Creator",
            List.of(new Affiliation(affiliationIdentifier, "ntnu", null)));
    var generator =
        new NvaBrageMigrationDataGenerator.Builder()
            ...
            .withPublicationDate(
                new PublicationDate(
                    "2022", new PublicationDateNva.Builder().withYear("2022").build()))
            .withType(new Type(List.of(), instanceType))
            .build();
    var s3Event = createNewBrageRecordEvent(generator.getBrageRecord());
    var updatedPublication = handler.handleRequest(s3Event, CONTEXT);
    var organizationUri =
        UriWrapper.fromUri(
            "https://test.nva.aws.unit.no/cristin/organization/" + affiliationIdentifier);
    var expectedContributor =
        new no.unit.nva.model.Contributor.Builder()
            .withIdentity(
                new no.unit.nva.model.Identity.Builder()
                    .withName(contributor.getIdentity().getName())
                    .build())
            .withRole(new RoleType(Role.parse(contributor.getRole())))
            .withSequence(1)
            .withAffiliations(
                List.of(new Organization.Builder().withId(organizationUri.getUri()).build()))
            .build();
    assertThat(
        updatedPublication.publication().getIdentifier(),
        is(equalTo(existingPublication.getIdentifier())));
  ...
  void shouldUpdateExistingPublicationByFillingUpInstanceTypeEmptyValues(
      PublicationInstance<?> publicationInstance, Type type) throws IOException {
    var generator =
        generateBrageRecordAndPersistDuplicateByCristinIdentifier(
            publicationInstance, type, randomAdditionalIdentifier());
    var s3Event =
        createNewBrageRecordEvent(generator.getGeneratorBuilder().build().getBrageRecord());
    var updatedPublicationInstance =
        handler
            .handleRequest(s3Event, CONTEXT)
            .publication()
            .getEntityDescription()
            .getReference()
            .getPublicationInstance();
  ...
  @Test
  void
      shouldSetMergedResourceEventWhenUpdatingExistingPublicationWithInstitutionFromIncomingPublication()
          throws IOException {
    ...
    var resource =
        Resource.resourceQueryObject(publicationRepresentation.publication().getIdentifier())
            .fetch(resourceService)
            .orElseThrow();
    ...
    assertEquals(Source.BRAGE, resourceEvent.importSource().getSource());
    assertNotEquals(
        existingPublication.getResourceOwner().getOwnerAffiliation(), resourceEvent.institution());
    assertEquals(HARDCODED_NTNU_CRISTIN_ID, resourceEvent.institution());
  }

  @DisplayName(
      "Should not keep Cristin identifier from Brage when Cristin identifier is present in existing"
          + " publication")
  @Test
  void shouldUpdateExistingPublicationWhenBragePublicationHasCristinIdentifier()
    ...
    var publication = randomPublication(ConferencePoster.class);
    publication.setAdditionalIdentifiers(
        Set.of(new CristinIdentifier(SourceName.fromCristin("ntnu@1234"), randomString())));
    publication.getEntityDescription().getReference().setDoi(null);
    publication.getEntityDescription().setContributors(List.of());
    publication
        .getEntityDescription()
    ...
    var contributor =
        new Contributor(
            ...
            "Creator",
            "Creator",
            List.of(new Affiliation(affiliationIdentifier, NTNU_CUSTOMER_NAME, null)));
    ...
    var expectedCristinIdentifierFromBrage =
        new CristinIdentifier(
            SourceName.fromBrage(generator.getBrageRecord().getCustomer().getName()),
  ...
  private BrageTestRecord generateBrageRecordAndPersistDuplicateByCristinIdentifier(
    ...
    publication.setAdditionalIdentifiers(
        Set.of(new AdditionalIdentifier(SOURCE_CRISTIN, cristinIdentifier), additionalIdentifier));
    publication.getEntityDescription().getReference().setDoi(null);
    publication.getEntityDescription().setContributors(List.of());
    publication
        .getEntityDescription()
  ...
  private BrageTestRecord generateBrageRecordAndPersistDuplicate(
    ...
    var existingPublication =
        resourceService.createPublicationFromImportedEntry(
            publication, ImportSource.fromSource(Source.CRISTIN));
    var affiliationIdentifier = randomString();
    var contributor =
        new Contributor(
            new Identity(randomString(), null, null),
  ...
  void shouldSkipPostWhereThereExistNvaPostWithTheSameHandle() throws IOException {
    ...
    publication.setAdditionalIdentifiers(
        Set.of(new HandleIdentifier(SourceName.fromBrage("ntnu"), handle)));
    var existingPublication =
        resourceService.createPublicationFromImportedEntry(
            publication, ImportSource.fromBrageArchive(randomString()));
    var contributor = existingPublication.getEntityDescription().getContributors().getFirst();
    ...
    var errorReport =
        extractActualReportFromS3Client(
            s3Event, HandleDuplicateException.class.getSimpleName(), generator.getBrageRecord());
    var exception = errorReport.get("exception").asText();
  ...
  private static String getIsbn(Publication existingPublication) {
    return ((Book)
            existingPublication.getEntityDescription().getReference().getPublicationContext())
        .getIsbnList()
        .getFirst();
  }
  ...
  void shouldMergeConferenceReportWithEvent() throws IOException {
    ...
    assertThat(
        publicationRepresentation.publication().getIdentifier(),
        is(equalTo(existingPublication.getIdentifier())));
  }

  @Test
  void shouldPersistNewMergeReportWhenUpdatingPublicationForTheFirstTime() throws IOException {
    var generator = generateBrageRecordAndPersistDuplicate(new Lecture(), TYPE_CONFERENCE_REPORT);
    var existingPublication = generator.getExistingPublication();
    ...
    var s3Driver =
        new S3Driver(s3Client, new Environment().readEnv("BRAGE_MIGRATION_ERROR_BUCKET_NAME"));
    var uri =
        UriWrapper.fromUri("PUBLICATION_UPDATE")
  ...
  @Test
  void
      whenSearchApiReturnsMultiplePublicationsButDynamoDbCannotFindTheFirstOneMergingShouldHappenWithNextInLine()
          throws IOException {
    ...
    mockMultipleHitSearchApiResponse(
        List.of(SortableIdentifier.next(), existingPublicationIdentifier));
    ...
    assertThat(
        updatedPublication.publication().getIdentifier(),
        is(equalTo(existingPublicationIdentifier)));
  }
  ...
  void shouldImportPublicationMissingMandatoryValuesAndPersistReport() throws IOException {
    ...
    var s3Driver =
        new S3Driver(s3Client, new Environment().readEnv("BRAGE_MIGRATION_ERROR_BUCKET_NAME"));
    var uri =
        UriWrapper.fromUri("ERROR_REPORT")
  ...
  void importedFileOnPublicationUpdateShouldHaveFileImportedEvent() throws IOException {
    ...
    var fileEntry =
        resource
            .getFileEntry(new SortableIdentifier(contentFile.getIdentifier().toString()))
            .orElseThrow();
  ...
  private static Publication copyPublication(NvaBrageMigrationDataGenerator brageGenerator)
    ...
    return JsonUtils.dtoObjectMapper.readValue(
        JsonUtils.dtoObjectMapper.writeValueAsString(brageGenerator.getNvaPublication()),
        Publication.class);
  }

  private static void putAssociatedArtifactsToResourceStorage(
      NvaBrageMigrationDataGenerator dataGenerator, S3Driver s3Driver, java.io.File file) {
  ...
  private void mockSingleHitSearchApiResponse(SortableIdentifier identifier, int statusCode) {
    var publicationId =
        UriWrapper.fromHost(API_HOST)
            ...
            .getUri();
    var searchResourceApiResponse =
        new SearchResourceApiResponse(1, List.of(new ResourceWithId(publicationId)));
  ...
  private void mockSingleHitSearchApiResponseByTitleAndTypes(
      SortableIdentifier identifier, int statusCode, String title, String... types) {
    var publicationId =
        UriWrapper.fromHost(API_HOST)
            .addChild("publication")
            .addChild(identifier.toString())
    ...
    when(this.uriRetriever.fetchResponse(uriWrapper.getUri(), "application/json"))
  ...
  private void mockMultipleHitSearchApiResponse(List<SortableIdentifier> identifiers) {
    var resourceWithIds =
        identifiers.stream()
            ...
            .toList();
    var searchResourceApiResponse =
        new SearchResourceApiResponse(resourceWithIds.size(), resourceWithIds);
    var response = mock(HttpResponse.class);
  ...
  private DiscardedFilesReport extractDiscardedFilesReportFromS3(
      Record brageRecord, S3Event s3Event, Publication cristinPublication)
      throws JsonProcessingException {
  ...
  private UriWrapper constructDiscardedFileUri(
      S3Event s3Event, Record brageRecord, Publication cristinPublication) {
  ...
  private Record createMinimalRecord(String cristinIdentifier) {
    ...
    var fakeDummyHandle =
        UriWrapper.fromUri(DUMMY_HANDLE_THAT_EXIST_FOR_PROCESSING_UNIS + "/1").getUri();
    minimalRecord.setId(fakeDummyHandle);
    minimalRecord.setPublisherAuthority(new PublisherAuthority(List.of(), PUBLISHED_VERSION));
  ...
  private String extractUpdateReportFromS3ByUpdateSource(
      S3Event s3Event, Publication publication, URI brageHandle, String updateSource) {
    var timestamp = s3Event.getRecords().getFirst().getEventTime().toString(YYYY_MM_DD_HH_FORMAT);
    var uri =
        UriWrapper.fromUri(UPDATE_REPORTS_PATH)
  ...
  private JsonNode extractActualReportFromS3ClientForInvalidRecord(
      S3Event s3Event, String simpleName) throws JsonProcessingException {
  ...
  private void assertThatPublicationsMatch(
    ...
    assertThat(
        actualPublication.getAssociatedArtifacts(),
        hasSize(expectedPublication.getAssociatedArtifacts().size()));
    actualPublication.getAssociatedArtifacts().stream()
        .filter(File.class::isInstance)
        .forEach(
            associatedArtifact -> {
              var file = (File) associatedArtifact;
              assertThat(
                  ((ImportUploadDetails) file.getUploadDetails()).archive(), is(equalTo("NTNU")));
            });
  }
  ...
  private Publication publicationThatMatchesRecord(Record record) {
    var publication = randomPublication(NonFictionMonograph.class);
    publication.setAdditionalIdentifiers(
        Set.of(new AdditionalIdentifier("Cristin", record.getCristinId())));
    publication
        .getEntityDescription()
        .setPublicationDate(
            new no.unit.nva.model.PublicationDate.Builder()
    ...
    var nvaContributor =
        new no.unit.nva.model.Contributor(
            new no.unit.nva.model.Identity.Builder()
                .withName(brageContributor.getIdentity().getName())
                .build(),
            List.of(),
            null,
            null,
  ...
  private String extractUpdatedPublicationsHandleReportFromS3Client(
      S3Event s3Event, Publication actualPublication, URI brageHandle) {
    return extractHandleReportFromS3Client(
        s3Event, actualPublication, UPDATED_PUBLICATIONS_REPORTS_PATH, brageHandle);
  }

  private String extractHandleReportFromS3Client(
      S3Event s3Event, Publication actualPublication, URI brageHandle) {
    return extractHandleReportFromS3Client(
        s3Event, actualPublication, HANDLE_REPORTS_PATH, brageHandle);
  }

  private String extractHandleReportFromS3Client(
      S3Event s3Event, Publication actualPublication, String destinationFolder, URI brageHandle) {
    UriWrapper handleReport =
        constructHandleReportFileUri(s3Event, actualPublication, destinationFolder, brageHandle);
    S3Driver s3Driver =
        new S3Driver(s3Client, new Environment().readEnv("BRAGE_MIGRATION_ERROR_BUCKET_NAME"));
    return s3Driver.getFile(handleReport.toS3bucketPath());
  }

  private UriWrapper constructHandleReportFileUri(
      S3Event s3Event, Publication actualPublication, String destinationFolder, URI brageHandle) {
    var timestamp = s3Event.getRecords().getFirst().getEventTime().toString(YYYY_MM_DD_HH_FORMAT);
  ...
  private JsonNode extractActualReportFromS3Client(
      S3Event s3Event, String exceptionSimpleName, Record brageRecord)
      throws JsonProcessingException {
  ...
  private UriWrapper constructErrorFileUri(
      S3Event event, String exceptionSimpleName, Record brageRecord) {
  ...
  private UriWrapper constructErrorFileUriForInvalidBrageRecord(
      S3Event event, String exceptionSimpleName) {
    var fileUri = UriWrapper.fromUri(extractFilename(event));
    var timestamp = event.getRecords().getFirst().getEventTime().toString(YYYY_MM_DD_HH_FORMAT);
    return UriWrapper.fromUri(ERROR_BUCKET_PATH)
        .addChild(NTNU_CUSTOMER_NAME)
  ...
  private ResourceContent createResourceContent(Instant embargoDate) {
    var file =
        new ContentFile(
            FILENAME,
            BundleType.ORIGINAL,
            ...
            new License(
                "someLicense",
                new NvaLicense(URI.create("https://creativecommons.org/licenses/by-nc/4.0"))),
            embargoDate);

    return new ResourceContent(Collections.singletonList(file));
  }

  private List<AssociatedArtifact> createCorrespondingAssociatedArtifactWithLegalNote(
      String legalNote, Instant embargoDate) {
    return List.of(
        File.builder()
            .withIdentifier(UUID)
            ...
            .withUploadDetails(
                new ImportUploadDetails(ImportUploadDetails.Source.BRAGE, "ntnu", null))
            .buildOpenFile());
  }
  ...
  private S3Event createNewInvalidBrageRecordEvent() throws IOException {
    ...
    var uri =
        s3Driver.insertFile(
            UnixPath.of(NTNU_CUSTOMER_NAME + "/" + randomString()), record.toString());
  ...
  private S3Event createNewBrageRecordEvent(Record brageRecord) throws IOException {
    ...
    var uri =
        s3Driver.insertFile(UnixPath.of(NTNU_CUSTOMER_NAME + "/" + randomString()), recordAsJson);
    return createS3Event(uri);
  }

  private S3Event createNewBrageRecordEventForCustomer(Record brageRecord, String customer)
      throws IOException {
    var recordAsJson = JsonUtils.dtoObjectMapper.writeValueAsString(brageRecord);
  ...
  private S3Event createNewBrageRecordEventWithSpecifiedObjectKey(Record brageRecord)
      throws IOException {
    var recordAsJson = JsonUtils.dtoObjectMapper.writeValueAsString(brageRecord);
