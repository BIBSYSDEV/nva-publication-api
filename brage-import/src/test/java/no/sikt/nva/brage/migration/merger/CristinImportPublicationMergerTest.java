...
class CristinImportPublicationMergerTest {
  ...
  @Test
  void
      shouldUseExistingJournalWhenExistingJournalIsJournalAndBragePublicationHasUnconfirmedJournal()
          throws InvalidUnconfirmedSeriesException, InvalidIsbnException, InvalidIssnException {
    var existingPublication = randomPublication(JournalArticle.class);
    var bragePublication = randomPublication(JournalArticle.class);
    bragePublication
        ...
        .getReference()
        .setPublicationContext(unconfirmedJournal());
    var updatedPublication = mergePublications(existingPublication, bragePublication);
  ...
  @Test
  void
      shouldUseExistingJournalWhenExistingJournalIsUnconfirmedJournalAndBragePublicationHasUnconfirmedJournalWithNullValues()
          throws InvalidUnconfirmedSeriesException, InvalidIsbnException, InvalidIssnException {
    var existingPublication = randomPublication(JournalArticle.class);
    existingPublication
        .getEntityDescription()
    ...
    bragePublication
        .getEntityDescription()
        .getReference()
        .setPublicationContext(emptyUnconfirmedJournal());
    var updatedPublication = mergePublications(existingPublication, bragePublication);
  ...
  void shouldReturnExistingJournalWhenNewPublicationContextIsNotSupportedJournalType()
    ...
    bragePublication
        .getEntityDescription()
        .getReference()
        .setPublicationContext(new BookBuilder().build());
    var updatedPublication = mergePublications(existingPublication, bragePublication);
  ...
  void shouldPrioritizePublisherIfRecordHasPublisherPrioritized()
    ...
    var shouldBeOverWrittenDuringMerging =
        new BookBuilder().withPublisher(new Publisher(randomUri())).build();
    existingPublication
        .getEntityDescription()
        .getReference()
  ...
  @Test
  void
      shouldUpdateExistingCreatorsAffiliationWhenBrageContributorHasAffiliationAndPublicationIsADegree()
          throws InvalidIssnException, InvalidIsbnException, InvalidUnconfirmedSeriesException {
  ...
  @Test
  void
      shouldNotUpdateExistingContributorAffiliationWhenContributorIsNotCreatorAndPublicationIsADegree()
          throws InvalidIssnException, InvalidIsbnException, InvalidUnconfirmedSeriesException {
    var existingPublication = randomPublication(DegreeBachelor.class);
    existingPublication.setAdditionalIdentifiers(Set.of());
  ...
  void shouldKeepFileFromNewPublicationWhenExistingPublicationHasAssociatedLinkOnly()
    ...
    assertThat(
        updatedPublication.getAssociatedArtifacts(),
  ...
  void shouldKeepFileFromNewPublicationWhenExistingPublicationHasHiddenFileOnly()
    ...
    existingPublication.setAssociatedArtifacts(
        new AssociatedArtifactList(List.of(administrativeAgreement)));
    var bragePublication = randomPublication(Map.class);
    bragePublication.setAssociatedArtifacts(new AssociatedArtifactList(List.of(newPublishedFile)));
  ...
  void shouldMergeWhenPublicationContextAndPublicationInstanceIsMissingOnIncomingPublication()
    ...
    assertThat(
        updatedPublication.getEntityDescription().getReference(),
  ...
  void shouldPrioritizeMainTitleIfRecordHasMainTitleSetAsPrioritized()
    ...
    existingPublication
        .getEntityDescription()
        .setMainTitle(titleThatShouldBeOverWrittenDuringMerging);
    ...
    assertThat(
        updatedPublication.getEntityDescription().getMainTitle(),
        is(equalTo(mainTitleThatShouldBeKept)));
  }
  ...
  void shouldPrioritizeAlternativeTitleIfRecordHasAlternativeTitleSetAsPrioritized()
    ...
    var existingPublication = randomPublication(Textbook.class);
    existingPublication.setAdditionalIdentifiers(Set.of());
    var alternativeTitleThatShouldBeOverWrittenDuringMerging =
        java.util.Map.of(randomString(), randomString());
    existingPublication
        .getEntityDescription()
    ...
    assertThat(
        updatedPublication.getEntityDescription().getAlternativeTitles(),
  ...
  void shouldPrioritizeAbstractIfRecordHasAbstractAsPrioritized()
    ...
    existingPublication
        .getEntityDescription()
        .setAbstract(abstractThatShouldBeOverWrittenDuringMerging);
    ...
    assertThat(
        updatedPublication.getEntityDescription().getAbstract(),
  ...
  void shouldPrioritizeAlternativeAbstractsIfRecordHasAlternativeAbstractAsPrioritized()
    ...
    var existingPublication = randomPublication(Textbook.class);
    existingPublication.setAdditionalIdentifiers(Set.of());
    var abstractThatShouldBeOverWrittenDuringMerging =
        java.util.Map.of(randomString(), randomString());
    existingPublication
        .getEntityDescription()
    ...
    assertThat(
        updatedPublication.getEntityDescription().getAlternativeAbstracts(),
        is(equalTo(abstractThatShouldBeKept)));
  }
  ...
  void shouldPrioritizeReferenceFromBrageIfRecordHasReferenceAsPrioritized()
    ...
    assertThat(
        updatedPublication.getEntityDescription().getReference(),
        is(equalTo(referenceThatShouldBeKept)));
  }
  ...
  void shouldMergeTagsWhenRecordHasTagsPrioritized()
    ...
    bragePublication
        .getEntityDescription()
        .setTags(List.of(newTag, duplicatedTag.toUpperCase(Locale.ROOT)));
    ...
    assertThat(actualTags, is(containsInAnyOrder(tag, duplicatedTag, newTag)));
  }
  ...
  void shouldAddDublinCoreFromIncomingPublicationToExistingOneWhenItIsPresentInBothPublications()
    ...
    existingPublication.setAssociatedArtifacts(
        new AssociatedArtifactList(existingAssociatedArtifact));
  ...
  private static Set<HiddenFile> extractDublinCores(Publication updatedPublication) {
    return updatedPublication.getAssociatedArtifacts().stream()
        ...
        .filter(
            administrativeAgreement -> "dublin_core.xml".equals(administrativeAgreement.getName()))
  ...
  @Test
  void
      shouldImportAllSupervisorsFromBrageWhenExistingPublicationIsMissingAdvisorsAndPublicationIsDegree()
          throws InvalidIssnException, InvalidIsbnException, InvalidUnconfirmedSeriesException {
    var existingPublication = randomPublication(DegreeBachelor.class);
    existingPublication
        .getEntityDescription()
  ...
  @Test
  void
      shouldNotImportSupervisorFromBrageWhenExistingPublicationHasContributorWithTheSameNameAndPublicationIsDegree()
          throws InvalidIssnException, InvalidIsbnException, InvalidUnconfirmedSeriesException {
    var existingPublication = randomPublication(DegreeBachelor.class);
  ...
  void shouldMergeTags()
    ...
    var existingPublication =
        randomPublicationWithHandleIdAdditionalIdentifiers(ReportResearch.class, handleIdentifier);
    var bragePublication =
        randomPublicationWithHandleIdAdditionalIdentifiers(
            ReportResearch.class, new HandleIdentifier(SourceName.fromBrage("nmbu"), handle));
    bragePublication.getEntityDescription().getReference().setPublicationContext(null);
    bragePublication.getEntityDescription().getReference().setPublicationInstance(null);
    var updatedPublication = mergePublications(existingPublication, bragePublication);
    ...
    assertThat(
        tags,
        hasItems(existingPublication.getEntityDescription().getTags().toArray(String[]::new)));
    assertThat(
        tags, hasItems(bragePublication.getEntityDescription().getTags().toArray(String[]::new)));
  }
  ...
  void shouldOverridePublicationDateWhenPublicationDateFromBrageIsPrioritized()
    ...
    var handleIdentifier = new HandleIdentifier(SourceName.fromBrage("ntnu"), handle);
    var existingPublication =
        randomPublicationWithHandleIdAdditionalIdentifiers(DegreeBachelor.class, handleIdentifier);
    var bragePublication =
        randomPublicationWithHandleIdAdditionalIdentifiers(
            DegreeBachelor.class, new HandleIdentifier(SourceName.fromBrage("nmbu"), handle));
    bragePublication
        .getEntityDescription()
        .setPublicationDate(new PublicationDate.Builder().withYear(Year.now().toString()).build());
    var updatedPublication = mergePublications(existingPublication, bragePublication);

    assertEquals(
        bragePublication.getEntityDescription().getPublicationDate(),
        updatedPublication.getEntityDescription().getPublicationDate());
  }

  private static Publication randomPublicationWithHandleIdAdditionalIdentifiers(
      Class<?> publicationInstance, HandleIdentifier handleIdentifier) {
    return randomPublication(publicationInstance)
        .copy()
  ...
  private AssociatedArtifact randomDublinCore() {
    return File.builder().withName("dublin_core.xml").withLicense(randomUri()).buildHiddenFile();
  }
  ...
  private static Publication mergePublications(
      Publication existingPublication, Publication bragePublication)
      throws InvalidIsbnException, InvalidUnconfirmedSeriesException, InvalidIssnException {
    var record = new Record();
    record.setId(bragePublication.getHandle());
  ...
  private static Publication mergePublications(
      Publication existingPublication, Publication bragePublication, Record record)
      throws InvalidIssnException, InvalidIsbnException, InvalidUnconfirmedSeriesException {
