...
class AssociatedArtifactsMergerTest {
    ...
    var incoming =
        new AssociatedArtifactList(
            List.of(
                ...
                randomHiddenFile(),
                randomOpenFile(null),
                randomOpenFile(ACCEPTED_VERSION),
  ...
  @Test
  void
      shouldImportAllOpenFilesWithNonPublishedVersionWhenMergingIncomingAssociatedArtifactsWithExisting() {
    var existing =
        new AssociatedArtifactList(
            List.of(
                randomOpenFile(ACCEPTED_VERSION),
                ...
                randomHiddenFile()));
    var incoming =
        new AssociatedArtifactList(List.of(randomOpenFile(null), randomOpenFile(ACCEPTED_VERSION)));
  ...
  @Test
  void
      shouldNotImportOpenFileWithPublishedVersionAndDifferentNameThanExistingOpenFileWithPublishedVersionWhenOnlyOneFile() {
  ...
  @Test
  void
      shouldImportOpenFileWithPublishedVersionAndDifferentNameThanExistingOpenFileWithPublishedVersionWhenMultipleFiles() {
    var existing =
        new AssociatedArtifactList(
            List.of(randomOpenFile(PUBLISHED_VERSION), randomOpenFile(PUBLISHED_VERSION)));
  ...
  @Test
  void
      shouldNotImportOpenFileWithPublishedVersionAndExistingNameThanExistingOpenFileWithPublishedVersionWhenMultipleFiles() {
    var filename = randomString();
    var existing =
        new AssociatedArtifactList(
            List.of(
                randomOpenFile(PUBLISHED_VERSION, filename), randomOpenFile(PUBLISHED_VERSION)));
  ...
  @Test
  void
      shouldImportOpenFileWithPublishedVersionWhenThereExistsOpenFileWithoutPublishedVersionButTheSameFilename() {
    var filename = randomString();
    var existing =
        new AssociatedArtifactList(
            List.of(randomOpenFile(ACCEPTED_VERSION, filename), randomOpenFile(null, filename)));
    var incoming = new AssociatedArtifactList(List.of(randomOpenFile(PUBLISHED_VERSION, filename)));
