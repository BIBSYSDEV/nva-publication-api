...
public final class ReferenceGenerator {
    ...
    try {
      ...
      if (NvaType.RECORDING_MUSICAL.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublishingContext(new Artistic())
            .withPublicationInstance(
                new MusicPerformance(Collections.emptyList(), NullDuration.create()))
            .withDoi(builder.getDoi())
            .build();
      }
      ...
      if (NvaType.PERFORMING_ARTS.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublicationInstance(
                new PerformingArts(
                    PerformingArtsSubtype.createOther(null), null, Collections.emptyList()))
            .withPublishingContext(new Artistic())
            .withDoi(builder.getDoi())
            .build();
      }
      ...
      if (NvaType.FILM.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublicationInstance(
                new MovingPicture(
                    MovingPictureSubtype.createOther(null),
                    null,
      ...
      if (NvaType.LITERARY_ARTS.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublicationInstance(
                new LiteraryArts(
                    LiteraryArtsSubtypeOther.createOther(null), Collections.emptyList(), null))
            .withPublishingContext(new Artistic())
            .withDoi(builder.getDoi())
            .build();
      }
      if (NvaType.EXHIBITION_CATALOGUE.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublicationInstance(new ExhibitionCatalog(generateMonographPages(builder)))
            .withPublishingContext(generatePublicationContextForBook(builder))
            .withDoi(builder.getDoi())
            .build();
      }
      if (NvaType.POPULAR_SCIENCE_MONOGRAPH.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublicationInstance(new PopularScienceMonograph(generateMonographPages(builder)))
            .withPublishingContext(generatePublicationContextForBook(builder))
            .withDoi(builder.getDoi())
            .build();
      }
      if (NvaType.EDITORIAL.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            ...
            .withPublishingContext(
                new UnconfirmedJournal(
                    builder.getJournalTitle(),
      ...
      if (NvaType.POPULAR_SCIENCE_ARTICLE.getValue().equals(builder.getType().getNva())) {
        return new Reference.Builder()
            .withPublicationInstance(
                new PopularScienceArticle(generateRange(builder), builder.getVolume(), null, null))
            .withPublishingContext(
                new UnconfirmedJournal(
                    builder.getJournalTitle(),
                    builder.getIssnList().get(0),
  ...
  private static PublicationInstance<? extends Pages>
      generatePublicationInstanceForReportBookOfAbstracts(Builder builder) {
  ...
  private static OtherStudentWork generatePublicationInstanceForStudentPaper(Builder builder) {
    return new OtherStudentWork(
        builder.getMonographPages(), builder.getPublicationDateForPublication());
  }

  private static PublicationInstance<? extends Pages>
      generatePublicationInstanceForScientificChapter(Builder builder) {
  ...
  private static ArtisticDesign generatePublicationInstanceForDesignProduct() {
    return new ArtisticDesign(
        ArtisticDesignSubtype.createOther(null), null, Collections.emptyList());
  }
  ...
  private static PublicationInstance<? extends Pages> generatePublicationInstanceForFeatureArticle(
      Builder builder) {
  ...
  private static Range generateRange(Builder builder) {
    return new Range(
        builder.getPages().getRange().getBegin(), builder.getPages().getRange().getEnd());
  }

  private static PublicationInstance<? extends Pages>
      generatePublicationInstanceForReportWorkingPaper(Builder builder) {
    return new ReportWorkingPaper(builder.getMonographPages());
  }

  private static PublicationInstance<? extends Pages>
      generatePublicationInstanceForScientificArticle(Builder builder) {
    return new AcademicArticle(generateRange(builder), null, null, null);
  }

  private static PublicationContext generateUnconfirmedJournal(Builder builder)
      throws InvalidIssnException {
    if (builder.getIssnList().size() > 1) {
      return new UnconfirmedJournal(
          builder.getPublication().getJournal(),
          builder.getIssnList().get(0),
          builder.getIssnList().get(1));
    }
    if (builder.getIssnList().size() == 1) {
      return new UnconfirmedJournal(
          builder.getPublication().getJournal(), builder.getIssnList().getFirst(), null);
    } else {
  ...
  private static BookSeries generateSeries(Builder builder) throws InvalidIssnException {
    if (nonNull(builder.getSeriesId())) {
      ...
      return new UnconfirmedSeries(
          builder.getSeriesTitle(),
  ...
  private static Degree generatePublicationContextForDegree(Builder builder)
    ...
    return new Degree.Builder()
        .withIsbnList(Collections.singletonList(builder.getIsbn()))
        .withSeries(generateSeries(builder))
        .withCourse(new UnconfirmedCourse(builder.getSubjectCode()))
        .build();
  }
}
