...
public class FileMergerFeatures {
  ...
  public void bragePublicationWithHandle(String handle) {
    ...
    var additionalIdentifiers =
        new HashSet<>(bragePublication.publication().getAdditionalIdentifiers());
  ...
  public void bragePublicationHasAFileWithValues(OpenFile openFile) {
    ...
    bragePublication
        .publication()
        .setAssociatedArtifacts(new AssociatedArtifactList(List.of(openFile)));
  }
  ...
  public void mergedNvaPublicationHasAHandleEqualTo(String handle) {
    var mergedPublication = scenarioContext.getMergedPublication();
    assertThat(
        mergedPublication.getAdditionalIdentifiers(),
        hasItem(new AdditionalIdentifier("handle", handle)));
  }
  ...
  public void bothThePublicationInstanceIsAcademicArticle() throws InvalidIssnException {
    ...
    bragePublication
        ...
        .getReference()
        .setPublicationInstance(academicArticle);
    bragePublication
        .publication()
        .getEntityDescription()
        .getReference()
        .setPublicationContext(journal);
