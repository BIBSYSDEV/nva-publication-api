...
public abstract class TicketDto implements JsonSerializable {
  ...
  protected TicketDto(
    ...
    this.availableInstitutions =
        nonNull(availableInstitutions) ? Set.copyOf(availableInstitutions) : Set.of();
    this.allowedOperations = nonNull(allowedOperations) ? Set.copyOf(allowedOperations) : Set.of();
  }

  public static TicketDto fromTicket(
      TicketEntry ticket,
  ...
  public static URI createTicketId(
      SortableIdentifier resourceIdentifier, SortableIdentifier ticketIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getId(), ticketDto.getId())
        ...
        && Objects.equals(getModifiedDate(), ticketDto.getModifiedDate())
        && getStatus() == ticketDto.getStatus()
  ...
  private static URI createPublicationId(SortableIdentifier publicationIdentifier) {
    return Optional.ofNullable(publicationIdentifier).map(TicketDto::toPublicationId).orElse(null);
  }
  ...
  public static final class Builder {
    ...
    public TicketDto build(TicketEntry ticketEntry) {
      return switch (ticketEntry) {
        ...
        case PublishingRequestCase publishingRequestCase ->
            createPublishingRequestDto(publishingRequestCase);
        ...
        case FilesApprovalThesis filesApprovalThesis ->
            createFilesApprovalThesisDto(filesApprovalThesis);
        default -> throw new RuntimeException("Unsupported type");
      };
    }

    private UnpublishRequestDto createUnpublishRequestDto() {
      return new UnpublishRequestDto(
          status,
          createdDate,
          modifiedDate,
          identifier,
    ...
    private FilesApprovalThesisDto createFilesApprovalThesisDto(
        FilesApprovalThesis filesApprovalThesis) {
      return new FilesApprovalThesisDto(
          status,
          createdDate,
          modifiedDate,
          identifier,
          ...
          owner,
          ownerAffiliation,
          filesApprovalThesis.getWorkflow(),
          filesApprovalThesis.getApprovedFiles(),
