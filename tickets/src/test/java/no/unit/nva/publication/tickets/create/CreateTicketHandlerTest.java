package no.unit.nva.publication.tickets.create;
...
import no.unit.nva.publication.tickets.GeneralSupportRequestDto;
import no.unit.nva.publication.tickets.PublishingRequestDto;
