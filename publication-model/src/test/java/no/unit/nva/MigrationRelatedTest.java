...
public class MigrationRelatedTest {
  ...
  void shouldTakeJsonAsInputAndConvertToDataManagementPlanWithSetOfRelatedDocuments(
      String json, Class<? extends RelatedDocument> expectedClass) throws JsonProcessingException {

    var object =
        (DataManagementPlan) JsonUtils.dtoObjectMapper.readValue(json, PublicationInstance.class);
