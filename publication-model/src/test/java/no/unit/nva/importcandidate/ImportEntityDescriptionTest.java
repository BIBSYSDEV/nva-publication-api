...
class ImportEntityDescriptionTest {
  ...
  void shouldStoreLegacyUioIdentifierAsUioIdentifier() {
    var organization =
        Organization.fromUri(UriWrapper.fromUri(randomUri()).addChild("185.0.0.0").getUri());
  ...
  private static ImportEntityDescription randomEntityDescription(
      ImportContributor... contributors) {
  ...
  private static ImportEntityDescription randomEntityDescription(
    ...
    return new ImportEntityDescription(
        null, null, null, contributors, null, null, null, null, null);
  }
  ...
  private ImportContributor createContributor(Organization organization) {
    ...
    return new ImportContributor(
        identity, List.of(new Affiliation(organization, null)), null, randomInteger(), false);
  }
}
