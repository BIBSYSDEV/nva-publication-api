...
class IsrcTest {
  ...
  public static Stream<String> nullIsrcPublicationProvider() {
    return Stream.of(isrcPublicationWithoutIsrc(), isrcPublicationWithNullIsrc());
  }
  ...
  void shouldThrowExceptionWhenIsrcIsInvalid() {
    ...
    assertThat(
        exception.getMessage(), is(equalTo(InvalidIsrcException.formatErrorMessage(invalidIsrc))));
  }
