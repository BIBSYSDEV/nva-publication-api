...
class ChapterArticleContentTypeTest {
  ...
  void shouldReturnChapterArticleContentTypeWhenInputIsCurrentValue(
      ChapterArticleContentType chapterArticleContentType) throws JsonProcessingException {
    var currentValue = "\"" + chapterArticleContentType.getValue() + "\"";
    var expectedChapterArticleContentType =
        JsonUtils.dtoObjectMapper.readValue(currentValue, ChapterArticleContentType.class);
  ...
  void shouldReturnChapterArticleContentTypeWhenInputIsDeprecatedValue(
    ...
    var expectedChapterArticleContentType =
        JsonUtils.dtoObjectMapper.readValue(deprecated, ChapterArticleContentType.class);
    assertEquals(expectedChapterArticleContentType, chapterArticleContentType);
  }
  ...
  void shouldThrowErrorWithProperErrorMessageWhenInvalidInputValueSupplied() {
    ...
    Executable handleRequest =
        () -> JsonUtils.dtoObjectMapper.readValue(inputJsonValue, ChapterArticleContentType.class);
