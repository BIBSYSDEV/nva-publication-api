...
class JournalArticleContentTypeTest {
  ...
  void shouldReturnEnumerationWhenInputIsCurrentName(
      JournalArticleContentType journalArticleContentType) throws JsonProcessingException {
  ...
  void shouldReturnEnumerationWhenInputIsDeprecatedName(
      String deprecatedValue, JournalArticleContentType journalArticleContentType)
