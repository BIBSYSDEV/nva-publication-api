...
class ReferenceTest {
  ...
  public static Stream<Arguments> contextTypePairs() {
    ...
    return IntStream.range(0, contextTypes.size())
        ...
        .flatMap(
            i ->
                IntStream.range(i + 1, contextTypes.size())
  ...
  void referenceWithTwoDifferentInstanceTypesShouldNotBeEqual(
      String instanceTypeOne, String instanceTypeTwo) throws JsonProcessingException {
    var oldJson =
        """
        {
          "type": "Reference",
  ...
  void referenceWithTwoDifferentContextTypesShouldNotBeEqual(String eventOne, String eventTwo)
  ...
  private static Stream<Arguments> instanceTypePairs() {
    ...
    return IntStream.range(0, types.size())
        ...
        .flatMap(
            i ->
                IntStream.range(i + 1, types.size())
