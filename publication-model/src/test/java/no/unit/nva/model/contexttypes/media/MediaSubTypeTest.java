...
/**
 * Test for demonstrating the necessity and the way to deserialize a SubType that can be both a
 * String (legacy format) and an object. Delete when all Subtypes have been migrated to objects.
 */
