...
public class PublicationContextWithIsbnTest {
  ...
  void shouldCreateResourceWithIsbnAsAdditionalIdentifierWhenInvalidIsbn(
    ...
    assertThat(
        context.getAdditionalIdentifiers(), hasItem(new AdditionalIdentifier("ISBN", invalidIsbn)));
  }
  ...
  @ParameterizedTest
  @ValueSource(classes = {BookMonograph.class, ReportResearch.class, DegreeBachelor.class})
  void shouldCreateResourceWithEmptyIsbnListAndAdditionalIdentifiersWhenNoIsbn(
      Class<?> publicationContext) {
