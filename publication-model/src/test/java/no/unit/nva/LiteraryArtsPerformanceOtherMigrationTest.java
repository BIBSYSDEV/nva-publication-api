...
public class LiteraryArtsPerformanceOtherMigrationTest {
  ...
  public static final String OTHER_OBJECT_WITH_DESCRIPTION =
      "{ \"type\": \"Other\", " + "\"description\": \"Some description\"}";
  ...
  private static String publication(String other) {
    return "{\n"
        ...
        + "    \"owner\" : \"5hvGFdljAVTx\",\n"
        + "    \"ownerAffiliation\" :"
        + " \"https://www.example.org/3c7ea15a-2467-487f-8f52-2160696eb643\"\n"
        + "  },\n"
        + "  \"publisher\" : {\n"
        + "    \"type\" : \"Organization\",\n"
        ...
        + "  \"handle\" :"
        + " \"https://www.example.org/8582e891-eafe-45b0-a7b1-67f72f7d7534\",\n"
        ...
        + "        \"type\" : \"Identity\",\n"
        + "        \"id\" :"
        + " \"https://www.example.org/6a87bfa8-6ac8-458a-a5c0-28bb83719a2f\",\n"
        ...
        + "        \"type\" : \"Organization\",\n"
        + "        \"id\" :"
        + " \"https://www.example.org/2ba05e1b-1531-46e0-9fa7-99c138c63f25\",\n"
        + "        \"labels\" : {\n"
        + "          \"nl\" : \"zWvJe1LVqdyfO\"\n"
        + "        }\n"
        + "      } ],\n"
        ...
        + "        \"type\" : \"Identity\",\n"
        + "        \"id\" :"
        + " \"https://www.example.org/2b6613ca-966f-495e-86c8-3733edd13b6c\",\n"
        + "        \"name\" : \"FIpBdti7zUqw\",\n"
        ...
        + "        \"type\" : \"Organization\",\n"
        + "        \"id\" :"
        + " \"https://www.example.org/f66ddc92-c561-4bb6-b9e6-f60e3993e01f\",\n"
        + "        \"labels\" : {\n"
        + "          \"hu\" : \"7mdg5cY6zUDYqAS\"\n"
        + "        }\n"
        + "      } ],\n"
        ...
        + "      },\n"
        + "      \"doi\" :"
        + " \"https://www.example.org/4adcddb7-333f-48de-b01e-0fb4c1c827e0\",\n"
        + "      \"publicationInstance\" : {\n"
        + "        \"type\" : \"LiteraryArts\",\n"
        + "        \"subtype\" : {\n"
        + "          \"type\" : \"Poetry\"\n"
        ...
        + "    },\n"
        + "    \"metadataSource\" :"
        + " \"https://www.example.org/4043f9c2-e9ce-47e9-a118-f0911dacdfb3\",\n"
  ...
  private LiteraryArtsPerformanceSubtype extractLiteraryArtsPerformance(Publication publication) {
    ...
    return ((LiteraryArts) publicationInstance)
