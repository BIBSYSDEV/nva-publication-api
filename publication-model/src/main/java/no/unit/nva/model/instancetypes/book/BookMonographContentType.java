...
/**
 * Content Type options for "Monograph" subtype when the creator chooses the Resource type as "Book"
...
public enum BookMonographContentType {
  ...
  /**
   * Enum Type Exhibition catalogue represents: A book published for a specific art or museum
   * exhibition. Contains a list of exhibits at the exhibition.
   */
  EXHIBITION_CATALOG("ExhibitionCatalog", "Exhibition catalog");

  public static final String ERROR_MESSAGE_TEMPLATE =
      "%s not a valid BookMonographContentType, expected one of: %s";
  ...
  private static boolean equalsCurrentOrDeprecatedValue(
      String value, BookMonographContentType nameType) {
