...
public record CristinIdentifier(@JsonIgnore SourceName source, String value)
    implements AdditionalIdentifierBase {

  static final String TYPE = "CristinIdentifier";

  @JsonCreator
  private CristinIdentifier(
      @JsonProperty("sourceName") String sourceName, @JsonProperty("value") String value) {
