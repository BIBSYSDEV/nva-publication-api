...
public class LiteraryArtsAudioVisual implements LiteraryArtsManifestation, PublisherInInstance {
  ...
  @JsonCreator
  public LiteraryArtsAudioVisual(
      @JsonProperty(SUBTYPE_FIELD) LiteraryArtsAudioVisualSubtype subtype,
  ...
  public int hashCode() {
    return Objects.hash(
        getSubtype(), getPublisher(), getPublicationDate(), getIsbnList(), getExtent());
  }
}
