...
public final class DefinedDuration implements Duration {
  ...
  @JsonCreator
  private DefinedDuration(
      @JsonProperty(MINUTES_FIELD) int minutes,
      @JsonProperty(HOURS_FIELD) int hours,
      @JsonProperty(DAYS_FIELD) int days,
      @JsonProperty(WEEKS_FIELD) int weeks) {
