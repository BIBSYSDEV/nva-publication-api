...
public class LiteraryArtsAudioVisualSubtype {
  ...
  public static LiteraryArtsAudioVisualSubtype createOther(String description) {
    return new LiteraryArtsAudioVisualSubtypeOther(
        LiteraryArtsAudioVisualSubtypeEnum.OTHER, description);
  }
  ...
  public static LiteraryArtsAudioVisualSubtype create(Object subtype) {
    if (subtype instanceof String) {
      return new LiteraryArtsAudioVisualSubtype(
          LiteraryArtsAudioVisualSubtypeEnum.parse((String) subtype));
  ...
  private static LiteraryArtsAudioVisualSubtype parseCurrentImplementation(
