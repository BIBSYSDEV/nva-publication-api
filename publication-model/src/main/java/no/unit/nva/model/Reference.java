...
public class Reference {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(publicationContext, reference.getPublicationContext())
        && Objects.equals(
            Optional.ofNullable(publicationContext).map(PublicationContext::getClass),
            Optional.ofNullable(reference.getPublicationContext())
                .map(PublicationContext::getClass))
        && Objects.equals(doi, reference.doi)
        && Objects.equals(publicationInstance, reference.getPublicationInstance())
        && Objects.equals(
            Optional.ofNullable(publicationInstance).map(PublicationInstance::getClass),
            Optional.ofNullable(reference.getPublicationInstance())
