...
public class FeatureArticle extends JournalNonPeerReviewedContent {
     ...
     */
    @JsonCreator
    public FeatureArticle(@JsonProperty("volume") String volume,
    ...
    private FeatureArticle(Builder builder) {
    ...
    public static final class Builder {
        ...
        public FeatureArticle build() {
            return new FeatureArticle(this);
        }
    }
}
