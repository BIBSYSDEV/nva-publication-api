...
public class DegreeLicentiate extends DegreeBase {
   ...
   * thesis: A thesis for the licentiate's degree. It is given by some countries of the European
   * Union, Latin America and Syria. In Swedish and Finnish universities, a licentiate's degree is
   * now recognised as a pre-doctoral degree, in rank above the master's degree.
   *
