...
/**
 * The AbstractRightsRetentionStrategy abstract class represents the strategy for rights retention.
 * It makes use of Jackson annotations to handle JSON serialization and deserialization into the
 * correct implementing types: CustomerRightsRetentionStrategy, OverriddenRightsRetentionStrategy
