...
/** PublicationContext provides a common root object for contexts of type {@link BasicContext}. */
...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(
      name = "MediaContributionPeriodical",
      value = MediaContributionPeriodical.class),
  @JsonSubTypes.Type(
      name = "UnconfirmedMediaContributionPeriodical",
