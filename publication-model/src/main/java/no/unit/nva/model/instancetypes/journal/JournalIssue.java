...
public class JournalIssue extends JournalNonPeerReviewedContent {
  /**
   * In order to represent entire issues of a journal — in cases where an institution has a special
   * issue of a journal featuring work from a group of researcher associated with the department, or
   * a similar collection. This class is used as a placeholder to hold information of such
   * collections
   *
