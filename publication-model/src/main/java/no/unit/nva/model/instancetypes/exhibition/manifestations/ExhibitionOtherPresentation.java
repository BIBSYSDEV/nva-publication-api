...
public class ExhibitionOtherPresentation
    implements ExhibitionProductionManifestation, PublisherInInstance {
  ...
  public int hashCode() {
    return Objects.hash(
        getTypeDescription(), getDescription(), getPlace(), getPublisher(), getDate());
  }
}
