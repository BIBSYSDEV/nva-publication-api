...
public class Book implements BasicContext {
  ...
  public Book(
      @JsonProperty(JSON_PROPERTY_SERIES) BookSeries series,
      @JsonProperty(value = JSON_PROPERTY_SERIES_TITLE, access = WRITE_ONLY)
          String unconfirmedSeriesTitle,
      ...
      @JsonProperty(JSON_PROPERTY_REVISION) Revision revision)
      throws InvalidUnconfirmedSeriesException {
    this(
        BookSeries.extractSeriesInformation(series, unconfirmedSeriesTitle),
        seriesNumber,
        publisher,
        isbnList,
        revision);
  ...
  /**
   * Returns the ISBN list to the object after checking that the ISBNs are valid and removing
   * ISBN-punctuation.
   *
