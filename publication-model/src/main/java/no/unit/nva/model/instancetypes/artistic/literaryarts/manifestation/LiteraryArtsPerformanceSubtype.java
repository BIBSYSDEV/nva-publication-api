...
public class LiteraryArtsPerformanceSubtype {
  ...
  public static LiteraryArtsPerformanceSubtype createOther(String description) {
    return new LiteraryArtsPerformanceSubtypeOther(
        LiteraryArtsPerformanceSubtypeEnum.OTHER, description);
  }
  ...
  private static LiteraryArtsPerformanceSubtype parseCurrentImplementation(
