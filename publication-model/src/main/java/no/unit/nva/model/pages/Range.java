...
public class Range implements Pages {
  ...
  /**
   * Default constructor for Range ensures that a range has a specified beginning and an end, and
   * contains no unnecessary whitespace, nor members that are only whitespace.
   *
