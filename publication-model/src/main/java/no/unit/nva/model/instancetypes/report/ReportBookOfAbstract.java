...
public class ReportBookOfAbstract implements PublicationInstance<MonographPages> {
  ...
  /**
   * Book of abstracts: contains abstracts of presentations (lectures and posters) given at a
   * specific conference. Published by a publisher or by the conference itself.
   *
