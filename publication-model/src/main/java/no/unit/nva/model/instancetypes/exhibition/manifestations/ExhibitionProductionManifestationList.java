...
public class ExhibitionProductionManifestationList
  ...
  public ExhibitionProductionManifestationList(
      List<ExhibitionProductionManifestation> manifestations) {
  ...
  @Override
  public ExhibitionProductionManifestation set(
      int index, ExhibitionProductionManifestation element) {
