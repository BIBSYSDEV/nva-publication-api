...
public class Event implements PublicationContext {
  ...
  public Event(
      @JsonAlias(LABEL_FIELD) @JsonProperty(NAME_FIELD) String name,
  ...
  public static final class Builder {
    ...
    /**
     * This method is deprecated because it conflicts with the generally used "label" concept
     * "labels", which is always and only a language map. Use @{link #withName}.
     *
