...
public class LandingPageUtilTest {
  ...
  public void constructResourceThrowsExceptionWhenHostIsInvalid() {
    ...
    when(mockEnv.readEnvOpt(LandingPageUtil.RESOURCES_HOST_ENV_VARIABLE))
        .thenReturn(Optional.of(INVALID_HOST));
    ...
    assertThat(
        ...
        is(equalTo(ERROR_PUBLICATION_LANDING_PAGE_COULD_NOT_BE_CONSTRUCTED)));
  }
}
