...
public final class ReserveDoiRequestValidator {
  ...
  public static final String NOT_DRAFT_STATUS_ERROR_MESSAGE =
      "Operation is not allowed, publication is not a draft";
  public static final String DOI_ALREADY_EXISTS_ERROR_MESSAGE =
      "Operation is not allowed, publication already has " + "doi";
  public static final String UNSUPPORTED_ROLE_ERROR_MESSAGE =
      "User does not have rights to create doi";

  private ReserveDoiRequestValidator() {}

  public static void validateRequest(UserInstance userInstance, Resource resource)
