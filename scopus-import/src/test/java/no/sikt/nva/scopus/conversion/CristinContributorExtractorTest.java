...
public class CristinContributorExtractorTest {
  ...
  public static final TypedValue FIRST_NAME =
      new TypedValue(FIRST_NAME_CRISTIN_FIELD_NAME, "First");
  ...
  void shouldCreateIdentityWithFullName() {
    ...
    var contributor =
        CristinContributorExtractor.generateContributorFromCristinPerson(
            person, authorTp(), null, null);
  ...
  @Test
  void
      shouldReturnContributorWhichIsCorrespondingAuthorWhenIndexedNameEqualsCorrespondencePersonIndexedName() {
    var person = new CristinPerson(null, null, Set.of(FIRST_NAME, LAST_NAME), null, null, null);
    var contributor =
        CristinContributorExtractor.generateContributorFromCristinPerson(
            person, authorTp(), correspondencePerson(), null);
