...
public final class CristinContributorExtractor {
    ...
    private static Collection<OrganizationMapping> generateOrganizations(Set<Affiliation> affiliations,
                                                                         AuthorGroupWithCristinOrganization authorGroupWithCristinOrganization) {
    ...
    private static Collection<OrganizationMapping> createOrganizationsFromActiveCristinPersonAffiliations(
        Set<Affiliation> affiliations, AuthorGroupWithCristinOrganization authorGroupWithCristinOrganization) {
        var list = new ArrayList<OrganizationMapping>();
        list.add(new OrganizationMapping(null,
    ...
    private static OrganizationMapping toOrganization(Affiliation affiliation) {
        return new OrganizationMapping(Organization.fromUri(affiliation.getOrganization()), null);
    }

    private static OrganizationMapping toOrganization(CristinOrganization cristinOrganization,
                                                      AuthorGroupTp authorGroupTp) {
        return new OrganizationMapping(Organization.fromUri(cristinOrganization.id()),
                                       AffiliationMapper.mapToAffiliation(authorGroupTp.getAffiliation()));
    }

    private static Stream<OrganizationMapping> createOrganizationFromCristinOrganization(
        AuthorGroupWithCristinOrganization authorGroupWithCristinOrganization) {
