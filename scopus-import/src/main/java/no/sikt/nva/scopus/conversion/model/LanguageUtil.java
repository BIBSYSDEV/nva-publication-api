...
public final class LanguageUtil {
  ...
  public static String guessTheLanguageOfTheInputStringAsIso6391Code(
      String textToBeGuessedLanguageCodeFrom) {
  ...
  private static String getIso6391LanguageCodeForSupportedNvaLanguage(
      String possiblyUnsupportedLanguageIso6391code) {
