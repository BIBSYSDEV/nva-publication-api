...
public class ScopusUpdater {
  ...
  public ImportCandidate updateImportCandidate(ImportCandidate importCandidate)
    ...
    var existingImportCandidate =
        fetchImportCandidate(importCandidate.getScopusIdentifier().orElse(null));
    if (nonNull(existingImportCandidate)) {
      var persistedImportcandidate =
          resourceService.getImportCandidateByIdentifier(existingImportCandidate.getIdentifier());
      return updateImportCandidate(importCandidate, persistedImportcandidate);
    }
    return importCandidate;
  }

  private static ImportCandidate updateImportCandidate(
      ImportCandidate importCandidate, ImportCandidate persistedImportcandidate) {
  ...
  public ExpandedImportCandidate toExpandedImportCandidate(
      ImportCandidateSearchApiResponse response) throws BadGatewayException {
