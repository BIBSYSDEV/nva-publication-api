...
public class CristinConnection {
  ...
  private static final String CRISTIN_ORGANIZATION_RESPONSE_ERROR =
      "Could not fetch cristin organization: ";
  ...
  private SearchOrganizationResponse convertSearchResponseToOrganization(String body)
