...
public class UpdateApprovalRequestHandlerTest {

    private UpdateApprovalRequestHandler handler;
    ...
    public void initialize() {
        ...
        handler = new UpdateApprovalRequestHandler(new Environment());
    }

    @Test
    public void updateDummyApprovalWithRandomStringReturnsAccepted() throws IOException {
