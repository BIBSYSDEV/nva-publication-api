...
public class EventBridgeRetryClientTest {
  ...
  @Mock private EventBridgeClient eventBridge;
  ...
  public void putEventsIsSuccessReturnsNoFailingEntries() {
    ...
    PutEventsRequest request = PutEventsRequest.builder().build();
  ...
  private PutEventsRequest createPutEventsRequest(List<PutEventsRequestEntry> requestEntries) {
    return PutEventsRequest.builder().entries(requestEntries).build();
  }

  private void prepareMocksWithConsecutiveResponses(
      PutEventsResponse firstResponse, PutEventsResponse secondResponse) {
  ...
  private void prepareMocksWithConsecutiveResponses(
      PutEventsResponse firstResponse,
  ...
  private PutEventsResponse createPutEventsResponse(
      int failedEntryCount, List<PutEventsResultEntry> resultEntries) {
  ...
  private PutEventsRequestEntry createPutEventsRequestEntry(String s) {
    return PutEventsRequestEntry.builder().detail(s).build();
  }

  private PutEventsResultEntry createFailedPutEventsResultEntry() {
    PutEventsResultEntry failedResponseEntry =
        PutEventsResultEntry.builder().errorCode("failed").build();
