...
public class EventBridgePublisher implements EventPublisher {
  ...
  public EventBridgePublisher(
      EventBridgeRetryClient eventBridge,
  ...
  public void publish(final DynamodbEvent event) {
    ...
    List<PutEventsRequestEntry> failedEntries = putEventsToEventBus(requestEntries);
  ...
  private List<PutEventsRequestEntry> putEventsToEventBus(
      List<PutEventsRequestEntry> requestEntries) {
