...
public class UpdateDoiStatusProcess {
  ...
  public static final String ERROR_BAD_DOI_UPDATE_HOLDER_FORMAT =
      "Invalid payload for DoiUpdateHolder DTO: %s";
  public static final String MODIFIED_DOI_IS_IN_THE_FUTURE =
      "Modified doi is in the future, bailing!";
  ...
  public UpdateDoiStatusProcess(ResourceService resourceService, DoiUpdateHolder request) {
    if (isInvalidPayloadFormat(request)) {
      throw new IllegalArgumentException(
          String.format(
              ERROR_BAD_DOI_UPDATE_HOLDER_FORMAT,
  ...
  private Publication fetchPublication(
      ResourceService resourceService, SortableIdentifier requestedPublicationId) {
