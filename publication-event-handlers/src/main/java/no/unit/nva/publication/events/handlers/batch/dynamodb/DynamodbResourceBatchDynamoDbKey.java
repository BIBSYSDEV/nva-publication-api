...
public record DynamodbResourceBatchDynamoDbKey(
  ...
  public Map<String, AttributeValue> toPrimaryKey() {
    ...
    return Map.of(
        PRIMARY_KEY_PARTITION_KEY_NAME, AttributeValue.fromS(partitionKey),
        PRIMARY_KEY_SORT_KEY_NAME, AttributeValue.fromS(sortKey));
  }
  ...
  public String toString() {
    if (isGsiQuery()) {
      return String.format(
          "DynamoDbKey{index='%s', pk='%s', sk='%s'}", indexName, partitionKey, sortKey);
    }
