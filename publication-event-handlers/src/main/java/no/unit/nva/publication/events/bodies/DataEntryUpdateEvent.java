...
public class DataEntryUpdateEvent implements JsonSerializable {
  ...
  public static final String FILE_ENTRY_DELETING_EVENT_TOPIC =
      "PublicationService.FileEntry.Deleting";
  public static final String FILE_ENTRY_DELETED_EVENT_TOPIC =
      "PublicationService.FileEntry.Deleted";
