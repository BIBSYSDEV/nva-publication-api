...
public class PersistedResourcesService {
  ...
  private PersistedResourcesException throwError(
      Failure<URI> failure, ExpandedDataEntry expandedDataEntry) {
    ...
    return new PersistedResourcesException(
        "Failed to persist expanded resource to S3.", failure.getException());
  }
