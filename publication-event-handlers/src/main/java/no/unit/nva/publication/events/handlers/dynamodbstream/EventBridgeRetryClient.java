...
public class EventBridgeRetryClient {
  ...
  private PutEventsRequest createEventWithFailedEntries(List<PutEventsRequestEntry> failedEntries) {
    ...
    requestCopy = PutEventsRequest.builder().entries(failedEntries).build();
    return requestCopy;
  }

  private List<PutEventsRequestEntry> getFailedEntries(
      PutEventsRequest request, PutEventsResponse response) {
