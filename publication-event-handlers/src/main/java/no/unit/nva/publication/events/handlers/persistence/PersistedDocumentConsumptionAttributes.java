...
public class PersistedDocumentConsumptionAttributes {
  ...
  public static final String UNSUPPORTED_TYPE_ERROR_MESSAGE =
      "Currently unsupported type of entry:";
  ...
  public static PersistedDocumentConsumptionAttributes createAttributes(
      ExpandedDataEntry expandedEntry) {
    if (expandedEntry instanceof ExpandedResource) {
      return new PersistedDocumentConsumptionAttributes(
          RESOURCES_INDEX, expandedEntry.identifyExpandedEntry());
    } else if (expandedEntry instanceof ExpandedImportCandidate) {
      return new PersistedDocumentConsumptionAttributes(
          IMPORT_CANDIDATES_INDEX, expandedEntry.identifyExpandedEntry());
    } else if (expandedEntry instanceof ExpandedTicket) {
      return new PersistedDocumentConsumptionAttributes(
          TICKETS_INDEX, expandedEntry.identifyExpandedEntry());
    }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getIndex(), that.getIndex())
        && Objects.equals(getDocumentIdentifier(), that.getDocumentIdentifier());
  }
}
