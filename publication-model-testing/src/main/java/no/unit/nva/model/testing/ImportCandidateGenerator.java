...
public final class ImportCandidateGenerator {
  ...
  public static ImportCandidate randomImportCandidate(List<ImportContributor> contributors) {
    return new ImportCandidate.Builder()
        ...
        .withEntityDescription(
            randomImportEntityDescription(
                randomPublicationContext(randomPublicationInstance().getClass()), contributors))
  ...
  public static ImportContributor randomImportContributorWithAffiliationId(URI affiliationId) {
    return new ImportContributor(
        randomIdentityForContributorFromScopus(),
        List.of(randomImportOrganization(affiliationId)),
        creatorRole(),
        1,
        randomBoolean());
  }

  public static ImportEntityDescription randomImportEntityDescription(
      PublicationContext publicationContext, List<ImportContributor> contributors) {
  ...
  public static ImportContributor randomImportContributorWithName(String name) {
    return new ImportContributor(
        new Identity.Builder().withName(name).build(),
        emptyList(),
        creatorRole(),
        1,
        randomBoolean());
