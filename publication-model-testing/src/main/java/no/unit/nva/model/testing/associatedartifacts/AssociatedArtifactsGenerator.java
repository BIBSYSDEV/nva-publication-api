...
public final class AssociatedArtifactsGenerator {
  ...
  public static final NullRightsRetentionStrategy NULL_RIGHTS_RETENTION_STRATEGY =
  ...
  public static List<AssociatedArtifact> randomAssociatedArtifacts() {
    return new AssociatedArtifactList(
  ...
  public static List<AssociatedArtifact>
      randomAssociatedArtifactsIncludingUploadedFileAndRejectedFile() {
  ...
  public static File randomOpenFile(PublisherVersion version) {
    return randomFileBuilder().withPublisherVersion(version).buildOpenFile();
  }

  public static File randomOpenFile(PublisherVersion version, String name) {
    return randomFileBuilder().withPublisherVersion(version).withName(name).buildOpenFile();
  }
