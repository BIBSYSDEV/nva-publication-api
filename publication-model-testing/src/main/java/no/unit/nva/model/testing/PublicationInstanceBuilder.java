...
public final class PublicationInstanceBuilder {
  ...
  public static PublicationInstance<? extends Pages> randomPublicationInstance(
    ...
    switch (typeName) {
      ...
      case "OtherArtisticOutput":
        return generateOtherArtisticOutput();
      default:
  ...
  private static ExhibitionOtherPresentation randomExhibitionOtherPresentation() {
    return new ExhibitionOtherPresentation(
        randomString(),
        randomString(),
  ...
  private static ExhibitionMentionInPublication randomExhibitionMentionInPublication() {
    return new ExhibitionMentionInPublication(
        randomString(), randomString(), randomString(), randomNvaInstant(), randomString());
  }

  private static ExhibitionBasic randomExhibitionBasic() {
    return new ExhibitionBasic(
        randomUnconfirmedOrganization(), randomUnconfirmedPlace(), randomNvaPeriod());
  }
  ...
  private static DataManagementPlan generateDataManagementPlan() {
    return new DataManagementPlan(
        Set.of(new UnconfirmedDocument(randomString(), randomInteger())), randomMonographPages());
  }
  ...
  private static MusicPerformanceManifestation randomOtherPerformance() {
    ...
    return new OtherPerformance(
        randomString(), randomUnconfirmedPlace(), randomString(), List.of(randomWork()));
  }
  ...
  private static MusicPerformanceManifestation randomMusicScore() {
    ...
    return new MusicScore(
        randomString(), randomString(), randomString(), randomUnconfirmedPublisher(), randomIsmn());
  }
  ...
  private static List<MusicalWorkPerformance> randomConcertProgramme() {
    return List.of(
        new MusicalWorkPerformance(randomString(), randomString(), true),
  ...
  private static MusicPerformanceManifestation randomAudioVisualPublication() {
    return new AudioVisualPublication(
        randomMusicMediaSubType(),
        randomUnconfirmedPublisher(),
        randomString(),
        randomTrackList(),
        randomIsrc());
  ...
  private static MediaReaderOpinion generateMediaReaderOpinion() {
    return new MediaReaderOpinion(
        randomVolume(), randomIssue(), randomArticleNumber(), randomRange());
  }
  ...
  private static DegreePhd generateDegreePhd() {
    return new DegreePhd(
        ...
        Set.of(
            new ConfirmedDocument(randomUri(), randomInteger()),
  ...
  private static AcademicLiteratureReview generateAcademicLiteratureReview() {
    return new AcademicLiteratureReview(
        randomRange(), randomVolume(), randomIssue(), randomArticleNumber());
  }
  ...
  private static PublicationInstance<? extends Pages> literaryArts(
      LiteraryArtsSubtypeEnum subtype) {
    var literaryArtsSubtype = literaryArtsSubtype(subtype);
    return new LiteraryArts(
        literaryArtsSubtype, randomLiteraryArtsManifestationList(), randomString());
  }
  ...
  private static List<LiteraryArtsManifestation> randomLiteraryArtsManifestationList() {
    ...
    var monograph =
        new LiteraryArtsMonograph(
            ...
            randomMonographPages());
    var audioVisual =
        new LiteraryArtsAudioVisual(
            randomLiteraryArtsAudioVisualSubtype(),
            randomUnconfirmedPublisher(),
            randomPublicationDate(),
            List.of(isbn),
            randomInteger());
    var performance =
        new LiteraryArtsPerformance(
            randomLiteraryArtsPerformanceSubtype(),
            randomUnconfirmedPlace(),
            randomPublicationDate());
    var web =
        new LiteraryArtsWeb(randomUri(), randomUnconfirmedPublisher(), randomPublicationDate());
  ...
  private static PublicationInstance<? extends Pages> performingArts(
      PerformingArtsSubtypeEnum subtype) {
  ...
  private static PublicationInstance<? extends Pages> movingPicture(
      MovingPictureSubtypeEnum subtype) {
    return new MovingPicture(
        getMovingPictureSubtype(subtype),
        randomString(),
        randomMovingPictureOutputs(),
        NullDuration.create());
  }
  ...
  private static Broadcast streaming() {
    return new Broadcast(
        new UnconfirmedPublisher(randomString()), randomNvaInstant(), randomInteger());
  }

  private static PublicationInstance<? extends Pages> architecture(
      ArchitectureSubtypeEnum subtype) {
    return new Architecture(
        architectureSubtype(subtype), randomString(), randomArchitectureOutputs());
  }
  ...
  private static List<ArchitectureOutput> randomArchitectureOutputs() {
    return List.of(
        randomCompetition(), randomMentionInPublication(), randomAward(), randomExhibition());
  }
  ...
  private static ArchitectureOutput randomMentionInPublication() {
    return new MentionInPublication(
        randomString(), randomIssue(), randomNvaInstant(), randomString(), randomInteger());
  }
  ...
  private static ArtisticDesign artisticDesign(ArtisticDesignSubtypeEnum subtype) {
    var materializedSubtype =
        ArtisticDesignSubtypeEnum.OTHER.equals(subtype)
