...
public class DoiRegistrarEntryFieldsTest {
  ...
  @Test
  public void
      fromPublicationCreatesObjectWithNonEmptyValuesWhenPublicationContainsAllNecessaryInformation() {
  ...
  private Publication alterPublication(Publication publication) {
    ...
    EntityDescription alteredEntityDescription =
        entityDescriptionCopy.withMainTitle(SOME_OTHER_TITLE).build();
    return publication.copy().withEntityDescription(alteredEntityDescription).build();
  }
