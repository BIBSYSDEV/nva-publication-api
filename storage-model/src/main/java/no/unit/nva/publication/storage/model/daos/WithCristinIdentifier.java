...
public interface WithCristinIdentifier {
    ...
    default String getResourceByCristinIdPartitionKey() {
        return getCristinIdentifier() == null ? getCristinIdentifier()
    ...
    default Map<String, Condition> createConditionsWithCristinIdentifier() {
        Condition condition = new Condition()
                ...
                .withAttributeValueList(new AttributeValue(getResourceByCristinIdPartitionKey()));
