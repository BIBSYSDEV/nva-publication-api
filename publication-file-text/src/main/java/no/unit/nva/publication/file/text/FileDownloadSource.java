 ...
 * software.amazon.awssdk.services.s3.model.NoSuchKeyException} when the object does not exist and
 * {@link IOException} on transfer failure; implementations must not leave a temp file behind on
 * failure.
 */
@FunctionalInterface
