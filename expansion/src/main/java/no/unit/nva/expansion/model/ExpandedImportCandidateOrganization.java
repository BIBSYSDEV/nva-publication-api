...
public record ExpandedImportCandidateOrganization(URI id, Map<String, String> labels) {
  ...
  public static ExpandedImportCandidateOrganization fromCristinOrganization(
      CristinOrganization cristinOrganization) {
    return new ExpandedImportCandidateOrganization(
        cristinOrganization.id(), cristinOrganization.labels());
  }
}
