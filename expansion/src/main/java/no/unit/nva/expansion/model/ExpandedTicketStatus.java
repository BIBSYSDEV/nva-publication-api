...
public enum ExpandedTicketStatus {
  ...
  private static final String INVALID_EXPANDED_TICKET_STATUS_ERROR =
      "Invalid ExpandedTicket status. Valid values:  ";
  ...
  private boolean filterByNameOrValue(String candidate) {
    return toString().equalsIgnoreCase(candidate) || name().equalsIgnoreCase(candidate);
  }
}
