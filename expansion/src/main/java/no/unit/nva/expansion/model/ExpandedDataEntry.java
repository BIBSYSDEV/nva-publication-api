...
public interface ExpandedDataEntry extends JsonSerializable {
  ...
  /**
   * An identifier that identifies the specific entry uniquely. It is meant to be used only for
   * persisting entries for usage from other services (such as the Search service or Analytics
   * services)
   *
