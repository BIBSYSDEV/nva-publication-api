...
public final class ExpandedDoiRequest extends ExpandedTicket {
  ...
  public static ExpandedDoiRequest createEntry(
    ...
    expandedDoiRequest.setAssignee(
        ExpansionUtil.expandPerson(doiRequest.getAssignee(), expansionService));
    expandedDoiRequest.setFinalizedBy(
        ExpansionUtil.expandPerson(doiRequest.getFinalizedBy(), expansionService));
    expandedDoiRequest.setViewedBy(
        ExpansionUtil.expandPersonViewedBy(doiRequest.getViewedBy(), expansionService));
  ...
  private static ExpandedDoiRequest fromDoiRequest(
      DoiRequest doiRequest,
      ResourceService resourceService,
    ...
    entry.setViewedBy(
        ExpansionUtil.expandPersonViewedBy(doiRequest.getViewedBy(), resourceExpansionService));
    entry.setPublication(publicationSummary);
    entry.setFinalizedBy(
        ExpansionUtil.expandPerson(doiRequest.getFinalizedBy(), resourceExpansionService));
    return entry;
  }
}
