...
public record License(URI value, String name, Map<String, String> labels)
  ...
  public enum LicenseType {
    ...
    public boolean hasPathParam(URI uri) {
      return Optional.ofNullable(uri)
          .map(URI::getPath)
          .map(this::containsPathParameter)
          .orElse(false);
    }
    ...
    private boolean containsPathParameter(String value) {
      return value
          ...
          .contains(this.pathParameter.toLowerCase(Locale.getDefault()));
    }
    ...
    private static final class Constants {
      ...
      public static final Map<String, String> CC_NC_ND_LABELS =
          Map.of(
      ...
      public static final Map<String, String> CC_NC_SA_LABELS =
          Map.of(
