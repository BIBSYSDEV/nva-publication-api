...
public class NewCreateMessageHandler extends ApiGatewayHandler<CreateMessageRequest, Void> {
  ...
  protected void validateRequest(
      CreateMessageRequest createMessageRequest, RequestInfo requestInfo, Context context)
  ...
  protected Void processInput(CreateMessageRequest input, RequestInfo requestInfo, Context context)
    ...
    var message =
        messageService.createMessage(ticket, requestUtils.toUserInstance(), input.getMessage());
  ...
  private static void userHasPermissionToCreateMessageForTicket(
      PublicationPermissions permissionStrategy, TicketEntry ticketDto)
