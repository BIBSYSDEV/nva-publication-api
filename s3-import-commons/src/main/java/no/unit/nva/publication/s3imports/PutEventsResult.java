...
public class PutEventsResult implements JsonSerializable {
  ...
  public PutEventsResult(
      @JsonProperty("request") PutEventsRequest request,
  ...
  /**
   * Override toString as a workaround for the the fact at {@link PutEventsRequest} and {@link
   * PutEventsResult} are not serializable as Json objects with Jackson, but they contain all
   * information in their {@code toString()} representations.
   *
