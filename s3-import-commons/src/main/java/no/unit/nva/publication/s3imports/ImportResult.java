...
public class ImportResult<I> implements JsonSerializable {
  ...
  @JsonIgnore public static final String INPUT_FIELD = "input";
  @JsonIgnore public static final String EXCEPTION_FIELD = "exception";
  @JsonIgnore public static final String STATUS_FIELD = "status";
  @JsonIgnore public static final String FAILURE = "FAILURE";
  ...
  @JacocoGenerated
  public ImportResult(
      @JsonProperty(INPUT_FIELD) I input,
