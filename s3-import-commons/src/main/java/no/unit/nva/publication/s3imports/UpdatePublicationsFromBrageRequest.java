...
public record UpdatePublicationsFromBrageRequest(URI uri, String archive, boolean dryRun)
    ...
    return attempt(
            () ->
                JsonUtils.dtoObjectMapper.readValue(
                    IoUtils.streamToString(inputStream), UpdatePublicationsFromBrageRequest.class))
        .orElseThrow();
  }
}
