...
/**
 * Event containing the contents of a file and additional information that are necessary for
...
public class FileContentsEvent<T> implements JsonSerializable {
  ...
  @JsonIgnore public static final String FILE_URI = "fileUri";
  @JsonIgnore public static final String TIMESTAMP = "timestamp";
  public static final String TOPIC = "topic";
  public static final String SUBTOPIC = "subtopic";
  @JsonIgnore protected static final String CONTENTS_FIELD = "contents";
  ...
  public static <T> FileContentsEvent<T> fromJson(String jsonString, Class<T> contentsClass) {
    ...
    return attempt(() -> s3ImportsMapper.<FileContentsEvent<T>>readValue(jsonString, javaType))
        .orElseThrow();
  }
  ...
  public EventReference toEventReference(S3Driver s3Driver) throws IOException {
    ...
    var uri =
        s3Driver.insertEvent(UnixPath.of(CRISTIN_ENTRIES_EVENT_FOLDER, timestamp.toString()), json);
