...
class DublinCoreAbstractMergerTest {
  ...
  void shouldNotAddAbstractWhenItMatchesResourceAbstract() {
    ...
    var result =
        DublinCoreAbstractMerger.mergeAbstracts(
            dcAbstracts, resourceAbstract, Collections.emptyMap());
  ...
  void shouldAddMultipleAbstractsWithDifferentLanguages() {
    ...
    var dcAbstracts =
        List.of(dcAbstract(englishAbstract, ENGLISH), dcAbstract(norwegianAbstract, NORWEGIAN));
  ...
  void shouldMergeMultipleAbstractsWithSameLanguage() {
    ...
    var dcAbstracts =
        List.of(dcAbstract(firstAbstract, ENGLISH), dcAbstract(secondAbstract, ENGLISH));
  ...
  void shouldSkipDuplicateAbstractsWhenMultipleWithSameContent() {
    ...
    var dcAbstracts =
        List.of(dcAbstract(duplicateAbstract, ENGLISH), dcAbstract(duplicateAbstract, ENGLISH));
