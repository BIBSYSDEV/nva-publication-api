...
public final class DatabaseConstants {
  ...
  public static final String IMPORT_CANDIDATE_KEY_PATTERN = "ImportCandidate:%s";
  ...
  public static final String GSI_1_INDEX_NAME = "GSI_1";
  ...
  public static final String GSI_1_PARTITION_KEY_NAME = "PK1";
  public static final String BY_CUSTOMER_RESOURCE_INDEX_PARTITION_KEY_NAME = "PK2";
  public static final String GSI_1_SORT_KEY_NAME = "SK1";
  ...
  public static final Map<String, DynamoDbKey> GSI_KEY_PAIRS =
      Map.of(
  ...
  public static final String SCOPUS_IDENTIFIER_INDEX_FIELD_PREFIX = "ScopusIdentifier";
  ...
  private static void logWarning() {
    logger.warn(
        ENVIRONMENT_VARIABLE_NOT_SET_WARNING,
