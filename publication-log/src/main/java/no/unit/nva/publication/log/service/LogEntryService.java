...
public class LogEntryService {
  ...
  public static final String PERSISTING_LOG_ENTRY_MESSAGE =
  ...
  private void persistLogEntry(Resource resource) {
    ...
    logger.info(
        PERSISTING_LOG_ENTRY_MESSAGE,
        resource.getResourceEvent().getClass().getSimpleName(),
        resource);
  }
  ...
  private void persistFileLogEntry(FileEntry fileEntry) {
    ...
    logger.info(
        PERSISTING_FILE_LOG_ENTRY_MESSAGE,
        fileEntry.getFile().getClass().getSimpleName(),
        fileIdentifier,
        resourceIdentifier);
  }
