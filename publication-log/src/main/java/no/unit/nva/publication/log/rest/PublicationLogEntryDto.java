...
public record PublicationLogEntryDto(
    LogTopic topic,
    Instant timestamp,
  ...
  public static PublicationLogEntryDto fromLogEntry(PublicationLogEntry publicationLogEntry) {
    return new PublicationLogEntryDto(
        publicationLogEntry.topic(),
        publicationLogEntry.timestamp(),
        publicationLogEntry.performedBy(),
        publicationLogEntry.resourceIdentifier(),
