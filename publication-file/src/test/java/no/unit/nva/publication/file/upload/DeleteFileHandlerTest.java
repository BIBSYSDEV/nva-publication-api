...
class DeleteFileHandlerTest extends ResourcesLocalTest {
  ...
  void shouldReturnAcceptedWhenPublicationDoesNotExist() throws IOException {
    var request =
        createAuthorizedRequestWithRandomUser(UUID.randomUUID(), SortableIdentifier.next());
  ...
  void shouldReturnAcceptedWhenFileDoesNotExist() throws IOException, BadRequestException {
    ...
    var request =
        createRequestForUserWithPermissions(
            file.getIdentifier(), resource.getIdentifier(), userInstance);
  ...
  @Test
  void shouldReturnForbiddenWhenUserHaNoPermissionToDeleteFile()
    ...
    var request =
        createAuthorizedRequestWithRandomUser(file.getIdentifier(), resource.getIdentifier());
  ...
  void shouldReturnInternalServerErrorWhenUnexpectedException()
    ...
    var request =
        createRequestForUserWithPermissions(
            UUID.randomUUID(), publication.getIdentifier(), curator);
  ...
  void shouldReturnAcceptedWhenDeletingFile() throws IOException, BadRequestException {
    ...
    var request =
        createRequestForUserWithPermissions(
            file.getIdentifier(), resource.getIdentifier(), curator);
  ...
  private static Map<String, String> getPathParameters(
      UUID fileIdentifier, SortableIdentifier publicationIdentifier) {
    return Map.of(
  ...
  private InputStream createRequestForUserWithPermissions(
      UUID fileIdentifier, SortableIdentifier resourceIdentifier, UserInstance userInstance)
      throws JsonProcessingException {
    return new HandlerRequestBuilder<Void>(dtoObjectMapper)
        .withPathParameters(getPathParameters(fileIdentifier, resourceIdentifier))
  ...
  private InputStream createAuthorizedRequestWithRandomUser(
      UUID fileIdentifier, SortableIdentifier publicationIdentifier)
      throws JsonProcessingException {
    return new HandlerRequestBuilder<Void>(dtoObjectMapper)
        .withPathParameters(getPathParameters(fileIdentifier, publicationIdentifier))
  ...
  private InputStream createUnauthorizedRequest(
      UUID fileIdentifier, SortableIdentifier publicationIdentifier)
      throws JsonProcessingException {
  ...
  private DeleteFileHandler handlerThrowingExceptionOnFileUpdate(
      Publication publication, UserInstance userInstance) throws NotFoundException {
    ...
    when(resourceService.fetchFile(any()))
        .thenReturn(
            Optional.of(
