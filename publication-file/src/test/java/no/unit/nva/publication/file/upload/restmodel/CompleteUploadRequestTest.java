...
class CompleteUploadRequestTest {
  ...
  void shouldSerializeAndDeserializeExternalCompleteUploadRequest() throws JsonProcessingException {
    ...
    var externalCompleteUploadRequest =
        JsonUtils.dtoObjectMapper.readValue(json, ExternalCompleteUploadRequest.class);

    var expected =
        new ExternalCompleteUploadRequest(
            "abcde123",
            "8d1dc28f-fec2-452f-9d58-da3d1ff03e87",
            List.of(new CompleteUploadPart(1, "34401a771b3e1dbb0d759cedb2fbf02f")),
            OpenFile.TYPE,
            null,
            null,
            null);
  ...
  @Test
  void shouldSerializeAndDeserializeExternalCompleteUploadRequest2()
  ...
  void shouldBePossibleToConsumeTwoEtagProperties() throws JsonProcessingException {
    ...
    var externalCompleteUploadRequest =
        JsonUtils.dtoObjectMapper.readValue(json, CompleteUploadRequest.class);
