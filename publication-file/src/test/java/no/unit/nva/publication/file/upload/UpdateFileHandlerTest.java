...
class UpdateFileHandlerTest extends ResourcesLocalTest {
  ...
  @Test
  void shouldReturnBadRequestWhenFileIdentifierInPathDoesNotMatchFileIdentifierInRequestBody()
      throws IOException {
  ...
  @Test
  void shouldReturnForbiddenWhenUserHasNoPermissionsToUpdateFile()
  ...
  void shouldReturnInternalServerErrorWhenUnexpectedErrorOccurs()
    ...
    var request =
        createRequestForUserWithPermissions(
            fileIdentifier, publication.getIdentifier(), curator, requestBody);
  ...
  @Test
  void shouldReturnAcceptedWhenFileHasBeenUpdatedSuccessfully()
      throws IOException, BadRequestException {
    ...
    var request =
        createRequestForUserWithPermissions(
            file.getIdentifier(), resource.getIdentifier(), curator, requestBody);
  ...
  private static Map<String, String> toPathParameters(
  ...
  private UpdateFileHandler handlerThrowingExceptionOnFileUpdate(
  ...
  private InputStream createRequestForUserWithPermissions(
    ...
    return new HandlerRequestBuilder<File>(dtoObjectMapper)
  ...
  private InputStream createRandomUserAuthorizedRequest(
      ...
      throws JsonProcessingException {
    return new HandlerRequestBuilder<File>(dtoObjectMapper)
        .withBody(randomUpdateFileRequest(fileIdentifier))
        .withPathParameters(toPathParameters(fileIdentifier, publicationIdentifier))
  ...
  private InputStream createNotSupportedRequest(SortableIdentifier publicationIdentifier)
    ...
    return new HandlerRequestBuilder<File>(dtoObjectMapper)
        .withBody(randomUpdateFileRequest(UUID.randomUUID()))
