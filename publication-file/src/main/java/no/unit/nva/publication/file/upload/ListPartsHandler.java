...
public class ListPartsHandler
  ...
  protected void validateRequest(
      ListPartsRequestBody listPartsRequestBody, RequestInfo requestInfo, Context context)
      throws ApiGatewayException {
    listPartsRequestBody.validate();
  }

  @Override
  protected ListPartsResponseBody processInput(
      ListPartsRequestBody input, RequestInfo requestInfo, Context context)
      throws ApiGatewayException {
