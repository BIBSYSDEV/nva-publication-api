...
public class FileService {
  ...
  public File completeMultipartUpload(
    ...
    var s3ObjectKey = completeMultipartUploadResult.key();
  ...
  public File constructFileForExternalClient(
      UUID identifier, ExternalCompleteUploadRequest uploadRequest, HeadObjectResponse metadata)
  ...
  private UploadedFile constructUploadedFile(
      UUID identifier, HeadObjectResponse metadata, UserInstance userInstance) {
    return new UploadedFile(
        identifier,
        Filename.fromContentDispositionValue(metadata.contentDisposition()),
