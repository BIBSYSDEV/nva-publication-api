...
public class FileService {
  ...
  public FileService(
      AmazonS3 amazonS3, CustomerApiClient customerApiClient, ResourceService resourceService) {
  ...
  public File completeMultipartUpload(
    ...
    var file =
        userInstance.isExternalClient()
                && request instanceof ExternalCompleteUploadRequest externalRequest
            ? constructFileForExternalClient(
                UUID.fromString(s3ObjectKey), externalRequest, objectMetadata)
  ...
  public void deleteFile(
    ...
    var fileEntry =
        FileEntry.queryObject(fileIdentifier, resourceIdentifier).fetch(resourceService);
  ...
  public File constructFileForExternalClient(
      UUID identifier, ExternalCompleteUploadRequest uploadRequest, ObjectMetadata metadata)
  ...
  private static void validateDeletePermissions(
      UserInstance userInstance, FileEntry fileEntry, Resource resource) throws ForbiddenException {
  ...
  private static void validateUpdateFilePermissions(
      Resource resource, FileEntry fileEntry, UserInstance userInstance) throws ForbiddenException {
    if (!new FilePermissions(fileEntry, userInstance, resource)
  ...
  private UploadedFile constructUploadedFile(
      UUID identifier, ObjectMetadata metadata, UserInstance userInstance) {
    return new UploadedFile(
        identifier,
        Filename.fromContentDispositionValue(metadata.getContentDisposition()),
