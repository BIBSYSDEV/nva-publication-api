...
public class AbortMultipartUploadHandler
    extends ApiGatewayHandler<AbortMultipartUploadRequestBody, Void> {
  ...
  protected void validateRequest(
      AbortMultipartUploadRequestBody abortMultipartUploadRequestBody,
  ...
  protected Void processInput(
      AbortMultipartUploadRequestBody input, RequestInfo requestInfo, Context context)
      throws ApiGatewayException {
