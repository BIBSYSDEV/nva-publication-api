...
public class CristinHrcsCategoriesAndActivities {
  ...
  private static final String CATEGORY_OR_ACTIVITY_NOT_VALID_EXCEPTION =
      "The %s Id %s is not a valid entry.";
  ...
  @JacocoGenerated
  public CristinHrcsCategoriesAndActivities() {}

  public static boolean validateCategory(String category) {
    if (!HRCS_CATEGORIES_MAP.containsKey(category)) {
      throw new HrcsException(
          String.format(CATEGORY_OR_ACTIVITY_NOT_VALID_EXCEPTION, "category", category));
    }
    return true;
  }
  ...
  public static boolean validateActivity(String activity) {
    if (!HRCS_ACTIVITIES_MAP.containsKey(activity)) {
      throw new HrcsException(
          String.format(CATEGORY_OR_ACTIVITY_NOT_VALID_EXCEPTION, "activity", activity));
    }
    return true;
  }
