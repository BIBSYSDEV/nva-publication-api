...
public class PublishingChannelEntryResolver {
  ...
  public PublishingChannelEntryResolver(
      Integer nsdCode,
      int year,
  ...
  public URI getPublisherUri() {
    return lookupNsdPublisherProxyUri()
        ...
        .orElseGet(
            () ->
                lookupNsdJournalOrSeriesProxyUri()
  ...
  private Optional<URI> lookupCristinPublisherByhName() {
    return channelNames.stream()
        .map(channelRegistryMapper::convertPublisherNameToPid)
        ...
        .flatMap(
            identifier ->
                channelRegistryMapper
                    .convertNsdJournalCodeToPid(identifier)
  ...
  private Optional<URI> lookupJournalByNsdCode() {
    return Optional.ofNullable(nsdCode)
        .flatMap(
            integer ->
                channelRegistryMapper.convertNsdJournalCodeToPid(integer).map(this::toJournalUri));
  }
  ...
  private Optional<URI> lookupNsdPublisherProxyUri() {
    return Optional.ofNullable(nsdCode)
        .flatMap(
            integer ->
                channelRegistryMapper
                    .convertNsdPublisherCodeToPid(integer)
                    .map(pid -> getNsdProxyUri(NSD_PROXY_PATH_PUBLISHER, pid)));
  }
  ...
  private Optional<URI> lookupNsdJournalOrSeriesProxyUri() {
    return Optional.ofNullable(nsdCode)
        .flatMap(
            integer ->
                channelRegistryMapper
                    .convertNsdJournalCodeToPid(integer)
