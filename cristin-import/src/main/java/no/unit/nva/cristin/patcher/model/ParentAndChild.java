...
public class ParentAndChild implements JsonSerializable {
  ...
  @JsonProperty private Publication childPublication;

  @JsonProperty private Publication parentPublication;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getChildPublication(), that.getChildPublication())
