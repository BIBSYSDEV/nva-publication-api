...
public final class ChannelRegistryMapper {
  ...
  public static final String JOURNAL_SERIES_ID_MAPPING_CSV =
      "channelRegistry/journals_series_by_nsd_code.csv";
  ...
  private static final String PATH_JOURNAL_NAME_CSV =
      "channelRegistry/journals_by_name_and_issn.csv";
  ...
  private static Map<Integer, String> getMapFromResource(String path) {
    try (var inputStream = IoUtils.inputStreamFromResources(path);
      ...
      var microJournal =
          new CsvToBeanBuilder<ChannelRegistryRepresentation>(bufferedReader)
      ...
      return microJournal.stream()
          .collect(
              Collectors.toMap(
                  ChannelRegistryRepresentation::getNsdCode,
  ...
  private static List<ChannelRegistryPublisherByNameRepresentation> getMapFromPublisherNameList(
      String path) {
    try (var inputStream = IoUtils.inputStreamFromResources(path);
        var bufferedReader = new BufferedReader(new InputStreamReader(inputStream))) {
