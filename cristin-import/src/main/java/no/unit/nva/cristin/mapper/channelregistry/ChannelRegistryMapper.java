...
public final class ChannelRegistryMapper {
    ...
    public static final String JOURNAL_SERIES_ID_MAPPING_CSV = "channelRegistry/journals_series_by_nsd_code_070625.csv";
    private static final char SEPARATOR = ';';
    private static final String PATH_PUBLISHER_ID_CSV = "channelRegistry/publishers_by_nsd_code_070625.csv";
