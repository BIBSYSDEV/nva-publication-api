...
public final class PublicationUpdater {
  ...
  public static PublicationRepresentations update(
  ...
  private static List<ResearchProject> updateProjects(
      PublicationRepresentations publicationRepresentations) {
    ...
    return shouldBeUpdated(existingProjects, incomingProjects)
        ? incomingProjects
        : existingProjects;
  }
  ...
  private static Set<Funding> updateFundings(
      PublicationRepresentations publicationRepresentations) {
    ...
    return shouldBeUpdated(existingFundings, incomingFundings)
        ? incomingFundings
        : existingFundings;
  }

  private static EntityDescription updatedEntityDescription(
      PublicationRepresentations publicationRepresentations) {
    return publicationRepresentations
  ...
  private static String updateNpiSubjectHeading(
      PublicationRepresentations publicationRepresentations) {
    var existingNpiSubjectHeading =
        getNpiSubjectHeading(publicationRepresentations.getExistingPublication());
    var incomingNpiSubjectHeading =
        getNpiSubjectHeading(publicationRepresentations.getIncomingPublication());
  ...
  private static List<Contributor> updateContributors(
      PublicationRepresentations publicationRepresentations) {
  ...
  private static void setIdForExistingContributorWhenMissing(
      Contributor incomingContributor, List<Contributor> existingContributors) {
    var contributorMissingId =
  ...
  private static boolean isDegree(Publication publication) {
    return publication.getEntityDescription().getReference().getPublicationContext()
        instanceof Degree;
  }
  ...
  private static List<String> updatedTags(PublicationRepresentations publicationRepresentations) {
    var existingTags =
        publicationRepresentations.getExistingPublication().getEntityDescription().getTags();
    var incomingTags =
        publicationRepresentations.getIncomingPublication().getEntityDescription().getTags();
  ...
  private static Reference updateReference(PublicationRepresentations publicationRepresentations) {
    var existinReference =
        publicationRepresentations.getExistingPublication().getEntityDescription().getReference();
  ...
  private static PublicationInstance<? extends Pages> updatePublicationInstance(
      PublicationRepresentations publicationRepresentations) {
    var existingPublicationInstance =
        getPublicationInstance(publicationRepresentations.getExistingPublication());
    var incomingPublicationInstance =
        getPublicationInstance(publicationRepresentations.getIncomingPublication());
    ...
    if (existingPublicationInstance instanceof JournalArticle existingJournalArticle
        ...
        && existingPublicationInstance
            .getInstanceType()
            .equals(incomingPublicationInstance.getInstanceType())) {
  ...
  @JacocoGenerated
  private static AcademicLiteratureReview getAcademicLiteratureReview(
      JournalArticle existingJournalArticle, JournalArticle incomingJournalArticle) {
    return new AcademicLiteratureReview(
        existingJournalArticle.getPages(),
  ...
  @JacocoGenerated
  private static AcademicArticle getAcademicArticle(
      JournalArticle existingJournalArticle, JournalArticle incomingJournalArticle) {
  ...
  @JacocoGenerated
  private static PopularScienceArticle getPopularScienceArticle(
      JournalArticle existingJournalArticle, JournalArticle incomingJournalArticle) {
  ...
  @JacocoGenerated
  private static ProfessionalArticle getProfessionalArticle(
      JournalArticle existingJournalArticle, JournalArticle incomingJournalArticle) {
  ...
  private static PublicationInstance<? extends Pages> getPublicationInstance(
      Publication publication) {
    return publication.getEntityDescription().getReference().getPublicationInstance();
  }

  private static PublicationContext updatePublicationContext(
      PublicationRepresentations publicationRepresentations) {
    var existingPublicationContext =
        getPublicationContext(publicationRepresentations.getExistingPublication());
    var incomingPublicationContext =
        getPublicationContext(publicationRepresentations.getIncomingPublication());
    return updatePublicationContext(existingPublicationContext, incomingPublicationContext);
  }

  private static PublicationContext updatePublicationContext(
      PublicationContext existingPublicationContext,
    ...
    if (existingPublicationContext instanceof MediaContribution existingMediaContribution
      ...
      return new MediaContribution.Builder()
          ...
          .withDisseminationChannel(
              updateDisseminationChannel(existingMediaContribution, incomingMediaContribution))
          .build();
    } else {
  ...
  private static String updateDisseminationChannel(
      MediaContribution existingMediaContribution, MediaContribution incomingMediaContribution) {
  ...
  private static Event updateEvent(Event existingEvent, Event incomingEvent) {
    ...
    if (shouldBeUpdated(existingPlace, incomingPlace)
      ...
      return new Event.Builder()
          ...
          .withAgent(
              nonNull(existingEvent.getAgent())
                  ? existingEvent.getAgent()
                  : incomingEvent.getAgent())
          .withTime(
              nonNull(existingEvent.getTime()) ? existingEvent.getTime() : incomingEvent.getTime())
          .withProduct(existingEvent.getProduct().orElse(incomingEvent.getProduct().orElse(null)))
          .withSubEvent(
              existingEvent.getSubEvent().orElse(incomingEvent.getSubEvent().orElse(null)))
  ...
  private static UnconfirmedPlace getPlaceCountry(Event event) {
    return Optional.ofNullable(event.getPlace()).map(UnconfirmedPlace.class::cast).orElse(null);
  }
  ...
  private static AssociatedArtifactList updatedAssociatedLinks(
      PublicationRepresentations publicationRepresentations) {
    var incomingAssociatedLinks =
        publicationRepresentations.getIncomingPublication().getAssociatedArtifacts();
    var existingAssociatedLinks =
        publicationRepresentations.getExistingPublication().getAssociatedArtifacts();
