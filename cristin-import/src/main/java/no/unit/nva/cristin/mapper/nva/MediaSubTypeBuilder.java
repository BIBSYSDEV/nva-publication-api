...
public class MediaSubTypeBuilder {
  ...
  private static final Map<CristinMediumTypeCode, MediaSubTypeEnum>
      cristinMediumTypeToNVAMediumTypeRule =
          Map.of(
              CristinMediumTypeCode.RADIO, MediaSubTypeEnum.RADIO,
  ...
  public MediaSubType build() {
    var cristinMediumTypeCode =
        cristinObject.getMediaContribution().getCristinMediumType().getMediumTypeCode();
    var mediaSubTypeEnum =
        cristinMediumTypeToNVAMediumTypeRule.getOrDefault(
            cristinMediumTypeCode, MediaSubTypeEnum.OTHER);
