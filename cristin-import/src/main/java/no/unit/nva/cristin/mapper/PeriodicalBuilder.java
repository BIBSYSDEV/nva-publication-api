...
public class PeriodicalBuilder extends CristinMappingModule {
  ...
  private UnconfirmedJournal createUnconfirmedJournalAndPersistErrorReport()
  ...
  private Periodical createJournal() {
    ...
    var channelNames =
        nonNull(extractPublisherTitle()) ? List.of(extractPublisherTitle()) : List.<String>of();
    var journalUri =
