...
public record ChannelRegistryEntry(String id, ChannelType type) {
  ...
  public static ChannelRegistryEntry fromChannelRegistryRepresentation(
      ChannelRegistryRepresentation representation) {
    return new ChannelRegistryEntry(
        representation.getPid(), ChannelType.fromValue(representation.getType()));
  }
