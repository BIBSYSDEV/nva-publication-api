...
public final class ChildParentInstanceComparator {
  ...
  private static final Map<String, List<String>> VALID_PUBLICATION_INSTANCE =
      Map.of(
          ...
          List.of(
              BookAnthology.class.getSimpleName(), Textbook.class.getSimpleName(),
              NonFictionMonograph.class.getSimpleName(),
                  PopularScienceMonograph.class.getSimpleName(),
          ...
          List.of(
              BookAnthology.class.getSimpleName(), NonFictionMonograph.class.getSimpleName(),
          ...
          List.of(
              BookAnthology.class.getSimpleName(),
              NonFictionMonograph.class.getSimpleName(),
              Introduction.class.getSimpleName(),
              Textbook.class.getSimpleName(),
              PopularScienceMonograph.class.getSimpleName(),
              AcademicMonograph.class.getSimpleName(),
              ExhibitionCatalog.class.getSimpleName(),
              Encyclopedia.class.getSimpleName(),
              ReportResearch.class.getSimpleName()),
          PopularScienceChapter.class.getSimpleName(),
          List.of(
              BookAnthology.class.getSimpleName(), PopularScienceMonograph.class.getSimpleName(),
              ...
              AcademicMonograph.class.getSimpleName(), ReportResearch.class.getSimpleName()),
          TextbookChapter.class.getSimpleName(),
          List.of(Textbook.class.getSimpleName()),
