...
public interface MovingPictureExtractor {
  ...
  default MovingPictureSubtype extractSubType(
      ArtisticProductionTimeUnit timeUnit, String duration) {
  ...
  private MovingPictureSubtype determineShortOrFeatureFilm(
      ArtisticProductionTimeUnit timeUnit, String duration) {
  ...
  private boolean hasUnknownLenght(ArtisticProductionTimeUnit timeUnit, String duration) {
    return isNull(timeUnit) || !timeUnit.timeUnitIsInMinutes() || isNull(duration);
  }
