...
public class DegreeFeatures {
  ...
  public void theNvaDegreePhdHasAPublicationContextWithNumberOfPagesEqualTo(
  ...
  public void theNvaDegreeMasterHasAPublicationContextWithNumberOfPagesEqualTo(
      String expectedNumberOfPages) {
    PublicationInstance<?> instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaDegreeLicentiateHasAPublicationContextWithNumberOfPagesEqualTo(
      String expectedNumberOfPages) {
    PublicationInstance<?> instance =
        scenarioContext
            .getNvaEntry()
