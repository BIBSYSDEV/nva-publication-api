...
public class JournalFeatures {
    ...
    public void thatTheCristinResultHasANonEmptyJournalPublication() throws JsonProcessingException {
    ...
    @And("the Journal Publication has a \"publisherName\" entry equal to {string}")
    ...
    public void theNvaResourceHasAPublicationContextWithPagesBeginEqualTo(String expectedPagesBegin) {
        PublicationInstance instance = scenarioContext
                                        .getNvaEntry()
                                        .getEntityDescription()
                                        .getReference()
