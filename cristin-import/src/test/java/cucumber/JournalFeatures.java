...
public class JournalFeatures {
  ...
  public void thatTheCristinResultHasANonEmptyJournalPublication() {
    assertThat(
        this.scenarioContext.getCristinEntry().getJournalPublication(), is(not(nullValue())));
  }
  ...
  public void theJournalPublicationHasAIssnEntryEqualTo(String issnNumber) {
    scenarioContext.getCristinEntry().getJournalPublication().getJournal().setIssn(issnNumber);
  }
  ...
  public void theJournalPublicationHasAPagesBeginEntryEqualTo(String pagesBegin) {
    scenarioContext.getCristinEntry().getJournalPublication().setPagesBegin(pagesBegin);
  }
  ...
  public void theJournalPublicationHasAPagesEndEntryEqualTo(String pagesEnd) {
    scenarioContext.getCristinEntry().getJournalPublication().setPagesEnd(pagesEnd);
  }
  ...
  public void theJournalPublicationHasAVolumeEntryEqualTo(String volume) {
    scenarioContext.getCristinEntry().getJournalPublication().setVolume(volume);
  }
  ...
  public void theJournalPublicationHasADoiEntryEqualTo(String doi) {
    scenarioContext.getCristinEntry().getJournalPublication().setDoi(doi);
  }

  @Given("the Journal Publication has a reference to an NSD journal with identifier {int}")
  public void theJournalPublicationHasAReferenceToAnNsdJournalOrPublisherWithIdentifier(
      int nsdCode) {
  ...
  public void theNvaResourceHasAReferenceObjectWithAJournalUriThatPointsToNvaNsdProxy() {
    ...
    var nsdProxyUri =
        UriWrapper.fromUri(NVA_API_DOMAIN).addChild(NVA_CHANNEL_REGISTRY_V2).getUri().toString();
  ...
  public void theJournalUriSpecifiesTheJournalByTheNsdIdAndTheYear(
      String pid, Integer journalYear) {
    var journal = extractJournal();
    var uriString = journal.getId().toString();
  ...
  public void theNvaResourceHasAReferenceObjectWithDoiEqualTo(String expectedDoi) {
    var reference = scenarioContext.getNvaEntry().getEntityDescription().getReference();
    var actualDoi = reference.getDoi();
    assertThat(actualDoi, is(equalTo(URI.create(expectedDoi))));
  }

  @Then(
      "the Nva Resource, MediaFeatureArticle, has a PublicationContext with pagesBegin equal to"
          + " {string}")
  ...
  @Then(
      "the Nva Resource, MediaFeatureArticle, has a PublicationContext with pagesEnd equal to"
          + " {string}")
  public void theNvaResourceFeatureArticleHasAPublicationContextWithPagesEndEqualTo(
      String expectedPagesEnd) {
    var instance =
        scenarioContext
            .getNvaEntry()
            .getEntityDescription()
  ...
  @Then(
      "the Nva Resource, MediaFeatureArticle, has a PublicationContext with volume equal to"
          + " {string}")
  public void theNvaResourceFeatureArticleHasAPublicationContextWithVolumeEqualTo(
  ...
  @Then(
      "the Nva Resource, JournalLetter, has a PublicationContext with pagesBegin equal to {string}")
  public void theNvaResourceJournalLetterHasAPublicationContextWithPagesBeginEqualTo(
      String expectedPagesBegin) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalLetterHasAPublicationContextWithPagesEndEqualTo(
      String expectedPagesEnd) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalLetterHasAPublicationContextWithVolumeEqualTo(
      String expectedVolume) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  @Then(
      "the Nva Resource, JournalReview, has a PublicationContext with pagesBegin equal to {string}")
  public void theNvaResourceJournalReviewHasAPublicationContextWithPagesBeginEqualTo(
      String expectedPagesBegin) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalReviewHasAPublicationContextWithPagesEndEqualTo(
      String expectedPagesEnd) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalReviewHasAPublicationContextWithVolumeEqualTo(
      String expectedVolume) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  @Then(
      "the Nva Resource, JournalLeader, has a PublicationContext with pagesBegin equal to {string}")
  public void theNvaResourceJournalLeaderHasAPublicationContextWithPagesBeginEqualTo(
      String expectedPagesBegin) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalLeaderHasAPublicationContextWithPagesEndEqualTo(
      String expectedPagesEnd) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalLeaderHasAPublicationContextWithVolumeEqualTo(
      String expectedVolume) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  @Then(
      "the Nva Resource, JournalCorrigendum, has a PublicationContext with pagesBegin equal to"
          + " {string}")
  public void theNvaResourceJournalCorrigendumHasAPublicationContextWithPagesBeginEqualTo(
      String expectedPagesBegin) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  @Then(
      "the Nva Resource, JournalCorrigendum, has a PublicationContext with pagesEnd equal to"
          + " {string}")
  public void theNvaResourceJournalCorrigendumHasAPublicationContextWithPagesEndEqualTo(
      String expectedPagesEnd) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  @Then(
      "the Nva Resource, JournalCorrigendum, has a PublicationContext with volume equal to"
          + " {string}")
  public void theNvaResourceJournalCorrigendumHasAPublicationContextWithVolumeEqualTo(
      String expectedVolume) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theJournalPublicationHasAIssueEntryEqualTo(String issue) {
    scenarioContext.getCristinEntry().getJournalPublication().setIssue(issue);
  }

  @Then(
      "the Nva Resource, MediaFeatureArticle, has a PublicationContext with issue equal to"
          + " {string}")
  public void theNvaResourceFeatureArticleHasAPublicationContextWithIssueEqualTo(
  ...
  public void theNvaResourceJournalArticleHasAPublicationContextWithIssueEqualTo(
      String expectedIssue) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  @Then(
      "the Nva Resource, JournalCorrigendum, has a PublicationContext with issue equal to {string}")
  public void theNvaResourceJournalCorrigendumHasAPublicationContextWithIssueEqualTo(
      String expectedIssue) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalLeaderHasAPublicationContextWithIssueEqualTo(
      String expectedIssue) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalLetterHasAPublicationContextWithIssueEqualTo(
      String expectedIssue) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void theNvaResourceJournalReviewHasAPublicationContextWithIssueEqualTo(
      String expectedIssue) {
    var instance =
        scenarioContext
            .getNvaEntry()
  ...
  public void articleHasAnArticleNumber(int articleNumber) {
    ...
    scenarioContext
        .getCristinEntry()
        .getJournalPublication()
        .setArticleNumber(String.valueOf(articleNumber));
  }
  ...
  public void nvaResourceHasArticleNumber(int articleNumber) {
    var instance =
        scenarioContext
            ...
            .getPublicationInstance();
    assertThat(
        ((ProfessionalArticle) instance).getArticleNumber(),
        is(equalTo(String.valueOf(articleNumber))));
  }
