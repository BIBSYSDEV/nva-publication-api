...
public class CristinContributorAffiliationTransformer {
  ...
  public static List<CristinContributorsAffiliation> parseContributorAffiliationsFromMap(
      DataTable dataTable) {
  ...
  public static CristinContributorsAffiliation toCristinContributorAffiliation(
