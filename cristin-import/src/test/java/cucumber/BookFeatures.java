...
public class BookFeatures {
  ...
  public void theBookReportHasAEqualTo(String numberOfPages) {
    scenarioContext.getCristinEntry().getBookOrReportMetadata().setNumberOfPages(numberOfPages);
  }
  ...
  public void theNvaResourceHasAPublicationContextWithPublisherWithNameEqualTo(
  ...
  public void thatTheBookReportHasASubjectFieldWithTheSubjectFieldCodeEqualTo(
      int subjectFieldCode) {
    scenarioContext
        .getCristinEntry()
        .getBookOrReportMetadata()
        .setSubjectField(
            CristinSubjectField.builder().withSubjectFieldCode(subjectFieldCode).build());
  }
  ...
  public void theCristinResultBelongsToASeries() {
    assertThat(
        this.scenarioContext.getCristinEntry().getBookOrReportMetadata(), is(notNullValue()));
  }
  ...
  public void theCristinResultsHasAnAlternativeMentionToAPublisherNameWithValue(
  ...
  public void theNvaResourceHasAPublicationContextWithAnIsbnListContainingTheValues(
      String expectedIsbn) {
  ...
  public void theNvaResourceHasAPublicationContextWithNumberOfPagesEqualTo(
      String expectedNumberOfPages) {
    var context =
        scenarioContext
            .getNvaEntry()
    ...
    var pages = rawPages instanceof MonographPages ? ((MonographPages) rawPages).getPages() : null;
  ...
  public void theNvaResourceHasANpiSubjectHeadingWithValueEqualTo(int expectedSubjectFieldCode) {
    var actualSubjectFieldCode =
        scenarioContext.getNvaEntry().getEntityDescription().getNpiSubjectHeading();
    assertThat(actualSubjectFieldCode, is(equalTo(String.valueOf(expectedSubjectFieldCode))));
  }

  @Then(
      "the NVA Resource contains a Publisher reference that is a URI pointing to the NVA NSD proxy")
  ...
  @Then(
      "the NVA Resource contains an Unconfirmed Series with title {string}, issn {string}, online"
          + " issn {string} and seriesNumber {string}")
  public void theNvaResourceContainsAnUnconfirmedSeriesWithTitleIssnOnlineIssnAndSeriesNumber(
      String title, String issn, String onlineIssn, String seriesNumber) {
    var book = extractNvaBook();
  ...
  public void thePublisherUriContainsTheNsdCodeAndThePublicationYear(
      String pid, Integer publicationYear) {
  ...
  public void theSeriesUriContainsTheNsdCodeAndThePublicationYear(
      String pid, Integer publicationYear) {
    var seriesId = extractSeriesId();
  ...
  @And(
      "the book has series which has NSD code which does not exist in channel registry lookup file")
  public void the_book_has_nsd_code() {
    scenarioContext
        .getCristinEntry()
        .getBookOrReportMetadata()
        .getBookSeries()
        .setNsdCode(randomInteger());
  }
