...
public class ArtisticFeatures {
  ...
  public void theNvaResourcesContainsTheDataScrapedFromTypeKunstneriskproduksjon() {
    ...
    var publicationInstance =
        nvaResource.getEntityDescription().getReference().getPublicationInstance();
  ...
  public void theCristinResultHasAPresentWithDurationEqualToMinutes(
      String metadatafield, String minutes) {
  ...
  public void theCristinResultContainsAMovingPictureSubtypeEnumEqualTo(
      String movingPictureSubtypeEnum) {
    var publicationInstance =
        scenarioContext
            .getNvaEntry()
    ...
    var movingPicture = (MovingPicture) publicationInstance;
    assertThat(
        movingPicture.getSubtype().getType().getType(), is(equalTo(movingPictureSubtypeEnum)));
  }
  ...
  public void theCristinResultLackTheDurationInBothMetadataFields() {
    scenarioContext
        ...
        .setArtisticProductionTimeUnit(null);
  ...
  public void thePerformanceTypeIsEqualtTo(String performanceType) {
    if ("null".equals(performanceType)) {
      scenarioContext.getCristinEntry().getCristinArtisticProduction().setPerformance(null);
    } else {
      scenarioContext
          .getCristinEntry()
          .getCristinArtisticProduction()
  ...
  public void theNvaResourceHasAOtherPerformance() {
    ...
    assertThat(musicalWorkPerformance.getManifestations(), hasSize(1));
    assertThat(
        musicalWorkPerformance.getManifestations().get(0), instanceOf(OtherPerformance.class));
  }
  ...
  public void theNvaResourceHasAAudioVisualPublication() {
    var musicalWorkPerformance = extractMusicPerformance();
    assertThat(
        musicalWorkPerformance.getManifestations(),
  ...
  public void theMusicScoreHasAnIsmnNEqualTo(String ismn) throws InvalidIsmnException {
    var musicalWorkPerformance = extractMusicPerformance();
    var musicScoreOptional =
        musicalWorkPerformance.getManifestations().stream()
  ...
  public void theAudioVisualPublicationHasAMediaSubTypeEqualTo(String expectedediaSubType) {
    ...
    assertThat(
        audioVisualManifestation.getMediaType().getType().getValue(),
        is(equalTo(expectedediaSubType)));
  }

  @And("the AudioVisualPublication has ISRC equalTo {string},")
  public void theAudioVisualPublicationHasIsrcEqualTo(String expectedIsrc)
      throws InvalidIsrcException {
    var audioVisualManifestation = getAudioVisualPublication();
  ...
  public void theAudioVisualPublicationHasAnUnconfirmedPublisherNameEqualTo(
      String expectedUnconfirmedPublisher) {
    var audioVisualManifestation = getAudioVisualPublication();
    assertThat(
        audioVisualManifestation.getPublisher(),
  ...
  public void thePerformingArtsHasASubtype(String subtype) {
    ...
    var performingArts = getPerformingArts();
    assertThat(performingArts.getSubtype().getType(), is(equalTo(expectedSubtype)));
  }
  ...
  private CristinProduct readProductFromResource() {
    ...
    return attempt(
            () -> JsonUtils.dtoObjectMapper.readValue(cristinProductString, CristinProduct.class))
        .orElseThrow();
  }
    ...
    return attempt(
            () ->
                JsonUtils.dtoObjectMapper.readValue(
                    artisticProduction, CristinArtisticProduction.class))
        .orElseThrow();
  }
