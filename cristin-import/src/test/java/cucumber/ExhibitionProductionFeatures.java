...
public class ExhibitionProductionFeatures {
  ...
  public void theCristinResultHasAMuseumCategoryOf(String category) {
    ...
    museumEvent.setMuseumEventCategory(
        MuseumEventCategory.builder().withEventCode(category).build());
  }
  ...
  public void theNvaResourceHasAnInstanceTypeExhibitionProductionWithAExhibitionBasic(String type) {
    ...
    assertThat(
        exhibition.getSubtype(),
        is(
            equalTo(
                new ExhibitionProductionSubtype(ExhibitionProductionSubtypeEnum.valueOf(type)))));
  }
  ...
  @Then(
      "the exhibition manifestation has an unconfirmed place with label equal to {string} and"
          + " country equal to {string}")
  public void theExhibitionManifestationHasAnUnconfirmedPlaceWithLabelEqualToAndCountryEqualTo(
  ...
  public void theExhibitionManifestationHasAOrganizationEqualTo(String organization) {
    var exhibitionBasic = getExhibitionBasic();
    assertThat(
        exhibitionBasic.getOrganization(), is(equalTo(new UnconfirmedOrganization(organization))));
  }
