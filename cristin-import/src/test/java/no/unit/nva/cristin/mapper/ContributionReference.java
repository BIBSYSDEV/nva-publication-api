...
/**
 * Helper class when testing for correct mapping of Contribution sequences. During the mapping from
 * Cristin objects to NVA objects, we assume that we can identify uniquely a contribution by a
 * resource identifier (Cristin result identifier), a Cristin person identifier and a sequence
 * number. That is to say, we expect to be able to identify a Contribution sequence by saying that
 * the "X person is the ith contributor in the Y publication".
 */
